...
- [ ] Sidebar menü açık/kapalı durumunu sayfa navigasyonunda koru

### 2. Variation Template Modülü (Yeni)
- [ ] Migration: `variation_templates` tablosu
  - id, name, type (text, color, image), sort_order, is_active, timestamps
- [ ] Migration: `variation_template_values` tablosu
  - id, variation_template_id, label, value, color (nullable), image (nullable), sort_order, timestamps
- [ ] Model: `VariationTemplate` (relationships: values)
- [ ] Model: `VariationTemplateValue`
- [ ] FormRequest: `StoreVariationTemplateRequest`, `UpdateVariationTemplateRequest`
- [ ] Service: `VariationTemplateService`
- [ ] Controller: `VariationTemplateController` (CRUD)
- [ ] Routes: Resource routes
- [ ] Frontend: Index, Create, Edit, Show sayfaları
- [ ] Frontend: Type seçimi (Text, Color, Image)
- [ ] Frontend: Values yönetimi (Label, Order, Color/Image)

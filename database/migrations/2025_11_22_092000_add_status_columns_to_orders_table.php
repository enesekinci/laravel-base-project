...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('orders', function (Blueprint $table) {
            ...
            // Shipping and Payment method foreign keys
            if (! Schema::hasColumn('orders', 'shipping_method_id')) {
                $table->unsignedBigInteger('shipping_method_id')->nullable()->after('billing_address_id');
            ...
            if (! Schema::hasColumn('orders', 'payment_method_id')) {
                $table->unsignedBigInteger('payment_method_id')->nullable()->after('shipping_method_id');

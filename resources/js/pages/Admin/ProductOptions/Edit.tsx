...
export default function ProductOptionsEdit({ option }: Props) {
    ...
    // Option values'ları local state'e yükle
    useEffect(() => {
        if (option.values) {
            setLocalValues(
                option.values.map((v) => ({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Ürün Seçeneği Düzenle" />

            <div className="flex-1 space-y-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">
                            Ürün Seçeneği Düzenle
                        </h1>
                        <p className="mt-1 text-muted-foreground">
                            Ürün seçeneğini düzenleyin
                        </p>
                    </div>
                    <Link href={index()}>
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectGroup>
                                            ...
                                            <SelectItem value="checkbox_custom">
                                                Custom Checkbox
                                            </SelectItem>
                                            <SelectItem value="radio">
                                                Radio Button
                                            </SelectItem>
                                            <SelectItem value="radio_custom">
                                                Custom Radio Button
                                            </SelectItem>

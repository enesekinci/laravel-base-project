...
export default function SmsTemplatesEdit({ smsTemplate }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/admin/sms-templates/${smsTemplate.id}`);
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="SMS Şablonu Düzenle" />
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-muted-foreground">
                            {smsTemplate.name} şablonunu düzenleyin
                        </p>
                    </div>
                    <div className="flex gap-2">
                        <Link href={`/admin/sms-templates/${smsTemplate.id}`}>

            ...
            <ul class="navbar-item flex-row ms-lg-auto ms-0">
                ...
                <li class="nav-item dropdown language-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="{{ asset('cork/src/assets/img/1x1/tr.svg') }}" class="flag-width" alt="flag">
                    </a>
                    <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{ asset('cork/src/assets/img/1x1/us.svg') }}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;English</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{ asset('cork/src/assets/img/1x1/tr.svg') }}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Türkçe</span></a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown notification-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="notificationDropdown">
                        <div class="drodpown-title message">
                            <h6 class="d-flex justify-content-between"><span class="align-self-center">Mesajlar</span> <span class="badge badge-primary">9 Okunmamış</span></h6>
                        </div>
            ...
            <nav id="sidebar">
                ...
                <div class="navbar-nav theme-brand flex-row  text-center">
                    <div class="nav-logo">
                        ...
                        <div class="nav-item theme-text">
                            <a href="{{ route('dashboard') }}" class="nav-link"> Fast Commerce </a>
                        </div>
                    </div>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu menu-heading">
                        <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus"><line x1="5" y1="12" x2="19" y2="12"></line></svg><span>E-TİCARET</span></div>
                    </li>
        ...
        <div id="content" class="main-content">
            ...
            <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © <span class="dynamic-year">{{ date('Y') }}</span> <a target="_blank" href="#">Fast Commerce</a>, Tüm hakları saklıdır.</p>
                </div>

...
<html lang="tr">
    <head>
        ...
        <title>@yield('title', 'Dashboard') | Laravel Base Project</title>
                    ...
                    <li class="nav-item dropdown language-dropdown">
                        ...
                        <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                            <a class="dropdown-item d-flex" href="javascript:void(0);">
                                <img src="{{ asset('cork/src/assets/img/1x1/us.svg') }}" class="flag-width" alt="flag" />
                    ...
                    <div class="navbar-nav theme-brand flex-row text-center">
                        <div class="nav-logo">
                            ...
                            <div class="nav-item theme-text">
                                <a href="{{ route('account.dashboard') }}" class="nav-link">Laravel Base Project</a>
                            </div>
                        </div>
                    ...
                    <ul class="list-unstyled menu-categories" id="accordionExample">
                        <li class="menu">
                            ...
                            <ul class="collapse submenu list-unstyled" id="dashboard" data-bs-parent="#accordionExample">
                                <li>
                                    <a href="{{ route('account.dashboard') }}">Ana Sayfa</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu">
                            ...
                            <ul class="collapse submenu list-unstyled" id="products" data-bs-parent="#accordionExample">
                                <li>
                                    <a href="{{ route('admin.products.index') }}">Liste</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.products.create') }}">Yeni Ürün</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu">
                            ...
                            <ul class="collapse submenu list-unstyled" id="categories" data-bs-parent="#accordionExample">
                                ...
                                <li>
                                    <a href="{{ route('admin.categories.create') }}">Yeni Kategori</a>
                                </li>
                            </ul>
                        </li>
                    </ul>

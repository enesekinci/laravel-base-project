...
@section('top-notice')
    @include('components.porto.demo36.top-notice')
@endsection

@section('footer')
    @include('components.porto.demo36.footer')
@endsection


@section('header')
    @include('components.porto.demo36.header')
@endsection
...
<div class="bg-gray pb-5">
				...
				'loop': false
                        ...
                        <div class="home-slide home-slide1 banner">
                            <img class="slide-bg" src="/porto/assets/images/demoes/demo36/slider/slide-1.jpg" alt="slider image">
                            <div class="container d-flex align-items-sm-center justify-content-sm-between justify-content-center flex-column flex-sm-row">
                                ...
                                <div class="banner-content content-right appear-animate" data-animation-name="fadeInUpShorter" data-animation-delay="1000">
                                    ...
                                    <a href="/porto/demo36-shop.html" class="btn btn-dark btn-lg">Shop Now</a>
                                </div>
                                <!-- End .banner-layer -->
                            </div>
                        </div>
                        ...
                        <div class="home-slide home-slide2 banner banner-md-vw">
                            <img class="slide-bg" src="/porto/assets/images/demoes/demo36/slider/slide-2.jpg" alt="slider image">
                    ...
                    <div class="categories-section appear-animate" data-animation-name="fadeIn" data-animation-delay="100">
                        <div class="categories-slider owl-carousel owl-theme show-nav-hover nav-outer" data-owl-options="{
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="/porto/demo36-shop.html">
                                    <figure>
                                        <img src="/porto/assets/images/demoes/demo36/products/categories/category-1.jpg" alt="category" width="280" height="240" />
                                    </figure>
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="/porto/demo36-shop.html">
                                    <figure>
                                        <img src="/porto/assets/images/demoes/demo36/products/categories/category-2.jpg" alt="category" width="220" height="220" />
                                    </figure>
                                    <div class="category-content">
                                        <h3>Furniture</h3>
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="/porto/demo36-shop.html">
                                    <figure>
                                        <img src="/porto/assets/images/demoes/demo36/products/categories/category-3.jpg" alt="category" width="220" height="220" />
                                    </figure>
                                    <div class="category-content">
                                        <h3>Sports</h3>
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="/porto/demo36-shop.html">
                                    <figure>
                                        <img src="/porto/assets/images/demoes/demo36/products/categories/category-4.jpg" alt="category" width="220" height="220" />
                                    </figure>
                                    <div class="category-content">
                                        <h3>Toys</h3>
                                        <span><mark class="count">2</mark> products</span>
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="/porto/demo36-shop.html">
                                    <figure>
                                        <img src="/porto/assets/images/demoes/demo36/products/categories/category-5.jpg" alt="category" width="220" height="220" />
                                    </figure>
                                    <div class="category-content">
                                        <h3>Cameras</h3>
                                        <span><mark class="count">1</mark> products</span>
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="/porto/demo36-shop.html">
                                    <figure>
                                        <img src="/porto/assets/images/demoes/demo36/products/categories/category-6.jpg" alt="category" width="220" height="220" />
                                    </figure>
                                    <div class="category-content">
                                        <h3>Gaming</h3>
                                        <span><mark class="count">1</mark> products</span>
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="/porto/demo36-shop.html">
                                    <figure>
                                        <img src="/porto/assets/images/demoes/demo36/products/categories/category-7.jpg" alt="category" width="220" height="220" />
                                    </figure>
                                    <div class="category-content">
                                        <h3>Headphones</h3>
                                        <span><mark class="count">1</mark> products</span>
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="/porto/demo36-shop.html">
                                    <figure>
                                        <img src="/porto/assets/images/demoes/demo36/products/categories/category-8.jpg" alt="category" width="220" height="220" />
                                    </figure>
                                    <div class="category-content">
                                        <h3>Smartphones</h3>
                                        <span><mark class="count">1</mark> products</span>
                    ...
                    <div class="promo-section bg-white appear-animate" data-animation-name="fadeIn" data-animation-delay="100">
                        <div class="promo-banner banner container text-uppercase bg-transparent">
                            ...
                            flex-md-row text-center">
                                ...
                                <a href="/porto/demo36-shop.html" class="btn btn-dark">Get NOW!</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="banner-section appear-animate" data-animation-name="fadeInUpShorter" data-animation-delay="200">
                    <div class="row">
                        <div class="col-md-4 mb-2 mb-md-0">
                            <div class="banner banner1 d-flex align-items-center justify-content-end" style="background-image: url(/porto/assets/images/demoes/demo36/banners/banner1.jpg);">
                        ...
                        <div class="col-md-8">
                            <div class="banner banner2 d-flex align-items-center justify-content-end" style="background-image: url(/porto/assets/images/demoes/demo36/banners/banner2.jpg);">
                                <div class="container d-flex align-items-center justify-content-end">
                    ...
                    <div class="row appear-animate" data-animation-name="fadeInUpShorter" data-animation-delay="200">
                        <div class="col-md-4 mb-2 mb-md-0">
                            <div class="product-default deal-product">
                                <figure>
                                    <a href="/porto/demo36-product.html">
                                        <img src="/porto/assets/images/demoes/demo36/products/product-1.jpg" width="450" height="450" alt="product">
                                    </a>
                                ...
                                <div class="product-details">
                                    <div class="category-list">
                                        <a href="/porto/demo36-shop.html" class="product-category">Category</a>
                                    </div>
                                    <h3 class="product-title">
                                        <a href="/porto/demo36-product.html">Drone Pro</a>
                                    </h3>
                                    ...
                                    <div class="product-action">
                                        ...
                                        <a href="/porto/ajax/product-quick-view.html" class="btn-quickview" title="Quick View"><i class="fas fa-external-link-alt"></i></a>
                                    </div>
                                </div>
                                <!-- End .product-details -->
                            </div>
                                ...
                                <div class="row row-joined">
                                    <div class="col-xl-3 col-sm-4 col-6">
                                        <div class="product-default inner-quickview inner-icon">
                                            <figure>
                                                <a href="/porto/demo36-product.html">
                                                    <img src="/porto/assets/images/demoes/demo36/products/product-2.jpg" width="239" height="239" alt="product">
                                                </a>
                                            ...
                                            <div class="product-details">
                                                ...
                                                <h3 class="product-title">
                                                    <a href="/porto/demo36-product.html">PT Speaker</a>
                                                </h3>
                                                <div class="ratings-container">
                                                    <div class="product-ratings">
                                    ...
                                    <div class="col-xl-3 col-sm-4 col-6">
                                        <div class="product-default inner-quickview inner-icon">
                                            <figure>
                                                <a href="/porto/demo36-product.html">
                                                    <img src="/porto/assets/images/demoes/demo36/products/product-3.jpg" width="239" height="239" alt="product">
                                                </a>
                                                <div class="btn-icon-group">
                                                    <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                            class="icon-shopping-cart"></i></a>
                                            ...
                                            <div class="product-details">
                                                ...
                                                <h3 class="product-title">
                                                    <a href="/porto/product.html">Beats Solo HD Drenched</a>
                                                </h3>
                                                <div class="ratings-container">
                                                    <div class="product-ratings">
                                                        <span class="ratings" style="width:100%"></span>
                                    ...
                                    <div class="col-xl-3 col-sm-4 col-6">
                                        <div class="product-default inner-quickview inner-icon">
                                            <figure>
                                                <a href="/porto/demo36-product.html">
                                                    <img src="/porto/assets/images/demoes/demo36/products/product-4.jpg" width="239" height="239" alt="product">
                                                </a>
                                                <div class="btn-icon-group">
                                                    <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                            class="icon-shopping-cart"></i></a>
                                            ...
                                            <div class="product-details">
                                                ...
                                                <h3 class="product-title">
                                                    <a href="/porto/product.html">Palm Print Jacket</a>
                                                </h3>
                                                <div class="ratings-container">
                                                    <div class="product-ratings">
                                                        <span class="ratings" style="width:100%"></span>
                                    ...
                                    <div class="col-xl-3 col-sm-4 col-6">
                                        <div class="product-default inner-quickview inner-icon">
                                            <figure>
                                                <a href="/porto/demo36-product.html">
                                                    <img src="/porto/assets/images/demoes/demo36/products/product-5.jpg" width="239" height="239" alt="product">
                                                </a>
                                                <div class="btn-icon-group">
                                                    <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                            class="icon-shopping-cart"></i></a>
                                            ...
                                            <div class="product-details">
                                                ...
                                                <h3 class="product-title">
                                                    <a href="/porto/product.html">Camera</a>
                                                </h3>
                                                <div class="ratings-container">
                                                    <div class="product-ratings">
                                                        <span class="ratings" style="width:100%"></span>
                                    ...
                                    <div class="col-xl-3 col-sm-4 col-6">
                                        <div class="product-default inner-quickview inner-icon">
                                            <figure>
                                                <a href="/porto/demo36-product.html">
                                                    <img src="/porto/assets/images/demoes/demo36/products/product-6.jpg" width="239" height="239" alt="product">
                                                </a>
                                                <div class="btn-icon-group">
                                                    <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                            class="icon-shopping-cart"></i></a>
                                            ...
                                            <div class="product-details">
                                                ...
                                                <h3 class="product-title">
                                                    <a href="/porto/product.html">Red Football</a>
                                                </h3>
                                                <div class="ratings-container">
                                                    <div class="product-ratings">
                                                        <span class="ratings" style="width:100%"></span>
                                    ...
                                    <div class="col-xl-3 col-sm-4 col-6">
                                        <div class="product-default inner-quickview inner-icon">
                                            <figure>
                                                <a href="/porto/demo36-product.html">
                                                    <img src="/porto/assets/images/demoes/demo36/products/product-7.jpg" width="239" height="239" alt="product">
                                                </a>
                                                <div class="btn-icon-group">
                                                    <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                            class="icon-shopping-cart"></i></a>
                                            ...
                                            <div class="product-details">
                                                ...
                                                <h3 class="product-title">
                                                    <a href="/porto/product.html">Soft Hat</a>
                                                </h3>
                                                <div class="ratings-container">
                                                    <div class="product-ratings">
                                                        <span class="ratings" style="width:100%"></span>
                                    ...
                                    <div class="col-xl-3 col-sm-4 col-6">
                                        <div class="product-default inner-quickview inner-icon">
                                            <figure>
                                                <a href="/porto/demo36-product.html">
                                                    <img src="/porto/assets/images/demoes/demo36/products/product-8.jpg" width="239" height="239" alt="product">
                                                </a>
                                                <div class="btn-icon-group">
                                                    <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                            class="icon-shopping-cart"></i></a>
                                            ...
                                            <div class="product-details">
                                                ...
                                                <h3 class="product-title">
                                                    <a href="/porto/product.html">PT Bag</a>
                                                </h3>
                                                <div class="ratings-container">
                                                    <div class="product-ratings">
                                                        <span class="ratings" style="width:100%"></span>
                                    ...
                                    <div class="col-xl-3 col-sm-4 col-6">
                                        <div class="product-default inner-quickview inner-icon">
                                            <figure>
                                                <a href="/porto/demo36-product.html">
                                                    <img src="/porto/assets/images/demoes/demo36/products/product-9.jpg" width="239" height="239" alt="product">
                                                </a>
                                                <div class="btn-icon-group">
                                                    <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                            class="icon-shopping-cart"></i></a>
                                            ...
                                            <div class="product-details">
                                                ...
                                                <h3 class="product-title">
                                                    <a href="/porto/product.html">GM Camaro SS Original</a>
                                                </h3>
                                                <div class="ratings-container">
                                                    <div class="product-ratings">
                                                        <span class="ratings" style="width:100%"></span>
                    ...
                    <div class="row">
                        <div class="col-lg-3 pr-lg-3 pr-sm-0 col-sm-6 order-1 order-sm-0">
                            <div class="shop-list h-100">
                                ...
                                <a class="view-all" href="/porto/demo36-shop.html">View
                                    All<i class="fas fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>

                        <div class="col-lg-3 col-sm-6 pl-lg-3 pl-sm-0 order-0">
                            <div class="banner banner3" style="background-image: url(/porto/assets/images/demoes/demo36/banners/banner3.jpg);">
                                    ...
                                    <div class="row row-joined h-100">
                                        <div class="col-sm-4 col-6">
                                            <div class="product-default inner-quickview inner-icon">
                                                <figure>
                                                    <a href="/porto/demo36-product.html">
                                                        <img src="/porto/assets/images/demoes/demo36/products/product-10.jpg" width="239" height="239" alt="product">
                                                    </a>
                                                    <div class="btn-icon-group">
                                                        <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                                class="icon-shopping-cart"></i></a>
                                                ...
                                                <div class="product-details">
                                                    ...
                                                    <h3 class="product-title">
                                                        <a href="/porto/demo36-product.html">Black Bag</a>
                                                    </h3>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                                            <span class="ratings" style="width:100%"></span>
                                        ...
                                        <div class="col-sm-4 col-6">
                                            <div class="product-default inner-quickview inner-icon">
                                                <figure>
                                                    <a href="/porto/demo36-product.html">
                                                        <img src="/porto/assets/images/demoes/demo36/products/product-11.jpg" width="239" height="239" alt="product">
                                                    </a>
                                                    <div class="btn-icon-group">
                                                        <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                                class="icon-shopping-cart"></i></a>
                                                ...
                                                <div class="product-details">
                                                    ...
                                                    <h3 class="product-title">
                                                        <a href="/porto/product.html">Brown Belt</a>
                                                    </h3>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                                            <span class="ratings" style="width:100%"></span>
                ...
                <div class="container">
                    <div class="categories-container bg-white appear-animate" data-animation-name="fadeIn" data-animation-delay="100">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2 mb-md-0">
                                <div class="banner banner4 bg-image" style="background-image: url(/porto/assets/images/demoes/demo36/banners/banner4.jpg);">
                            ...
                            <div class="col-md-6">
                                <div class="banner banner5 bg-image" style="background-image: url(/porto/assets/images/demoes/demo36/banners/banner5.jpg);">
                                    <div class="banner-layer d-flex align-items-center flex-column flex-sm-row justify-content-end">
                                        <div class="content-left">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-sm-6">
                                <div class="shop-list p-0">
                                    <a href="/porto/demo36-shop.html" class="sub-title">Accessories</a>
                                    <ul class="d-flex flex-wrap">
                                        <li><a href="/porto/demo36-shop.html">Bags & Cases</a></li>
                                        <li><a href="/porto/demo36-shop.html">Batteries</a></li>
                                        <li><a href="/porto/demo36-shop.html">Cables & Adapters</a></li>
                                        <li><a href="/porto/demo36-shop.html">Chargers</a></li>
                                        <li><a href="/porto/demo36-shop.html">Electronic Cigarettes</a></li>
                                        <li><a href="/porto/demo36-shop.html">Home Electronic</a></li>
                                    </ul>
                                    <a class="view-all" href="/porto/demo36-shop.html">View
                                        All<i class="fas fa-long-arrow-alt-right"></i></a>
                                </div>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="shop-list p-0">
                                    <a href="/porto/demo36-shop.html" class="sub-title">Audio & Video</a>
                                    <ul class="d-flex flex-wrap">
                                        <li><a href="/porto/demo36-shop.html">Audio Amplifier</a></li>
                                        <li><a href="/porto/demo36-shop.html">HDMI Projectors</a></li>
                                        <li><a href="/porto/demo36-shop.html">Projectors</a></li>
                                        <li><a href="/porto/demo36-shop.html">Televisions</a></li>
                                        <li><a href="/porto/demo36-shop.html">TV Receivers</a></li>
                                        <li><a href="/porto/demo36-shop.html">TV Sticks</a></li>
                                    </ul>
                                    <a class="view-all" href="/porto/demo36-shop.html">View
                                        All<i class="fas fa-long-arrow-alt-right"></i></a>
                                </div>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="shop-list p-0">
                                    <a href="/porto/demo36-shop.html" class="sub-title">Camera & Photo</a>
                                    <ul class="d-flex flex-wrap">
                                        <li><a href="/porto/demo36-shop.html">Action Cameras</a></li>
                                        <li><a href="/porto/demo36-shop.html">Camcorders</a></li>
                                        <li><a href="/porto/demo36-shop.html">Camera & Photo</a></li>
                                        <li><a href="/porto/demo36-shop.html">Camera Drones</a></li>
                                        <li><a href="/porto/demo36-shop.html">Digital Cameras</a></li>
                                        <li><a href="/porto/demo36-shop.html">Photo Supplies</a></li>
                                    </ul>
                                    <a class="view-all" href="/porto/demo36-shop.html">View
                                        All<i class="fas fa-long-arrow-alt-right"></i></a>
                                </div>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="shop-list p-0">
                                    <a href="/porto/demo36-shop.html" class="sub-title">Laptops</a>
                                    <ul class="d-flex flex-wrap">
                                        <li><a href="/porto/demo36-shop.html">Gaming Laptops</a></li>
                                        <li><a href="/porto/demo36-shop.html">Laptop Accessories</a></li>
                                        <li><a href="/porto/demo36-shop.html">Laptop Bags & Cases</a></li>
                                        <li><a href="/porto/demo36-shop.html">Tablet Accessories</a></li>
                                        <li><a href="/porto/demo36-shop.html">Tablets</a></li>
                                        <li><a href="/porto/demo36-shop.html">Ultraslim Laptops</a></li>
                                    </ul>
                                    <a class="view-all" href="/porto/demo36-shop.html">View
                                        All<i class="fas fa-long-arrow-alt-right"></i></a>
                                </div>
                    ...
                    <div class="products-slider owl-carousel owl-theme nav-outer carousel-with-bg show-nav-hover nav-image-center appear-animate" data-animation-name="fadeIn" data-animation-delay="100" data-owl-options="{
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title">
                                    <a href="/porto/demo36-product.html">Beats solo HD Drenched</a>
                                </h3>
                                <div class="ratings-container">
                                    <div class="product-ratings">
                                        <span class="ratings" style="width:100%"></span>
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title">
                                    <a href="/porto/demo36-product.html">Camera</a>
                                </h3>
                                <div class="ratings-container">
                                    <div class="product-ratings">
                                        <span class="ratings" style="width:100%"></span>
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure>
                                <a href="/porto/demo36-product.html">
                                    <img src="/porto/assets/images/demoes/demo36/products/product-1.jpg" width="239" height="239" alt="product">
                                </a>
                                <div class="btn-icon-group">
                                    <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                            class="icon-shopping-cart"></i></a>
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title">
                                    <a href="/porto/demo36-product.html">GM CAMARO SS Original</a>
                                </h3>
                                <div class="ratings-container">
                                    <div class="product-ratings">
                                        <span class="ratings" style="width:100%"></span>
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure>
                                <a href="/porto/demo36-product.html">
                                    <img src="/porto/assets/images/demoes/demo36/products/product-12.jpg" width="239" height="239" alt="product">
                                </a>
                                <div class="btn-icon-group">
                                    <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                            class="icon-shopping-cart"></i></a>
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title">
                                    <a href="/porto/demo36-product.html">Sport Watches</a>
                                </h3>
                                <div class="ratings-container">
                                    <div class="product-ratings">
                                        <span class="ratings" style="width:100%"></span>
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="shop-list p-0 d-flex align-items-sm-center flex-sm-row flex-column">
                                    ...
                                    <div>
                                        ...
                                        <ul>
                                            <li><a href="/porto/demo36-shop.html">Gifts for Boyfriend</a></li>
                                            <li><a href="/porto/demo36-shop.html">Gifts for Dad</a>
                                            </li>
                                            <li><a href="/porto/demo36-shop.html">Gifts for Husband</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="shop-list p-0 d-flex align-items-sm-center flex-sm-row flex-column">
                                    ...
                                    <div>
                                        ...
                                        <ul>
                                            <li><a href="/porto/demo36-shop.html">Gifts for Girlfriend</a></li>
                                            <li><a href="/porto/demo36-shop.html">Gifts for Mom</a>
                                            </li>
                                            <li><a href="/porto/demo36-shop.html">Gifts for Wife</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="shop-list p-0 d-flex align-items-sm-center flex-sm-row flex-column">
                                    ...
                                    <div>
                                        ...
                                        <ul>
                                            <li><a href="/porto/demo36-shop.html">Gifts for Boys</a></li>
                                            <li><a href="/porto/demo36-shop.html">Gifts for Girls</a>
                                            </li>
                                            <li><a href="/porto/demo36-shop.html">Gifts for Tween Boys</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="shop-list p-0 d-flex align-items-sm-center flex-sm-row flex-column">
                                    ...
                                    <div>
                                        ...
                                        <ul>
                                            <li><a href="/porto/demo36-shop.html">Birthday for Her</a></li>
                                            <li><a href="/porto/demo36-shop.html">Birthday for Him</a>
                                            </li>
                                            <li><a href="/porto/demo36-shop.html">Boyfriend Gifts</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="products-slider product-slider-two owl-carousel carousel-with-bg owl-theme nav-outer show-nav-hover nav-image-center pb-0 appear-animate" data-animation-name="fadeIn" data-animation-delay="100" data-owl-options="{
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure>
                                <a href="/porto/demo36-product.html">
                                    <img src="/porto/assets/images/demoes/demo36/products/product-13.jpg" width="239" height="239" alt="product">
                                </a>
                                <div class="btn-icon-group">
                                    <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                            class="icon-shopping-cart"></i></a>
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title">
                                    <a href="/porto/demo36-product.html">Belt accessories</a>
                                </h3>
                                <div class="ratings-container">
                                    <div class="product-ratings">
                                        <span class="ratings" style="width:100%"></span>
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure>
                                <a href="/porto/demo36-product.html">
                                    <img src="/porto/assets/images/demoes/demo36/products/product-14.jpg" width="239" height="239" alt="product">
                                </a>
                                <div class="btn-icon-group">
                                    <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                            class="icon-shopping-cart"></i></a>
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title">
                                    <a href="/porto/demo36-product.html">PT Cup</a>
                                </h3>
                                <div class="ratings-container">
                                    <div class="product-ratings">
                                        <span class="ratings" style="width:100%"></span>
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure>
                                <a href="/porto/demo36-product.html">
                                    <img src="/porto/assets/images/demoes/demo36/products/product-15.jpg" width="239" height="239" alt="product">
                                </a>
                                <div class="btn-icon-group">
                                    <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                            class="icon-shopping-cart"></i></a>
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title">
                                    <a href="/porto/demo36-product.html">Tea bowl</a>
                                </h3>
                                <div class="ratings-container">
                                    <div class="product-ratings">
                                        <span class="ratings" style="width:100%"></span>
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure>
                                <a href="/porto/demo36-product.html">
                                    <img src="/porto/assets/images/demoes/demo36/products/product-16.jpg" width="239" height="239" alt="product">
                                </a>
                                <div class="btn-icon-group">
                                    <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                            class="icon-shopping-cart"></i></a>
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title">
                                    <a href="/porto/demo36-product.html">White brooch</a>
                                </h3>
                                <div class="ratings-container">
                                    <div class="product-ratings">
                                        <span class="ratings" style="width:100%"></span>
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure>
                                <a href="/porto/demo36-product.html">
                                    <img src="/porto/assets/images/demoes/demo36/products/product-17.jpg" width="239" height="239" alt="product">
                                </a>
                                <div class="btn-icon-group">
                                    <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                            class="icon-shopping-cart"></i></a>
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title">
                                    <a href="/porto/demo36-product.html">White ring</a>
                                </h3>
                                <div class="ratings-container">
                                    <div class="product-ratings">
                                        <span class="ratings" style="width:100%"></span>
                    ...
                    <div class="sale-banner banner bg-image mb-4 appear-animate" data-animation-name="fadeIn" data-animation-delay="100" style="background-image: url(/porto/assets/images/demoes/demo36/banners/banner6.jpg);">
                        <div class="container banner-content">
                            <div class="row no-gutter justify-content-start">
                                ...
                                <div class="mb-0 col-md-4 col-12 col-3 col-auto justify-content-center justify-content-md-start content-right">
                                    <a href="/porto/demo8-shop.html" class="btn btn-lg bg-white text-dark font2">Shop Now!</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="categories-container categories-container-three bg-white pb-0">
                                    <div class="heading d-flex flex-lg-row flex-column align-items-lg-center">
                                        ...
                                        <ul class="shop-list d-flex flex-wrap align-items-center p-0 mt-0">
                                            <li><a href="/porto/demo36-shop.html">Furniture</a></li>
                                            <li><a href="/porto/demo36-shop.html">Garden & Outdoors</a></li>
                                            <li><a href="/porto/demo36-shop.html">Home Accessories</a></li>
                                            <li><a href="/porto/demo36-shop.html">Lighting</a></li>
                                        </ul>
                                        <a class="view-all" href="/porto/demo36-shop.html">View
                                            All<i class="fas fa-long-arrow-alt-right"></i></a>
                                    </div>
                                    <div class="banner banner6" data-md-order="8">
                                        <figure>
                                            <img src="/porto/assets/images/demoes/demo36/banners/banner7.jpg" alt="banner">
                                        </figure>
                                        ...
                                        <div class="tab-pane fade show active" id="seller" role="tabpanel" aria-labelledby="seller-tab">
                                            <div class="products-slider owl-carousel nav-circle owl-theme pb-0" data-owl-options="{
                                                ...
                                                <div class="product-default inner-quickview inner-icon">
                                                    <figure>
                                                        <a href="/porto/demo36-product.html">
                                                            <img src="/porto/assets/images/demoes/demo36/products/product-18.jpg" width="239" height="239" alt="product">
                                                        </a>
                                                        <div class="btn-icon-group">
                                                            <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                                    class="icon-shopping-cart"></i></a>
                                                    ...
                                                    <div class="product-details">
                                                        ...
                                                        <h3 class="product-title">
                                                            <a href="/porto/demo36-product.html">Brown Arm Chair</a>
                                                        </h3>
                                                        <div class="ratings-container">
                                                            <div class="product-ratings">
                                                                <span class="ratings" style="width:100%"></span>
                                                ...
                                                <div class="product-default inner-quickview inner-icon">
                                                    <figure>
                                                        <a href="/porto/demo36-product.html">
                                                            <img src="/porto/assets/images/demoes/demo36/products/product-19.jpg" width="239" height="239" alt="product">
                                                        </a>
                                                        <div class="btn-icon-group">
                                                            <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                                    class="icon-shopping-cart"></i></a>
                                                    ...
                                                    <div class="product-details">
                                                        ...
                                                        <h3 class="product-title">
                                                            <a href="/porto/demo36-product.html">Coffee Cup</a>
                                                        </h3>
                                                        <div class="ratings-container">
                                                            <div class="product-ratings">
                                                                <span class="ratings" style="width:100%"></span>
                                                ...
                                                <div class="product-default inner-quickview inner-icon">
                                                    <figure>
                                                        <a href="/porto/demo36-product.html">
                                                            <img src="/porto/assets/images/demoes/demo36/products/product-20.jpg" width="239" height="239" alt="product">
                                                        </a>
                                                        <div class="btn-icon-group">
                                                            <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                                    class="icon-shopping-cart"></i></a>
                                                    ...
                                                    <div class="product-details">
                                                        ...
                                                        <h3 class="product-title">
                                                            <a href="/porto/demo36-product.html">White Sofa</a>
                                                        </h3>
                                                        <div class="ratings-container">
                                                            <div class="product-ratings">
                                                                <span class="ratings" style="width:100%"></span>
                                                ...
                                                <div class="product-default inner-quickview inner-icon">
                                                    <figure>
                                                        <a href="/porto/demo36-product.html">
                                                            <img src="/porto/assets/images/demoes/demo36/products/product-21.jpg" width="239" height="239" alt="product">
                                                        </a>
                                                        <div class="btn-icon-group">
                                                            <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                                    class="icon-shopping-cart"></i></a>
                                                    ...
                                                    <div class="product-details">
                                                        ...
                                                        <h3 class="product-title">
                                                            <a href="/porto/demo36-product.html">Wooden Chair</a>
                                                        </h3>
                                                        <div class="ratings-container">
                                                            <div class="product-ratings">
                                                                <span class="ratings" style="width:100%"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12 col-md-4 col-sm-6">
                                            <div class="product-default left-details product-widget">
                                                <figure>
                                                    <a href="/porto/demo36-product.html">
                                                        <img src="/porto/assets/images/demoes/demo36/products/small/product-1.jpg" width="84" height="84" alt="product">
                                                    </a>
                                                </figure>

                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo36-product.html">PT
                                                            Speaker</a> </h3>
                                        ...
                                        <div class="col-xl-12 col-md-4 col-sm-6">
                                            <div class="product-default left-details product-widget">
                                                <figure>
                                                    <a href="/porto/demo36-product.html">
                                                        <img src="/porto/assets/images/demoes/demo36/products/small/product-2.jpg" width="84" height="84" alt="product">
                                                    </a>
                                                </figure>

                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo36-product.html">Beats Solo
                                                            HD Drenched</a> </h3>
                                        ...
                                        <div class="col-xl-12 col-md-4 col-sm-6">
                                            <div class="product-default left-details product-widget">
                                                <figure>
                                                    <a href="/porto/demo36-product.html">
                                                        <img src="/porto/assets/images/demoes/demo36/products/small/product-3.jpg" width="84" height="84" alt="product">
                                                    </a>
                                                </figure>

                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo36-product.html">Palm Print
                                                            Jacket</a> </h3>
                                        ...
                                        <div class="col-xl-12 col-md-4 col-sm-6">
                                            <div class="product-default left-details product-widget">
                                                <figure>
                                                    <a href="/porto/demo36-product.html">
                                                        <img src="/porto/assets/images/demoes/demo36/products/small/product-4.jpg" width="84" height="84" alt="product">
                                                    </a>
                                                </figure>

                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo36-product.html">Camera</a>
                                                    </h3>
                                        ...
                                        <div class="col-xl-12 col-md-4 col-sm-6">
                                            <div class="product-default left-details product-widget">
                                                <figure>
                                                    <a href="/porto/demo36-product.html">
                                                        <img src="/porto/assets/images/demoes/demo36/products/small/product-5.jpg" width="84" height="84" alt="product">
                                                    </a>
                                                </figure>

                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo36-product.html">Red
                                                            Football</a> </h3>
                                        ...
                                        <div class="col-xl-12 col-md-4 col-sm-6">
                                            <div class=" product-default left-details product-widget">
                                                <figure>
                                                    <a href="/porto/demo36-product.html">
                                                        <img src="/porto/assets/images/demoes/demo36/products/small/product-6.jpg" width="84" height="84" alt="product">
                                                    </a>
                                                </figure>

                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo36-product.html">Soft
                                                            Hat</a> </h3>
                    ...
                    <div class="brands-section mt-2 mb-3 appear-animate" data-animation-delay="200" data-animation-name="fadeIn" data-animation-duration="1000">
                        ...
                        <div class="brands-slider owl-carousel bg-white owl-theme nav-circle images-center" data-owl-options="{
                            ...
                            <figure><img src="/porto/assets/images/brands/small/brand1.png" width="140" height="60" alt="brand">
                            </figure>
                            <figure><img src="/porto/assets/images/brands/small/brand2.png" width="140" height="60" alt="brand">
                            </figure>
                            <figure><img src="/porto/assets/images/brands/small/brand3.png" width="140" height="60" alt="brand">
                            </figure>
                            <figure><img src="/porto/assets/images/brands/small/brand4.png" width="140" height="60" alt="brand">
                            </figure>
                            <figure><img src="/porto/assets/images/brands/small/brand5.png" width="140" height="60" alt="brand">
                            </figure>
                            <figure><img src="/porto/assets/images/brands/small/brand6.png" width="140" height="60" alt="brand">
                            </figure>
                            <figure><img src="/porto/assets/images/brands/small/brand4.png" width="140" height="60" alt="brand">
                            </figure>
                        </div>
                    ...
                    <div class="product-slider-tab selected-products-section appear-animate bg-white" data-animation-name="fadeIn" data-animation-delay="100">
                        <div class="heading shop-list d-flex flex-lg-row flex-column align-items-lg-center bg-gray mb-0 pl-0 pr-0 pt-2">
                            ...
                            <a class="view-all ml-auto" href="/porto/demo36-shop.html">View
                                All<i class="fas fa-long-arrow-alt-right"></i></a>
                        </div>
                    ...
                    <div class="top-notice bg-dark text-white  top-notice-bg appear-animate" data-animation-name="fadeIn" data-animation-delay="100">
                        <div class="container text-center d-flex align-items-center justify-content-center flex-column flex-xl-row ">
                            <img src="/porto/assets/images/demoes/demo36/shop-logo.png" width="116" height="23" alt="logo" />
                            <h5 class="d-inline-block mb-0 pl-3 pr-3 pt-1 pb-1">The Lowest Prices Once A Month! Hurry To Snap Up
                            </h5>
                            <a href="/porto/demo36-shop.html" class="btn btn-darkcategory ls-n-0 mt-xl-0 mt-1">SHOP NOW!</a>
                        </div>
                        <!-- End .container -->
                    </div>
                    <!-- End .top-notice -->
                        ...
                        <div class="products-slider owl-carousel owl-theme carousel-with-bg nav-circle pb-0" data-owl-options="{
                            ...
                            <div class="product-default inner-quickview inner-icon">
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo36-product.html">PT Bag</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:100%"></span>
                            ...
                            <div class="product-default inner-quickview inner-icon">
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo36-product.html">Soft Hat</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:100%"></span>

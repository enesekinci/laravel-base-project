...
<div class="container">
				<ul class="checkout-progress-bar d-flex justify-content-center flex-wrap">
					<li class="active">
						<a href="/porto/demo19-cart.html">Shopping Cart</a>
					</li>
					<li>
						<a href="/porto/demo19-checkout.html">Checkout</a>
					</li>
					<li class="disabled">
						<a href="/porto/demo19-cart.html">Order Complete</a>
					</li>
				</ul>
							...
							<table class="table table-cart">
								...
								<tbody>
									<tr class="product-row">
										...
										<td class="product-col">
											<h5 class="product-title">
												<a href="/porto/demo19-product.html">Men Watch</a>
											</h5>
										</td>
										<td>$17.90</td>
										<td>
									...
									<tr class="product-row">
										...
										<td class="product-col">
											<h5 class="product-title">
												<a href="/porto/demo19-product.html">Men Black Gentle Belt</a>
											</h5>
										</td>
										<td>$17.90</td>
										<td>
					...
					<div class="col-lg-4">
						<div class="cart-summary">
							...
							<div class="checkout-methods">
								<a href="/porto/demo19-cart.html" class="btn btn-block btn-dark">Proceed to Checkout

...
@section('top-notice')
    @include('components.porto.demo25.top-notice')
@endsection

@section('header')
    @include('components.porto.demo25.header')
@endsection

@section('footer')
    @include('components.porto.demo25.footer')
@endsection
...
<nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/porto/demo25.html">Home</a></li>
                        ...
                        <div class="col-lg-9 product-sidebar-right">
                            <div class="product-single-container product-single-default">
                                <div class="cart-message d-none">
                                    <strong class="single-cart-notice">“The Night Before”</strong>
                                ...
                                <div class="row">
                                    <div class="col-md-6 product-single-gallery">
                                            ...
                                            <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                                <div class="product-item">
                                                    <img class="product-single-image"
                                                        src="/porto/assets/images/demoes/demo25/products/zoom/product-1-big.jpg"
                                                        data-zoom-image="/porto/assets/images/demoes/demo25/products/zoom/product-1-big.jpg"
                                        ...
                                        <div class="prod-thumbnail owl-dots">
                                            <div class="owl-dot">
                                                <img src="/porto/assets/images/demoes/demo25/products/zoom/product-1-thumb.jpg"
                                    ...
                                    <div class="col-md-6 product-single-details font2">
                                        <h1 class="product-title">The Night Before</h1>
                                                    ...
                                                    <span class="product-popup">
                                                        <span class="box-content">
                                                            <img alt="product" width="150" height="150"
                                                                src="/porto/assets/images/demoes/demo25/products/product-3.jpg"
                                            ...
                                            <div class="product-next">
                                                <a href="#">
                                                    ...
                                                    <span class="product-popup">
                                                        <span class="box-content">
                                                            <img alt="product" width="150" height="150"
                                                                src="/porto/assets/images/demoes/demo25/products/product-4.jpg"
                                                                style="padding-top: 0px;">
                                        ...
                                        <ul class="single-info-list">
                                            ...
                                            <li>
                                                AVAILABILITY:
                                                <strong>
                                                    <a href="#" class="product-category">10 IN STOCK</a>
                                                </strong>
                                            </li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="product-desc-content" role="tabpanel"
                                        ...
                                        <div class="product-desc-content">
                                            ...
                                            <p class="mb-0">Sed do eiusmod tempor incididunt ut labore et dolore magna
                                                aliqua. Ut
                                                enim ad
                                                minim
                        ...
                        <aside class="sidebar-product col-lg-3 mobile-sidebar">
                            <div class="sidebar-wrapper">
                                <div class="widget widget-info">
                                    <h3 class="widget-title m-b-3">AUTHOR</h3>

                                    <div class="widget-body bg-gray">
                                        <h4 class="font2 text-dark line-height-1 m-b-1">Wendy Walker</h4>
                                        <p class="font2 font-weight-normal line-height-1 ls-0 text-uppercase">12
                                            Books</p>
                                        <a href="/porto/demo25-shop.html" class="d-inline-block text-uppercase">View All
                                            Books</a>
                                    </div>
                                </div>

                                <div class="widget widget-featured">
                                    <h3 class="widget-title m-b-3">FEATURED BOOKS</h3>
                                        ...
                                        <div class="owl-carousel widget-featured-products">
                                            <div class="featured-col">
                                                <div class="product-default left-details product-widget">
                                                    <figure>
                                                        <a href="/porto/demo25-product.html">
                                                            <img src="/porto/assets/images/demoes/demo25/products/small/product-1.jpg"
                                                ...
                                                <div class="product-default left-details product-widget">
                                                    <figure>
                                                        <a href="/porto/demo25-product.html">
                                                            <img src="/porto/assets/images/demoes/demo25/products/small/product-2.jpg"
                                                                width="75" height="75" alt="product" />
                                                        </a>
                                                    </figure>
                                                    <div class="product-details">
                                                ...
                                                <div class="product-default left-details product-widget">
                                                    <figure>
                                                        <a href="/porto/demo25-product.html">
                                                            <img src="/porto/assets/images/demoes/demo25/products/small/product-3.jpg"
                                                                width="75" height="75" alt="product" />
                                                        </a>
                                                    </figure>
                                                    <div class="product-details">
                                ...
                                <div class="widget widget-custom">
                                    <h3 class="widget-title m-b-1">CUSTOM HTML BLOCK</h3>

                                    <div class="widget-body p-0">
                                        <h4 class="mb-2">This is a custom sub-title.</h4>
                                        <p class="font2 text-dark mb-0">Lorem ipsum dolor sit amet, consectetur elitad
                                            adipiscing Cras non placerat
                                            mi.</p>
                                    </div>
                                </div>

                                <div class="sidebar-banner d-flex justify-content-end"
                                    style="background-image: url(/porto/assets/images/demoes/demo25/banners/banner-sidebar.jpg);background-color: #343339;">
                                    <div class="banner-layer">
                                        <h3 class="line-height-1 text-uppercase text-white m-b-1">Award Winners</h3>
                                        <p class="font2 line-height-1 mb-2">12 Books</p>

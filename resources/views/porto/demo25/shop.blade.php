...
@section('header')
    @include('components.porto.demo25.headershop')
@endsection
...
<div class="category-banner-container">
                <div class="category-banner p-0">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <h5 class="line-height-1 text-uppercase mb-0">Book Club</h5>
                                <h2 class="m-b-2">Summer Reading</h2>
                                <h3 class="ls-n-10 font-weight-normal line-height-1 text-body m-0">The best books for
                                    your
                                    beach bag</h3>
                            </div>
                            <div class="col-md-3 col-lg-4"
                                style="background-image: url(/porto/assets/images/demoes/demo25/banners/shop-banner.png)">
                            </div>
                            <div class="col-md-4 col-lg-3 text-md-center">
                                <a href="#" class="btn btn-quaternary ml-0">Explore Books <i
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-sm-4 col-lg-3">
                                    <div class="product-default inner-quickview inner-icon">
                                        <figure>
                                            <a href="/porto/demo25-product.html">
                                                <img src="/porto/assets/images/demoes/demo25/products/product-10.jpg"
                                                    width="217" height="217" alt="product">
                                            </a>
                                            <div class="label-group">
                                ...
                                <div class="col-6 col-sm-4 col-lg-3">
                                    <div class="product-default inner-quickview inner-icon">
                                        <figure>
                                            <a href="/porto/demo25-product.html">
                                                <img src="/porto/assets/images/demoes/demo25/products/product-5.jpg"
                                                    width="217" height="217" alt="product">
                                            </a>
                                            <div class="label-group">
                                                <div class="product-label label-hot">HOT</div>
                                ...
                                <div class="col-6 col-sm-4 col-lg-3">
                                    <div class="product-default inner-quickview inner-icon">
                                        <figure>
                                            <a href="/porto/demo25-product.html">
                                                <img src="/porto/assets/images/demoes/demo25/products/product-11.jpg"
                                                    width="217" height="217" alt="product">
                                            </a>
                                            <div class="btn-icon-group">
                                                <a href="/porto/demo25-product.html" class="btn-icon btn-add-cart"><i
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h3 class="product-title">
                                                <a href="/porto/demo25-product.html">The Guest Book</a>
                                            </h3>
                                            <div class="ratings-container">
                                                <div class="product-ratings">
                                ...
                                <div class="widget">
                                    <h3 class="widget-title">
                                        <a data-toggle="collapse" href="#widget-body-1" role="button"
                                            aria-expanded="true" aria-controls="widget-body-1">Categories</a>
                                    </h3>

                                    <div class="collapse show" id="widget-body-1">
                                        <div class="widget-body">
                                            <ul class="cat-list">
                                                <li><a href="#">Arts &amp; Photography<span
                                                            class="products-count">(2)</span></a></li>
                                                <li><a href="#">Business &amp; Investing<span
                                                            class="products-count">(3)</span></a></li>
                                                <li><a href="#">Literature &amp; Fiction<span
                                                            class="products-count">(4)</span></a></li>
                                                <li><a href="#">Mystery Suspense<span
                                                            class="products-count">(4)</span></a></li>
                                                <li><a href="#">Scifi Fantasy<span class="products-count">(3)</span></a>
                                                </li>
                                            </ul>
                                        </div><!-- End .widget-body -->
                                    </div><!-- End .collapse -->
                                ...
                                <div class="widget">
                                    <h3 class="widget-title">
                                        <a data-toggle="collapse" href="#widget-body-2" role="button"
                                            aria-expanded="true" aria-controls="widget-body-2">Price</a>
                                    </h3>
                                ...
                                <div class="widget widget-color">
                                    <h3 class="widget-title">
                                        <a data-toggle="collapse" href="#widget-body-3" role="button"
                                            aria-expanded="true" aria-controls="widget-body-3">Color</a>
                                    </h3>
                                ...
                                <div class="widget">
                                    <h3 class="widget-title">
                                        <a data-toggle="collapse" href="#widget-body-4" role="button"
                                            aria-expanded="true" aria-controls="widget-body-4">Sizes</a>
                                    </h3>

...
<div class="page-header page-header-bg text-left"
                style="background: 50%/cover #D4E1EA url('/porto/assets/images/page-header-bg.jpg');">
                <div class="container">
                    <h1><span class="font1 ls-n-10">ABOUT US</span>
                        OUR COMPANY</h1>
                    <a href="/porto/demo21-contact.html" class="btn btn-dark">Contact</a>
                </div><!-- End .container -->
            </div><!-- End .page-header -->
            ...
            <div class="about-section">
                <div class="container">
                    ...
                    <p class="lead font1 ls-n-10">“ Many desktop publishing packages and web page editors now use Lorem
                        Ipsum as their
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="feature-box bg-white">
                                ...
                                <div class="feature-box-content p-0">
                                    <h3 class="font1 ls-n-10 m-b-3">Free Shipping</h3>
                        ...
                        <div class="col-lg-4">
                            <div class="feature-box bg-white">
                                ...
                                <div class="feature-box-content p-0">
                                    <h3 class="font1 ls-n-10 m-b-3">100% money back guarantee.</h3>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        Ipsum has been the industr.</p>
                                </div><!-- End .feature-box-content -->
                            </div><!-- End .feature-box -->
                        ...
                        <div class="col-lg-4">
                            <div class="feature-box bg-white">
                                ...
                                <div class="feature-box-content p-0">
                                    <h3 class="font1 ls-n-10 m-b-3">Online Support 24/7</h3>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        Ipsum has been the industr.</p>
                                </div><!-- End .feature-box-content -->
                            </div><!-- End .feature-box -->
                ...
                <div class="container">
                    ...
                    <div class="testimonials-carousel owl-carousel owl-theme images-left" data-owl-options="{
                        ...
                        <div class="testimonial">
                            <div class="testimonial-owner mb-4">
                                <figure>
                                    <img src="/porto/assets/images/clients/client1.png" alt="client">
                                </figure>

                                <div>
                                    <strong class="testimonial-title mb-0">John Smith</strong>
                        ...
                        <div class="testimonial">
                            <div class="testimonial-owner mb-4">
                                ...
                                <div>
                                    <strong class="testimonial-title mb-0">Bob Smith</strong>
                                    <span>SMARTWAVE CEO</span>
                                </div>
                            </div><!-- End .testimonial-owner -->

...
@section('header')
    @include('components.porto.demo21.header')
@endsection

@section('footer')
    @include('components.porto.demo21.footer')
@endsection
...
<nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/porto/demo21.html">Home</a></li>
                        <li class="breadcrumb-item"><a href="/porto/demo21-shop.html">Shop</a></li>
                        <li class="breadcrumb-item"><a href="/porto/demo21-shop.html">Electronic</a>, <a
                                href="/porto/demo21-shop.html">Motors</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 product-single-gallery">
                                ...
                                <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="/porto/assets/images/demoes/demo21/products/zoom/product-1.jpg"
                                            data-zoom-image="/porto/assets/images/demoes/demo21/products/zoom/product-1-big.jpg"
                            ...
                            <div class="prod-thumbnail owl-dots">
                                <div class="owl-dot">
                                    <img src="/porto/assets/images/demoes/demo21/products/zoom/product-1.jpg" width="110"
                                        ...
                                        <span class="product-popup">
                                            <span class="box-content">
                                                <img alt="product" width="150" height="150"
                                                    src="/porto/assets/images/demoes/demo21/products/product-10.jpg"
                                ...
                                <div class="product-next">
                                    <a href="#">
                                        ...
                                        <span class="product-popup">
                                            <span class="box-content">
                                                <img alt="product" width="150" height="150"
                                                    src="/porto/assets/images/demoes/demo21/products/product-4.jpg"
                                                    style="padding-top: 0px;">
                ...
                <div class="products-section pt-0">
                    ...
                    <div class="products-slider 5col owl-carousel owl-theme dots-top dots-small" data-owl-options="{
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure>
                                <a href="/porto/demo21-product.html">
                                    <img src="/porto/assets/images/demoes/demo21/products/product-10.jpg" width="217"
                                        height="217" alt="product">
                                    <img src="/porto/assets/images/demoes/demo21/products/product-10-2.jpg" width="217"
                                        height="217" alt="product">
                                </a>
                                <div class="btn-icon-group">
                                    <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure>
                                <a href="/porto/demo21-product.html">
                                    <img src="/porto/assets/images/demoes/demo21/products/product-12.jpg" width="217"
                                        height="217" alt="product">
                                </a>
                                <div class="btn-icon-group">
                                    <a href="/porto/demo21-product.html" class="btn-icon btn-add-cart"><i
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure>
                                <a href="/porto/demo21-product.html">
                                    <img src="/porto/assets/images/demoes/demo21/products/product-11.jpg" width="217"
                                        height="217" alt="product">
                                </a>
                                <div class="label-group">
                            ...
                            <div class="product-details">
                                <div class="category-wrap">
                                    <div class="category-list">
                                        <a href="/porto/demo21-product.html" class="product-category">Category</a>
                                    </div>
                                    <a href="/porto/wishlist.html" title="Wishlist" class="btn-icon-wish"><i
                                            class="icon-heart"></i></a>
                                </div>
                ...
                <div class="product-widgets-container row pt-0 pb-2">
                    <div class="col-md-6 col-lg-3 mb-2 mb-lg-0">
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/demo21-product.html">
                                    <img src="/porto/assets/images/demoes/demo21/products/small/product-7.jpg" width="84"
                                        height="84" alt="product">
                                    <img src="/porto/assets/images/demoes/demo21/products/small/product-7-2.jpg" width="84"
                                        height="84" alt="product">
                                </a>
                            </figure>

                            <div class="product-details">
                                <h3 class="product-title"> <a href="/porto/demo21-product.html">Digital Camera 16x</a> </h3>
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/demo21-product.html">
                                    <img src="/porto/assets/images/demoes/demo21/products/small/product-8.jpg" width="84"
                                        height="84" alt="product">
                                </a>
                            </figure>

                            <div class="product-details">
                                <h3 class="product-title"> <a href="/porto/demo21-product.html">Porto Extended Camera</a> </h3>
                        ...
                        <div class="product-default left-details product-widget">
                            ...
                            <div class="product-details">
                                <h3 class="product-title"> <a href="/porto/demo21-product.html">Black Grey Headset</a> </h3>
                    ...
                    <div class="col-md-6 col-lg-3 mb-2 mb-lg-0">
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/demo21-product.html">
                                    <img src="/porto/assets/images/demoes/demo21/products/small/product-9.jpg" width="84"
                                        height="84" alt="product">
                                </a>
                            </figure>

                            <div class="product-details">
                                <h3 class="product-title"> <a href="/porto/demo21-product.html">Computer Mouse</a> </h3>
                    ...
                    <div class="col-md-6 col-lg-3 mb-2 mb-lg-0">
                        ...
                        <div class="product-default left-details product-widget">
                            ...
                            <div class="product-details">
                                <h3 class="product-title"> <a href="/porto/demo21-product.html">1080p Wifi IP Camera</a> </h3>

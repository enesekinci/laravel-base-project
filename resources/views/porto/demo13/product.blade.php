...
<nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">sports shoes</li>
                    </ol>
                </div>
            </nav>
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 product-single-gallery">
                                ...
                                <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="/porto/assets/images/demoes/demo13/products/product-10.jpg"
                                            data-zoom-image="/porto/assets/images/demoes/demo13/products/product-10.jpg"
                                            width="468" height="468" alt="product" />
                                    </div>
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="/porto/assets/images/demoes/demo13/products/product-10-2.jpg"
                                            data-zoom-image="/porto/assets/images/demoes/demo13/products/product-10-2.jpg"
                                            width="468" height="468" alt="product" />
                                    </div>
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="/porto/assets/images/demoes/demo13/products/product-9.jpg"
                                            data-zoom-image="/porto/assets/images/demoes/demo13/products/product-9.jpg"
                                            width="468" height="468" alt="product" />
                                    </div>
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="/porto/assets/images/demoes/demo13/products/product-9-2.jpg"
                                            data-zoom-image="/porto/assets/images/demoes/demo13/products/product-9-2.jpg"
                                            width="468" height="468" alt="product" />
                                    </div>
                                    <div class="product-item">
                                        <img class="product-single-image"
                            ...
                            <div class="prod-thumbnail owl-dots">
                                <div class="owl-dot">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-10.jpg" width="110"
                                        height="110" alt="product-thumbnail" />
                                </div>
                                <div class="owl-dot">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-10-2.jpg" width="110"
                                        height="110" alt="product-thumbnail" />
                                </div>
                                <div class="owl-dot">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-9.jpg" width="110"
                                        height="110" alt="product-thumbnail" />
                                </div>
                                <div class="owl-dot">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-9-2.jpg" width="110"
                                        height="110" alt="product-thumbnail" />
                                </div>
                                <div class="owl-dot">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-10.jpg" width="110"
                        ...
                        <div class="col-lg-7 col-md-6 product-single-details">
                            ...
                            <ul class="single-info-list">
                                ...
                                <li>
                                    Categories:
                                    <strong>
                                        <a href="#" class="product-category">SHOES, TOYS</a>
                                    </strong>
                                </li>
                                ...
                                <li>
                                    TAGs:
                                    <strong>
                                        <a href="#" class="product-category">CLOTHES</a>
                                    </strong>,
                                    <strong>
                    ...
                    <div class="products-slider owl-carousel owl-theme dots-top dots-small">
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            ...
                            <div class="product-details">
                                <div class="category-wrap">
                                    <div class="category-list">
                                        <a href="/porto/demo13-shop.html" class="product-category">T-SHIRTS, WATCHES</a>
                                    </div>
                                    <a href="/porto/wishlist.html" title="Wishlist" class="btn-icon-wish">
                                        <i class="icon-heart"></i>
                                    </a>
                ...
                <div class="product-widgets-container row pb-2">
                    <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/product.html">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-5.jpg" width="95" height="95"
                                        alt="product">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-5-2.jpg" width="95"
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/product.html">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-1.jpg" width="95" height="95"
                                        alt="product">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-1-2.jpg" width="95"
                                        height="95" alt="product">
                                </a>
                            </figure>
                            <div class="product-details">
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/product.html">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-8.jpg" width="95" height="95"
                                        alt="product">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-8-2.jpg" width="95"
                                        height="95" alt="product">
                                </a>
                            </figure>
                            <div class="product-details">
                    ...
                    <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/product.html">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-2.jpg" width="95" height="95"
                                        alt="product">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-2-2.jpg" width="95"
                                        height="95" alt="product">
                                </a>
                            </figure>
                            <div class="product-details">
                    ...
                    <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/product.html">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-13.jpg" width="95"
                                        height="95" alt="product">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-13-2.jpg" width="95"
                                        height="95" alt="product">
                                </a>
                            </figure>
                            <div class="product-details">
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/product.html">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-9.jpg" width="95" height="95"
                                        alt="product">
                                    <img src="/porto/assets/images/demoes/demo13/products/product-9-2.jpg" width="95"
                                        height="95" alt="product">
                                </a>
                            </figure>
                            <div class="product-details">

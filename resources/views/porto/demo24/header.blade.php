            ...
            <div class="header-middle sticky-header">
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="/porto/demo24.html" class="logo">
                            <img src="/porto/assets/images/demoes/demo24/logo.png" alt="Porto Logo" width="97" height="51">
                        </a>
                    </div>
                    ...
                    <div class="header-center d-none d-lg-block">
                        <nav class="main-nav">
                            <ul class="menu">
                                <li class="active">
                                    <a href="/porto/demo24.html">Home</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="/porto/demo24-product.html">Products</a>
                                    <div class="megamenu megamenu-fixed-width">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <a href="#" class="nolink">PRODUCT PAGES</a>
                                                <ul class="submenu">
                                                    <li><a href="/porto/demo24-product.html">SIMPLE PRODUCT</a></li>
                                                    <li><a href="/porto/product-variable.html">VARIABLE PRODUCT</a></li>
                                                    <li><a href="/porto/demo24-product.html">SALE PRODUCT</a></li>
                                                    <li><a href="/porto/demo24-product.html">FEATURED & ON SALE</a></li>
                    ...
                    <div class="header-right">
                        ...
                        <div class="header-search header-search-popup header-search-category text-right d-none d-sm-flex">
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo24-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo24-product.html" class="product-image">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo24-product.html">Brown Women Casual HandBag</a>
                                                </h4>
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo24-product.html">Circled Ultimate 3D Speaker</a>
                                                </h4>

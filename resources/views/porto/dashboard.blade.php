...
@section('top-notice')
	<div class="top-notice bg-primary text-white">
		<div class="container text-center">
			...
			<a href="/porto/category.html" class="category">MEN</a>
			<a href="/porto/category.html" class="category ml-2 mr-3">WOMEN</a>
...
@section('header')
	@include('components.porto.dashboard-header')
@endsection

@section('footer')
	@include('components.porto.dashboard-footer')
@endsection

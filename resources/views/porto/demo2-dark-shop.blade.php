...
<div class="category-banner-container">
                <div class="category-banner banner text-uppercase"
                    style="background: no-repeat 60%/cover url('/porto/assets/images/banners/banner-top.jpg'); background-color: #77dafa">
                            ...
                            <div class="pl-lg-3 col-sm-4 offset-sm-0 offset-1 pt-3">
                                <div class="coupon-sale-content">
                                    <h4 class="m-b-1 coupon-sale-text bg-dark text-transform-none">Exclusive
                                        COUPON</h4>
                                    <h5 class="mb-2 coupon-sale-text text-dark d-block ls-10 p-0"><i class="ls-0">UP
                        ...
                        <div class="row products-group">
                                ...
                                <div class="product-default inner-quickview inner-icon">
                                    <figure class="img-effect">
                                        <a href="/porto/demo2-dark-product.html">
                                            <img src="/porto/assets/images/demoes/demo2-dark/products/product-1.jpg"
                                                width="205" height="205" alt="product">
                                            <img src="/porto/assets/images/demoes/demo2-dark/products/product-1-2.jpg"
                                                width="205" height="205" alt="product">
                                        </a>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure class="img-effect">
                                        <a href="/porto/demo2-dark-product.html">
                                            <img src="/porto/assets/images/demoes/demo2-dark/products/product-2.jpg"
                                                width="205" height="205" alt="product" />
                                        </a>
                                        <div class="btn-icon-group">
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure class="img-effect">
                                        <a href="/porto/demo2-dark-product.html">
                                            <img src="/porto/assets/images/demoes/demo2-dark/products/product-3.jpg"
                                                width="205" height="205" alt="product">
                                        </a>
                                        <div class="label-group">
                                            <div class="product-label label-hot">HOT</div>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure class="img-effect">
                                        <a href="/porto/demo2-dark-product.html">
                                            <img src="/porto/assets/images/demoes/demo2-dark/products/product-4.jpg"
                                                width="205" height="205" alt="product">
                                        </a>
                                        <div class="btn-icon-group">
                                            <a href="/porto/demo2-dark-product.html" class="btn-icon btn-add-cart"><i
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure class="img-effect">
                                        <a href="/porto/demo2-dark-product.html">
                                            <img src="/porto/assets/images/demoes/demo2-dark/products/product-5.jpg"
                                                width="205" height="205" alt="product">
                                        </a>
                                        <div class="btn-icon-group">
                                            <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure class="img-effect">
                                        <a href="/porto/demo2-dark-product.html">
                                            <img src="/porto/assets/images/demoes/demo2-dark/products/product-6.jpg"
                                                width="205" height="205" alt="product">
                                        </a>
                                        <div class="btn-icon-group">
                                            <a href="/porto/demo2-dark-product.html" class="btn-icon btn-add-cart"><i
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo2-dark-product.html">Brown Long Shoes</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo2-dark-product.html">Brown-Black Men Casual Glasses</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo2-dark-product.html">Black Men Casual Glasses</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo2-dark-product.html">Basketball Sports Blue Shoes</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo2-dark-product.html">Men Sports Travel Bag</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo2-dark-product.html">Brown HandBag</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                                ...
                                <div class="collapse show" id="widget-body-4">
                                    <div class="widget-body pb-0">
                                        <ul class="config-swatch-list">
                                            <li class="active">
                                                <a href="#" style="background-color: #000;" title="color list"></a>
                                            </li>
                                            <li>
                                                <a href="#" style="background-color: #0188cc;" title="color list"></a>
                                            </li>
                                            <li>
                                                <a href="#" style="background-color: #81d742;" title="color list"></a>
                                            </li>
                                            <li>
                                                <a href="#" style="background-color: #6085a5;" title="color list"></a>
                                            </li>
                                            <li>
                                                <a href="#" style="background-color: #ab6e6e;" title="color list"></a>
                                            </li>
                                        </ul>
                                    </div><!-- End .widget-body -->
                                </div><!-- End .collapse -->
                                    ...
                                    <div class="owl-carousel widget-featured-products">
                                        <div class="featured-col">
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo2-dark-product.html">Blue
                                            ...
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo2-dark-product.html">Casual
                                            ...
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo2-dark-product.html">Men
                                        ...
                                        <div class="featured-col">
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a
                                                            href="/porto/demo2-dark-product.html">Ultimate 3D Bluetooth
                                                            Speaker</a> </h3>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                                            <span class="ratings" style="width:100%"></span>
                                            ...
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo2-dark-product.html">Brown
                                            ...
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo2-dark-product.html">Circled

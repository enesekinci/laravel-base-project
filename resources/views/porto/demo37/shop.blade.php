...
@section('top-notice')
    @include('components.porto.demo37.top-notice')
@endsection

@section('header')
    @include('components.porto.demo37.headershop')
@endsection

@section('footer')
    @include('components.porto.demo37.footer')
@endsection
...
<div class="container">
                <nav aria-label="breadcrumb" class="breadcrumb-nav">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/porto/demo37.html"><i class="icon-home"></i></a></li>
                        ...
                        <div class="row products-group">
                                ...
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo37-product.html">
                                            <img src="/porto/assets/images/demoes/demo37/products/product-6.jpg" width="205" height="205" alt="product">
                                        </a>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo37-product.html">
                                            <img src="/porto/assets/images/demoes/demo37/products/product-4.jpg" width="205" height="205" alt="product">
                                        </a>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo37-product.html">
                                            <img src="/porto/assets/images/demoes/demo37/products/product-2.jpg" width="205" height="205" alt="product">
                                        </a>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo37-product.html">
                                            <img src="/porto/assets/images/demoes/demo37/products/product-3.jpg" width="205" height="205" alt="product">
                                            <img src="/porto/assets/images/demoes/demo37/products/product-3-2.jpg" width="205" height="205" alt="product">
                                        </a>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo37-product.html">
                                            <img src="/porto/assets/images/demoes/demo37/products/product-7.jpg" width="205" height="205" alt="product">
                                        </a>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo37-product.html">
                                            <img src="/porto/assets/images/demoes/demo37/products/product-8.jpg" width="205" height="205" alt="product">
                                        </a>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo37-product.html">
                                            <img src="/porto/assets/images/demoes/demo37/products/product-11.jpg" width="205" height="205" alt="product">
                                        </a>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo37-product.html">
                                            <img src="/porto/assets/images/demoes/demo37/products/product-10.jpg" width="205" height="205" alt="product">
                                        </a>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo37-product.html">
                                            <img src="/porto/assets/images/demoes/demo37/products/product-9.jpg" width="205" height="205" alt="product">
                                        </a>
                                        ...
                                        <ul class="cat-list">
                                            <li>
                                                <a href="#widget-category-1">
                                                    Accessories<span class="products-count">(2)</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#widget-category-2">
                                                    Baby<span class="products-count">(1)</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#widget-category-3">
                                                    Boys<span class="products-count">(2)</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#widget-category-4">
                                                    Girls<span class="products-count">(2)</span>
                                                </a>
                                            </li>

                                            <li><a href="#">Jewelry</a><span class="products-count">(1)</span></li>
                                            <li><a href="#">Men</a><span class="products-count">(9)</span></li>
                                            <li><a href="#">Shoes</a><span class="products-count">(2)</span></li>
                                            <li><a href="#">Underwear</a><span class="products-count">(1)</span></li>
                                            <li><a href="#">Women</a><span class="products-count">(6)</span></li>
                                        </ul>
                                    </div>
                                    <!-- End .widget-body -->
                                </div>
                                    ...
                                    <div class="owl-carousel widget-featured-products">
                                        <div class="featured-col">
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title">
                                                        <a href="/porto/demo37-product.html">Blue Backpack for the Young -
                                                            S</a>
                                                    </h3>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                            ...
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo37-product.html">Casual
                                            ...
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo37-product.html">Men Black
                                                            Gentle Belt</a> </h3>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                                            <span class="ratings" style="width:100%"></span>
                                        ...
                                        <div class="featured-col">
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo37-product.html">Ultimate 3D
                                            ...
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo37-product.html">Brown Women
                                                            Casual HandBag</a> </h3>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                                            <span class="ratings" style="width:100%"></span>
                                            ...
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo37-product.html">Circled

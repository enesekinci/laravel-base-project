...
<div class="category-banner-container bg-gray">
            ...
            <div class="container">
                <nav aria-label="breadcrumb" class="breadcrumb-nav">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/porto/demo2.html"><i class="icon-home"></i></a></li>
                        ...
                        <div class="row products-group">
                                ...
                                <div class="product-default inner-quickview inner-icon">
                                    <figure class="img-effect">
                                        <a href="/porto/demo2-product.html">
                                            <img src="/porto/assets/images/demoes/demo2/products/product-1.jpg" width="205" height="205" alt="product">
                                            <img src="/porto/assets/images/demoes/demo2/products/product-1-2.jpg" width="205" height="205" alt="product">
                                        </a>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure class="img-effect">
                                        <a href="/porto/demo2-product.html">
                                            <img src="/porto/assets/images/demoes/demo2/products/product-2.jpg" width="205" height="205" alt="product" />
                                        </a>
                                        <div class="btn-icon-group">
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure class="img-effect">
                                        <a href="/porto/demo2-product.html">
                                            <img src="/porto/assets/images/demoes/demo2/products/product-3.jpg" width="205" height="205" alt="product">
                                        </a>
                                        <div class="label-group">
                                            <div class="product-label label-hot">HOT</div>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure class="img-effect">
                                        <a href="/porto/demo2-product.html">
                                            <img src="/porto/assets/images/demoes/demo2/products/product-4.jpg" width="205" height="205" alt="product">
                                        </a>
                                        <div class="btn-icon-group">
                                            <a href="/porto/demo2-product.html" class="btn-icon btn-add-cart"><i
                                                    class="fa fa-arrow-right"></i>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure class="img-effect">
                                        <a href="/porto/demo2-product.html">
                                            <img src="/porto/assets/images/demoes/demo2/products/product-5.jpg" width="205" height="205" alt="product">
                                        </a>
                                        <div class="btn-icon-group">
                                            <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                    class="icon-shopping-cart"></i></a>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure class="img-effect">
                                        <a href="/porto/demo2-product.html">
                                            <img src="/porto/assets/images/demoes/demo2/products/product-6.jpg" width="205" height="205" alt="product">
                                        </a>
                                        <div class="btn-icon-group">
                                            <a href="/porto/demo2-product.html" class="btn-icon btn-add-cart"><i
                                                    class="fa fa-arrow-right"></i>
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo2-product.html">Brown Long Shoes</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo2-product.html">Brown-Black Men Casual Glasses</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo2-product.html">Black Men Casual Glasses</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo2-product.html">Basketball Sports Blue Shoes</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo2-product.html">Men Sports Travel Bag</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo2-product.html">Brown HandBag</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span>
                                    ...
                                    <div class="owl-carousel widget-featured-products">
                                        <div class="featured-col">
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo2-product.html">Blue
                                            ...
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo2-product.html">Casual
                                            ...
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo2-product.html">Men Black
                                                            Gentle Belt</a> </h3>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                                            <span class="ratings" style="width:100%"></span>
                                        ...
                                        <div class="featured-col">
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo2-product.html">Ultimate 3D
                                            ...
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo2-product.html">Brown Women
                                                            Casual HandBag</a> </h3>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                                            <span class="ratings" style="width:100%"></span>
                                            ...
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo2-product.html">Circled

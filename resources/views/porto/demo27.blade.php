...
@section('footer')
    @include('components.porto.footer-demo27')
@endsection


@section('header')
    @include('components.porto.header-demo27')
@endsection
                    ...
                    <div class="home-slider slide-animate owl-carousel owl-theme owl-carousel-lazy">
                        <div class="home-slide home-slide-1 banner d-flex flex-wrap">
                            <div class="col-lg-4 d-flex justify-content-center">
                                <div class="d-flex flex-column justify-content-center appear-animate"
                                    ...
                                    <div>
                                        <a href="/porto/demo27-shop.html" class="btn btn-dark btn-lg">Shop all sale</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-8 with-bg"
                                style="background-image: url(/porto/assets/images/demoes/demo27/slider/slide-bg.png);">
                                <div class="appear-animate" data-animation-name="fadeInLeftShorter"
                                    data-animation-delay="500">
                                    <img class="m-b-5" src="/porto/assets/images/demoes/demo27/slider/slide-1.png" width="740"
                        ...
                        <div class="home-slide home-slide-2 banner d-flex flex-wrap">
                            ...
                            <div class="col-lg-7 order-lg-first text-lg-right appear-animate"
                                ...
                                <img class="m-b-5" src="/porto/assets/images/demoes/demo27/slider/slide-2.png" width="740"
                                    height="397" alt="banner" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="products-slider 5col owl-carousel owl-theme appear-animate" data-owl-options="{
                            ...
                            <div class="product-default">
                                <figure>
                                    <a href="/porto/demo27-product.html">
                                        <img src="/porto/assets/images//demoes/demo27/products/product-1.jpg" width="280"
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo27-product.html">Black Bike</a>
                                    </h3>
                            ...
                            <div class="product-default">
                                <figure>
                                    <a href="/porto/demo27-product.html">
                                        <img src="/porto/assets/images//demoes/demo27/products/product-2.jpg" width="280"
                                            height="280" alt="product">
                                    </a>
                                    <div class="label-group">
                                        <div class="product-label label-hot">HOT</div>
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo27-product.html">Porto Fashion Bike</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:80%"></span><!-- End .ratings -->
                            ...
                            <div class="product-default">
                                <figure>
                                    <a href="/porto/demo27-product.html">
                                        <img src="/porto/assets/images//demoes/demo27/products/product-3.jpg" width="280"
                                            height="280" alt="product">
                                    </a>
                                    <div class="label-group">
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo27-product.html">Green Bike</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                    ...
                                    <div class="product-action">
                                        <a href="/porto/wishlist.html" class="btn-icon-wish" title="wishlist"><i
                                                class="icon-heart"></i></a>
                                        <a href="/porto/demo27-product.html" class="btn-icon btn-add-cart"><i
                            ...
                            <div class="product-default">
                                <figure>
                                    <a href="/porto/demo27-product.html">
                                        <img src="/porto/assets/images//demoes/demo27/products/product-4.jpg" width="280"
                                            height="280" alt="product">
                                    </a>
                                    <div class="label-group">
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo27-product.html">White Bike</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:80%"></span><!-- End .ratings -->
                            ...
                            <div class="product-default">
                                <figure>
                                    <a href="/porto/demo27-product.html">
                                        <img src="/porto/assets/images//demoes/demo27/products/product-5.jpg" width="280"
                                            height="280" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo27-product.html">Casual Bike</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:80%"></span><!-- End .ratings -->
                            ...
                            <div class="product-default">
                                <figure>
                                    <a href="/porto/demo27-product.html">
                                        <img src="/porto/assets/images//demoes/demo27/products/product-6.jpg" width="280"
                                            height="280" alt="product">
                                    </a>
                                    <div class="label-group">
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo27-product.html">Blue Bike</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                    ...
                    <div class="categories-slider owl-carousel owl-theme mb-4 appear-animate" data-owl-options="{
                        ...
                        <div class="product-category">
                            <img src="/porto/assets/images/demoes/demo27/icons/icon-1.png" alt="icon" width="60" height="60">
                            <div class="category-content">
                                <h3 class="font2 ls-0 text-uppercase mb-0">Bike Saddles</h3>
                            </div>
                        </div>
                        <div class="product-category">
                            <img src="/porto/assets/images/demoes/demo27/icons/icon-2.png" alt="icon" width="60" height="60">
                            <div class="category-content">
                                <h3 class="font2 ls-0 text-uppercase mb-0">Bike Pedals</h3>
                            </div>
                        </div>
                        <div class="product-category">
                            <img src="/porto/assets/images/demoes/demo27/icons/icon-3.png" alt="icon" width="60" height="60">
                            <div class="category-content">
                                <h3 class="font2 ls-0 text-uppercase mb-0">Bike Frames</h3>
                            </div>
                        </div>
                        <div class="product-category">
                            <img src="/porto/assets/images/demoes/demo27/icons/icon-4.png" alt="icon" width="60" height="60">
                            <div class="category-content">
                                <h3 class="font2 ls-0 text-uppercase mb-0">Bike Chains</h3>
                            </div>
                        </div>
                        <div class="product-category">
                            <img src="/porto/assets/images/demoes/demo27/icons/icon-5.png" alt="icon" width="60" height="60">
                            <div class="category-content">
                ...
                <div class="row row-sm">
                    <div class="col-md-4">
                        <div class="banner banner1 appear-animate" data-animation-name="fadeIn"
                            ...
                            <figure>
                                <img src="/porto/assets/images/demoes/demo27/banners/banner-1.jpg" alt="banner" width="640"
                                    height="640">
                            </figure>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="banner banner2 h-100"
                            style="background: #101010 no-repeat center/cover url(/porto/assets/images/demoes/demo27/banners/banner-2.jpg);">
                    ...
                    <div class="row appear-animate" data-animation-name="fadeInUpShorter" data-animation-delay="200">
                        <div class="products-slider 5col owl-carousel owl-theme" data-owl-options="{
                            ...
                            <div class="product-default">
                                <figure>
                                    <a href="/porto/demo27-product.html">
                                        <img src="/porto/assets/images//demoes/demo27/products/product-7.jpg" width="280"
                                            height="280" alt="product">
                                    </a>
                                    <div class="label-group">
                                        <div class="product-label label-hot">HOT</div>
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo27-product.html">Bike Kit</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:80%"></span><!-- End .ratings -->
                            ...
                            <div class="product-default">
                                <figure>
                                    <a href="/porto/demo27-product.html">
                                        <img src="/porto/assets/images//demoes/demo27/products/product-8.jpg" width="280"
                                            height="280" alt="product">
                                    </a>
                                    <div class="label-group">
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo27-product.html">Bike Glasses</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:0%"></span><!-- End .ratings -->
                            ...
                            <div class="product-default">
                                <figure>
                                    <a href="/porto/demo27-product.html">
                                        <img src="/porto/assets/images//demoes/demo27/products/product-9.jpg" width="280"
                                            height="280" alt="product">
                                    </a>
                                    <div class="label-group">
                                        <div class="product-label label-hot">HOT</div>
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo27-product.html">Bike Frames</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                            ...
                            <div class="product-default">
                                <figure>
                                    <a href="/porto/demo27-product.html">
                                        <img src="/porto/assets/images//demoes/demo27/products/product-10.jpg" width="280"
                                            height="280" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo27-product.html">Bike Chain</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:80%"></span><!-- End .ratings -->
                    ...
                    <div class="row">
                        <div class="col-xl-6 mb-2">
                            <div class="banner banner3 d-flex flex-wrap align-items-center bg-gray h-100 appear-animate"
                                ...
                                <div class="col-sm-4">
                                    <img src="/porto/assets/images/demoes/demo27/banners/banner-3.jpg" alt="banner" width="232"
                                        height="124">
                                </div>
                                <div class="col-sm-4 text-center">
                                    <a href="/porto/demo27-shop.html" class="btn btn-dark">Shop All Sale</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 mb-2">
                            <div class="banner banner4 d-flex flex-wrap align-items-center bg-primary h-100 appear-animate"
                                ...
                                <div class="col-sm-4">
                                    <img src="/porto/assets/images/demoes/demo27/banners/banner-4.jpg" alt="banner" width="232"
                                        height="124">
                                </div>
                                <div class="col-sm-4 text-center">
                                    <a href="/porto/demo27-shop.html" class="btn btn-light">Shop All Sale</a>
                                </div>
                            </div>
                        </div>
                    </div>

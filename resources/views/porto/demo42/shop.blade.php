...
<div class="container">
                <nav aria-label="breadcrumb" class="breadcrumb-nav">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/porto/demo42.html"><i class="icon-home"></i></a></li>
                        ...
                        <div class="row">
                                ...
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo42-product.html">
                                            <img src="/porto/assets/images/demoes/demo42/product/product15-300x300.jpg"
                                    ...
                                    <div class="product-details">
                                        <div class="category-wrap">
                                            ...
                                            <a href="/porto/wishlist.html" class="btn-icon-wish"><i class="icon-heart"></i></a>
                                        </div>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo42-product.html">
                                            <img src="/porto/assets/images/demoes/demo42/product/product1-300x300.jpg"
                                                width="300" height="300" alt="product">
                                        </a>
                                        <div class="label-group">
                                            <span class="product-label label-sale">-13%</span>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo42-product.html">
                                            <img src="/porto/assets/images/demoes/demo42/product/product4-300x300.jpg"
                                                width="300" height="300" alt="product">
                                        </a>
                                        <div class="label-group">
                                            <span class="product-label label-sale">-13%</span>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo42-product.html">
                                            <img src="/porto/assets/images/demoes/demo42/product/product9-300x300.jpg"
                                                width="300" height="300" alt="product">
                                        </a>
                                        <div class="label-group">
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo42-product.html">
                                            <img src="/porto/assets/images/demoes/demo42/product/product5-300x300.jpg"
                                                width="300" height="300" alt="product">
                                        </a>
                                        <div class="btn-icon-group">
                                            <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                    ...
                                    <div class="owl-carousel widget-featured-products">
                                        <div class="featured-col">
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo42-product.html">Product
                                                            Short Name</a> </h3>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                                            <span class="ratings" style="width:100%"></span>
                                            ...
                                            <div class="product-default left-details product-widget">
                                                <figure>
                                                    <a href="/porto/demo42-product.html">
                                                        <img src="/porto/assets/images/demoes/demo42/product/product2-300x300.jpg"
                                                            width="75" height="75" alt="product" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">

                        ...
                        <div class="row">
                                ...
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo35-product.html">
                                            <img src="/porto/assets/images/demoes/demo35/products/product-6.jpg" width="217"
                            ...
                            <div class="col-6 col-sm-4 col-xl-3">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo35-product.html">
                                            <img src="/porto/assets/images/demoes/demo35/products/product-7.jpg" width="217"
                                                height="217" alt="product">
                                        </a>
                            ...
                            <div class="col-6 col-sm-4 col-xl-3">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo35-product.html">
                                            <img src="/porto/assets/images/demoes/demo35/products/product-2.jpg" width="217"
                                                height="217" alt="product">
                                        </a>
                                        <div class="label-group">
                                            <div class="product-label label-hot">HOT</div>
                            ...
                            <div class="col-6 col-sm-4 col-xl-3">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo35-product.html">
                                            <img src="/porto/assets/images/demoes/demo35/products/product-3.jpg" width="217"
                                                height="217" alt="product">
                                        </a>
                                        <div class="label-group">
                                            <div class="product-label label-hot">HOT</div>
                            ...
                            <div class="col-6 col-sm-4 col-xl-3">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo35-product.html">
                                            <img src="/porto/assets/images/demoes/demo35/products/product-19.jpg" width="217"
                                                height="217" alt="product">
                                        </a>
                                        <div class="btn-icon-group">
                                            <a href="/porto/demo35-product.html"
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo35-product.html">Apple</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:0%"></span>
                            ...
                            <div class="widget">
                                ...
                                <div class="collapse show" id="widget-body-2">
                                    <div class="widget-body">
                                        <ul class="cat-list">
                                            <li><a href="#">Breakfast <span class="product-count">(8)</span></a></li>
                                            <li><a href="#">Cooking <span class="product-count">(4)</span></a></li>
                                            <li><a href="#">Frozen <span class="product-count">(4)</span></a></li>
                                            <li><a href="#">Fruits <span class="product-count">(10)</span></a></li>
                                            <li><a href="#">Vegetables <span class="product-count">(1)</span></a></li>
                                        </ul>
                                    </div><!-- End .widget-body -->
                                </div><!-- End .collapse -->
                            </div><!-- End .widget -->
                            ...
                            <div class="widget widget-brand">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-body-6" role="button" aria-expanded="true"
                                        aria-controls="widget-body-6">Made By</a>
                                </h3>
                                ...
                                <div class="widget-body">
                                    <div class="featured-col">
                                        <div class="product-default left-details product-widget">
                                            ...
                                            <div class="product-details">
                                                <h3 class="product-title"> <a href="/porto/demo35-product.html">Temperos</a>
                                                </h3>
                                                <div class="ratings-container">
                                                    <div class="product-ratings">
                                                        <span class="ratings" style="width:0"></span>
                                        ...
                                        <div class="product-default left-details product-widget">
                                            ...
                                            <div class="product-details">
                                                <h3 class="product-title"> <a href="/porto/demo35-product.html">Clasico</a>
                                                </h3>
                                                <div class="ratings-container">
                                                    <div class="product-ratings">
                                                        <span class="ratings" style="width:0%"></span>
                                        ...
                                        <div class="product-default left-details product-widget">
                                            ...
                                            <div class="product-details">
                                                <h3 class="product-title"> <a href="/porto/demo35-product.html">Coffee</a>
                                                </h3>
                                                <div class="ratings-container">
                                                    <div class="product-ratings">
                                                        <span class="ratings" style="width:100%"></span>
                                        ...
                                        <div class="product-default left-details product-widget">
                                            ...
                                            <div class="product-details">
                                                <h3 class="product-title"> <a href="/porto/demo35-product.html">Grape</a> </h3>
                                                <div class="ratings-container">
                                                    <div class="product-ratings">
                                                        <span class="ratings" style="width:100%"></span>
                                                        <!-- End .ratings -->
                                        ...
                                        <div class="product-default left-details product-widget">
                                            ...
                                            <div class="product-details">
                                                <h3 class="product-title"> <a href="/porto/demo35-product.html">Magic Toast</a>
                                                </h3>
                                                <div class="ratings-container">
                                                    <div class="product-ratings">
                                                        <span class="ratings" style="width:100%"></span>

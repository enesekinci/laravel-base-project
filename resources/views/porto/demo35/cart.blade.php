...
<div class="container">
				<ul class="checkout-progress-bar d-flex justify-content-center flex-wrap">
					<li class="active">
						<a href="/porto/demo35-cart.html">Shopping Cart</a>
					</li>
					<li>
						<a href="/porto/demo35-checkout.html">Checkout</a>
					</li>
					<li class="disabled">
						<a href="/porto/demo35-cart.html">Order Complete</a>
					</li>
				</ul>
					...
					<div class="col-lg-4">
						<div class="cart-summary">
							...
							<div class="checkout-methods">
								<a href="/porto/demo35-cart.html" class="btn btn-block btn-dark">Proceed to Checkout

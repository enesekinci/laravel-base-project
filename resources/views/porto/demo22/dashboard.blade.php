...
<div class="page-header">
				<div class="container d-flex flex-column align-items-center">
					<nav aria-label="breadcrumb" class="breadcrumb-nav">
						<div class="container">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="/porto/demo22.html">Home</a></li>
								<li class="breadcrumb-item"><a href="/porto/demo22-category.html">Shop</a></li>
				...
				<div class="row">
					<div class="sidebar widget widget-dashboard mb-lg-0 mb-3 col-lg-3 order-0">
						...
						<ul class="nav nav-tabs list flex-column mb-0" role="tablist">
							...
							<li class="nav-item">
								<a class="nav-link" href="/porto/demo22-wishlist.html">Wishlist</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="/porto/demo22-login.html">Logout</a>
							</li>
						</ul>
					</div>
						...
						<div class="tab-pane fade show active" id="dashboard" role="tabpanel">
							<div class="dashboard-content">
								<p>
									...
									<a href="/porto/demo22-login.html" class="btn btn-link ">Log out</a>)
								</p>
								...
								<div class="row row-lg">
									...
									<div class="col-6 col-md-4">
										<div class="feature-box text-center pb-4">
											<a href="/porto/demo22-wishlist.html"><i class="sicon-heart"></i></a>
											<div class="feature-box-content">
												<h3>WISHLIST</h3>
											</div>
										</div>
									...
									<div class="col-6 col-md-4">
										<div class="feature-box text-center pb-4">
											<a href="/porto/demo22-login.html"><i class="sicon-logout"></i></a>
											<div class="feature-box-content">
												<h3>LOGOUT</h3>
											</div>
										</div>
						...
						<div class="tab-pane fade" id="order" role="tabpanel">
							<div class="order-content">
								...
								<div class="order-table-container text-center">
									...
									<a href="/porto/demo22-category.html" class="btn btn-dark">Go Shop</a>
								</div>
							</div>
						</div><!-- End .tab-pane -->
						...
						<div class="tab-pane fade" id="download" role="tabpanel">
							<div class="download-content">
								...
								<div class="download-table-container">
									<p>No downloads available yet.</p> <a href="/porto/demo22-category.html"

...
<div class="container">
                ...
                <div class="row main-content">
                    <div class="col-lg-9">
                        <div class="category-banner banner bg-gray py-3 mb-3">
                            <div class="row m-0 no-gutters align-items-center">
                                ...
                                <div class="col-sm-4">
                                    <figure>
                                        <img src="/porto/assets/images/demoes/demo22/banners/category-banner.jpg" alt="banner"
                                ...
                                <div class="col-sm-4">
                                    <div class="coupon-sale-text d-flex flex-column align-items-start mb-4">
                                        <h4 class="m-b-2 font1 ls-10 text-white bg-dark skew-box">Exclusive
                                            COUPON</h4>
                                        <h5 class="mb-0 font1 d-inline-block bg-dark skew-box"><i
                                                class="text-dark ls-0">UP
                                                TO</i><b class="text-white">$100</b><sub class="text-dark">OFF</sub>
                                        </h5>
                                    </div>

                                    <a href="#" class="btn btn-light btn-lg font1 ml-0">View All Now</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row divide-line no-gutters m-0">
                                ...
                                <div class="product-default inner-icon inner-quickview">
                                    <figure>
                                        <a href="/porto/demo22-product.html">
                                            <img src="/porto/assets/images/demoes/demo22/products/product-4.jpg" width="217"
                            ...
                            <div class="col-6 col-sm-4 col-xl-3">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo22-product.html">
                                            <img src="/porto/assets/images/demoes/demo22/products/product-7.jpg" width="217"
                                                height="217" alt="product">
                                        </a>
                                        <div class="btn-icon-group">
                                            <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo22-product.html">Black Watch</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:0%"></span><!-- End .ratings -->
                                        ...
                                        <div class="price-box">
                                            <span class="product-price">$555.00 &ndash; $666.00</span>
                                        </div><!-- End .price-box -->
                                    </div><!-- End .product-details -->
                                </div>
                            </div><!-- End .col-xl-3 -->
                            ...
                            <div class="col-6 col-sm-4 col-xl-3">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo22-product.html">
                                            <img src="/porto/assets/images/demoes/demo22/products/product-11.jpg" width="217"
                                                height="217" alt="product">
                                        </a>
                                        <div class="btn-icon-group">
                                            <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                            ...
                            <div class="col-6 col-sm-4 col-xl-3">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo22-product.html">
                                            <img src="/porto/assets/images/demoes/demo22/products/product-10.jpg" width="217"
                                                height="217" alt="product">
                                        </a>
                                        <div class="label-group">
                            ...
                            <div class="col-6 col-sm-4 col-xl-3">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo22-product.html">
                                            <img src="/porto/assets/images/demoes/demo22/products/product-6.jpg" width="217"
                                                height="217" alt="product">
                                        </a>
                                        <div class="label-group">
                                            <div class="product-label label-hot">HOT</div>
                            ...
                            <div class="col-6 col-sm-4 col-xl-3">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo22-product.html">
                                            <img src="/porto/assets/images/demoes/demo22/products/product-13.jpg" width="217"
                                                height="217" alt="product">
                                        </a>
                                        <div class="btn-icon-group">
                                            <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                            ...
                            <div class="col-6 col-sm-4 col-xl-3">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo22-product.html">
                                            <img src="/porto/assets/images/demoes/demo22/products/product-17.jpg" width="217"
                                                height="217" alt="product">
                                        </a>
                                        <div class="label-group">
                                ...
                                <div class="widget-body">
                                    <div class="featured-col">
                                        <div class="product-default left-details product-widget">
                                            <figure>
                                                <a href="/porto/demo22-product.html">
                                                    <img src="/porto/assets/images/demoes/demo22/products/small/product-1.jpg"
                                        ...
                                        <div class="product-default left-details product-widget">
                                            <figure>
                                                <a href="/porto/demo22-product.html">
                                                    <img src="/porto/assets/images/demoes/demo22/products/small/product-2.jpg"
                                                        width="75" height="75" alt="product" />
                                                </a>
                                            </figure>
                                            <div class="product-details">

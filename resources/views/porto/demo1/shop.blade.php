                    ...
                    <div class="col-lg-9 mb-1">
                        <div class="home-slider category-home-slider owl-carousel owl-theme owl-carousel-lazy" data-owl-options="{
                            ...
                            <div class="home-slide home-slide1 banner banner-md-vw banner-sm-vw d-flex align-items-center">
                                <img class="owl-lazy slide-bg" src="/porto/assets/images/lazy.png" style="background-color: #71b5da;" data-src="/porto/assets/images/demoes/demo1/banners/banner-4.jpg" width="880" height="280" alt="category-banenr">
                                <div class="banner-layer">
                                    ...
                                    <a href="/porto/demo1-shop.html" class="btn btn-dark btn-md">GET YOURS!</a>
                                </div>
                                <!-- End .banner-layer -->
                            </div>
                            <!-- End .home-slide -->
                            ...
                            <div class="home-slide home-slide2 banner banner-md-vw banner-sm-vw d-flex align-items-center">
                                <img class="owl-lazy slide-bg" src="/porto/assets/images/lazy.png" data-src="/porto/assets/images/demoes/demo1/banners/banner-5.jpg" width="880" height="280" alt="category-banenr">
                            ...
                            <div class="home-slide home-slide3 banner banner-md-vw banner-sm-vw  d-flex align-items-center">
                                <img class="owl-lazy slide-bg" src="/porto/assets/images/lazy.png" data-src="/porto/assets/images/demoes/demo1/banners/banner-6.jpg" width="880" height="280" alt="category-banenr" />
                                <div class="banner-layer text-uppercase">
                        ...
                        <nav class="toolbox sticky-header mt-2" data-sticky-options="{'mobile': true}">
                            ...
                            <div class="toolbox-right">
                                ...
                                <div class="toolbox-item layout-modes">
                                    <a href="/porto/demo1-shop.html" class="layout-btn btn-grid active" title="Grid">
                            ...
                            <div class="col-6 col-sm-4 col-md-3">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo1-product.html">Brown-Black Men Casual Glasses</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span>
                            ...
                            <div class="col-6 col-sm-4 col-md-3">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo1-product.html">Black Men Casual Glasses</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span>
                            ...
                            <div class="col-6 col-sm-4 col-md-3">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo1-product.html">Basketball Sports Blue Shoes</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span>
                            ...
                            <div class="col-6 col-sm-4 col-md-3">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo1-product.html">Men Sports Travel Bag</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span>
                            ...
                            <div class="col-6 col-sm-4 col-md-3">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo1-product.html">Brown HandBag</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span>

...
@section('header')
    @include('porto.demo15.header')
@endsection

@section('footer')
    @include('porto.demo15.footer')
@endsection

@section('content')
<div class="container">
                <div class="sale-banner">
                    <div class="banner banner-caty" style="background-color: #ffab8c;">
                        <img src="/porto/assets/images/demoes/demo15/banners/banner-4.jpg" width="1120" height="380" alt="banner" />
                        <div class="banner-layer banner-layer-middle banner-layer-left">
                            <h5 class="font-weight-normal font3 text-left">Outlet Selected Items</h5>
                        ...
                        <div class="row products-group products-caty">
                                ...
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo15-product.html">
                                            <img src="/porto/assets/images/demoes/demo15/products/product-10.jpg" alt="product" width="400" height="400">
                                        </a>
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="/porto/demo15-product.html">Black Jacket</a> </h3>
                            ...
                            <div class="col-6 col-md-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo15-product.html">
                                            <img src="/porto/assets/images/demoes/demo15/products/product-7.jpg" alt="product" width="400" height="400">
                                        </a>
                                        <div class="label-group">
                                            <span class="product-label label-sale">-26%</span>
                                        </div>
                            ...
                            <div class="col-6 col-md-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo15-product.html">
                                            <img src="/porto/assets/images/demoes/demo15/products/dot-3.jpg" alt="product" width="400" height="400">
                                        </a>
                                        <div class="label-group">
                                            <span class="product-label label-sale">-26%</span>
                                        </div>
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="/porto/demo15-product.html">Gentle Shoes</a> </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:0%"></span>
                                                <!-- End .ratings -->
                                ...
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        <div class="category-wrap">
                                            <div class="category-list">
                                                <a href="/porto/demo15-shop.html" class="product-category">headphone</a>,
                                                <a href="/porto/demo15-shop.html" class="product-category">T-shirt</a>
                                            </div>
                                            <a href="#" class="btn-icon-wish">
                                                <i class="icon-heart"></i>
                                            </a>
                                        </div>
                                        <h3 class="product-title"> <a href="/porto/demo15-product.html">Jeans Wear</a> </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:0%"></span>
                                                <!-- End .ratings -->
                            ...
                            <div class="col-6 col-md-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo15-product.html">
                                            <img src="/porto/assets/images/demoes/demo15/products/dot-1.jpg" alt="product" width="400" height="400">
                                        </a>
                                        <div class="label-group">
                                            <span class="product-label label-sale">-26%</span>
                                        </div>
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="/porto/demo15-product.html">Men Shoes Black</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:0%"></span>
                            ...
                            <div class="col-6 col-md-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo15-product.html">
                                            <img src="/porto/assets/images/demoes/demo15/products/product-14.jpg" alt="product" width="400" height="400">
                                        </a>
                                        <div class="label-group">
                                            <span class="product-label label-sale">-26%</span>
                                        </div>
                            ...
                            <div class="col-6 col-md-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="/porto/demo15-product.html">Woman Black Blouse</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:0%"></span>
                            ...
                            <div class="col-6 col-md-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="/porto/demo15-product.html">Woman Jacket</a> </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:0%"></span>
                                                <!-- End .ratings -->
                            ...
                            <div class="col-6 col-md-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="/porto/demo15-product.html">Porto Sticky info</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:0%"></span>
                    ...
                    <aside class="sidebar-shop col-lg-3 order-lg-first mobile-sidebar">
                        <div class="sidebar-wrapper">
                            ...
                            <div class="widget widget-brand">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-body-6" role="button" aria-expanded="true" aria-controls="widget-body-5">Brand</a>
                                </h3>

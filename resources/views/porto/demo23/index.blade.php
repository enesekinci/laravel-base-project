...
<section class="intro-section mb-3">
                <div class="home-slider slide-animate owl-carousel owl-theme" data-owl-options="{
                    ...
                    <div class="home-slide home-slide-1 banner">
                        <img class="slide-bg" src="/porto/assets/images/demoes/demo23/slider/slide-1.jpg" alt="slider image"
                        ...
                        <div class="banner-layer banner-layer-middle banner-layer-left">
                            <div class="container-fluid">
                                <div class="appear-animate" data-animation-name="fadeInLeftShorter"
                                    ...
                                    <a href="/porto/demo23-shop.html" class="btn btn-link"><i>View
                                            our
                    ...
                    <div class="home-slide home-slide-2 banner">
                        <img class="slide-bg" src="/porto/assets/images/demoes/demo23/slider/slide-2.jpg" alt="slider image"
                            width="1200" height="575">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-8 col-lg-6">
                            <div class="banner banner1 mb-2 appear-animate" data-animation-name="fadeIn"
                                ...
                                <figure>
                                    <img src="/porto/assets/images/demoes/demo23/banners/banner-1.jpg" alt="banner" width="580"
                                        height="374">
                                </figure>
                                ...
                                <div class="banner-layer d-flex flex-column align-items-end justify-content-center">
                                    <div class="text-justify">
                                        ...
                                        <a href="/porto/demo23-shop.html" class="btn btn-link"><i>View our Deals</i><i
                        ...
                        <div class="col-md-4 col-lg-3">
                            <div class="banner banner2 mb-2 appear-animate" data-animation-name="fadeIn"
                                ...
                                <figure>
                                    <img src="/porto/assets/images/demoes/demo23/banners/banner-2.jpg" alt="banner" width="280"
                                        height="374">
                                </figure>
                                ...
                                <div class="banner-layer d-flex flex-column align-items-center justify-content-end">
                                    ...
                                    <a href="/porto/demo23-shop.html" class="btn btn-link"><i>View our Classics</i><i
                                            class="icon-right-open-big"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                            <div class="banner banner3 mb-2 appear-animate" data-animation-name="fadeIn"
                                ...
                                <figure>
                                    <img src="/porto/assets/images/demoes/demo23/banners/banner-3.jpg" alt="banner" width="280"
                                        height="374">
                                </figure>
                                ...
                                <div class="banner-layer d-flex flex-column align-items-center justify-content-between">
                                    <h2 class="font-weight-bold ls-n-25 text-center text-uppercase">Mother &amp;
                                        Daughter</h2>
                                    <a href="/porto/demo23-shop.html" class="btn btn-link"><i>View our Outfits</i><i
                                            class="icon-right-open-big"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                            <div class="banner banner4 mb-2 appear-animate" data-animation-name="fadeIn"
                                ...
                                <figure>
                                    <img src="/porto/assets/images/demoes/demo23/banners/banner-4.jpg" alt="banner" width="560"
                                        height="374">
                                </figure>
                        ...
                        <div class="col-md-4 col-lg-3">
                            <div class="banner banner5 mb-2 appear-animate" data-animation-name="fadeIn"
                                ...
                                <figure>
                                    <img src="/porto/assets/images/demoes/demo23/banners/banner-5.jpg" alt="banner" width="280"
                                        height="374">
                                </figure>

                                <div class="banner-layer d-flex flex-column align-items-center justify-content-between">
                                    <h2 class="ls-n-25 text-uppercase">Babies dresses</h2>
                                    <a href="/porto/demo23-shop.html" class="btn btn-link"><i>View our Dresses</i><i
                                            class="icon-right-open-big"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8 col-lg-6">
                            <div class="banner banner6 mb-2 appear-animate" data-animation-name="fadeIn"
                                ...
                                <figure>
                                    <img src="/porto/assets/images/demoes/demo23/banners/banner-6.jpg" alt="banner" width="280"
                                        height="374">
                                </figure>
                    ...
                    <div class="row appear-animate" data-animation-name="fadeInUpShorter" data-animation-delay="400">
                            ...
                            <div class="product-default inner-quickview inner-icon">
                                <figure>
                                    <a href="/porto/demo23-product.html">
                                        <img src="/porto/assets/images/demoes/demo23/products/product-1.jpg" width="217"
                                            height="217" alt="product">
                                        <img src="/porto/assets/images/demoes/demo23/products/product-7.jpg" width="217"
                                            height="217" alt="product">
                                    </a>
                                    ...
                                    <div class="btn-icon-group">
                                        <a href="/porto/demo23-product.html" class="btn-icon btn-add-cart"><i
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo23-product.html">Pink Winter Girl Shoes</a>
                                    </h3>
                        ...
                        <div class="col-6 col-md-4 col-xl-3">
                            <div class="product-default inner-quickview inner-icon">
                                <figure>
                                    <a href="/porto/demo23-product.html">
                                        <img src="/porto/assets/images/demoes/demo23/products/product-2.jpg" width="217"
                                            height="217" alt="product">
                                    </a>
                                    <div class="label-group">
                                        <div class="product-label label-hot">HOT</div>
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo23-product.html">Porto Extended Camera</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                        ...
                        <div class="col-6 col-md-4 col-xl-3">
                            <div class="product-default inner-quickview inner-icon">
                                <figure>
                                    <a href="/porto/demo23-product.html">
                                        <img src="/porto/assets/images/demoes/demo23/products/product-3.jpg" width="217"
                                            height="217" alt="product">
                                        <img src="/porto/assets/images/demoes/demo23/products/product-1.jpg" width="217"
                                            height="217" alt="product">
                                    </a>
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo23-product.html">Blue Child Overshoes</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:80%"></span><!-- End .ratings -->
                    ...
                    <div class="col-lg-9">
                        <div class="categories-slider owl-carousel owl-theme" data-owl-options="{
                            ...
                            <div class="product-category" style="background-color: #d8dfe1;">
                                <a href="/porto/demo23-shop.html">
                                    <figure>
                                        <img src="/porto/assets/images/demoes/demo23/products/cats/cat-1.jpg" alt="cat banner"
                            ...
                            <div class="product-category" style="background-color: #ebeae9;">
                                <a href="/porto/demo23-shop.html">
                                    <figure>
                                        <img src="/porto/assets/images/demoes/demo23/products/cats/cat-2.jpg" alt="cat banner"
                                            width="500" height="400">
                                    </figure>
                            ...
                            <div class="product-category" style="background-color: #ead7d5;">
                                <a href="/porto/demo23-shop.html">
                                    <figure>
                                        <img src="/porto/assets/images/demoes/demo23/products/cats/cat-3.jpg" alt="cat banner"
                                            width="500" height="400">
                                    </figure>
                    ...
                    <div class="row">
                        <div class="col-6 col-md-4 col-xl-3">
                            <div class="product-default inner-quickview inner-icon">
                                <figure>
                                    <a href="/porto/demo23-product.html">
                                        <img src="/porto/assets/images/demoes/demo23/products/product-5.jpg" width="217"
                                            height="217" alt="product">
                                    </a>
                                    <div class="label-group">
                                        <div class="product-label label-hot">HOT</div>
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo23-product.html">Smart Watches</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:80%"></span><!-- End .ratings -->
                        ...
                        <div class="col-6 col-md-4 col-xl-3">
                            <div class="product-default inner-quickview inner-icon">
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/porto/demo23-product.html">Rag baby doll</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:80%"></span><!-- End .ratings -->
            ...
            <div class="brands-section">
                <div class="container">
                    ...
                    'responsive': {
                        ...
                        <img src="/porto/assets/images/demoes/demo23/brands/brand1.png" width="200" height="50" alt="brand">
                        <img src="/porto/assets/images/demoes/demo23/brands/brand2.png" width="200" height="50" alt="brand">
                        <img src="/porto/assets/images/demoes/demo23/brands/brand3.png" width="200" height="50" alt="brand">
                        <img src="/porto/assets/images/demoes/demo23/brands/brand4.png" width="200" height="50" alt="brand">
                        <img src="/porto/assets/images/demoes/demo23/brands/brand5.png" width="200" height="50" alt="brand">

                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 text-center">
                                <img src="/porto/assets/images/demoes/demo23/banners/category-banner.png" alt="banner"
                        ...
                        <div class="row">
                                ...
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo23-product.html">
                                            <img src="/porto/assets/images/demoes/demo23/products/product-8.jpg" width="217"
                                    ...
                                    <div class="product-details">
                                        <div class="category-wrap">
                                            <div class="category-list">
                                                <a href="/porto/demo23-product.html" class="product-category">Category</a>
                                            </div>
                                            <a href="/porto/wishlist.html" title="Wishlist" class="btn-icon-wish"><i
                                                    class="icon-heart"></i></a>
                                        </div>
                                        <h3 class="product-title">
                                            <a href="/porto/demo23-product.html">Baby Sport Shoes</a>
                                        </h3>
                            ...
                            <div class="col-6 col-sm-4 col-lg-3">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo23-product.html">Blue Baby Winter Shoes</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:0%"></span><!-- End .ratings -->
                            ...
                            <div class="col-6 col-sm-4 col-lg-3">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo23-product.html">
                                            <img src="/porto/assets/images/demoes/demo23/products/product-12.jpg" width="217"
                                                height="217" alt="product">
                                        </a>
                                        <div class="btn-icon-group">
                                            <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo23-product.html">Casual Brown Shoes</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                            ...
                            <div class="col-6 col-sm-4 col-lg-3">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo23-product.html">
                                            <img src="/porto/assets/images/demoes/demo23/products/product-13.jpg" width="217"
                                                height="217" alt="product">
                                        </a>
                                        <div class="label-group">
                                            <div class="product-label label-sale">-35%</div>
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo23-product.html">Pink Baby Caps</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:0%"></span><!-- End .ratings -->
                                ...
                                <div class="widget-body">
                                    <div class="featured-col">
                                        <div class="product-default left-details product-widget">
                                            <figure>
                                                <a href="/porto/demo23-product.html">
                                                    <img src="/porto/assets/images/demoes/demo23/products/small/product-1.jpg"
                                                        width="75" height="75" alt="product" />
                                                    <img src="/porto/assets/images/demoes/demo23/products/small/product-6.jpg"
                                                        width="75" height="75" alt="product" />
                                                </a>
                                            </figure>
                                            <div class="product-details">
                                        ...
                                        <div class="product-default left-details product-widget">
                                            <figure>
                                                <a href="/porto/demo23-product.html">
                                                    <img src="/porto/assets/images/demoes/demo23/products/small/product-2.jpg"
                                                        width="75" height="75" alt="product" />
                                                </a>
                                            </figure>
                                            <div class="product-details">

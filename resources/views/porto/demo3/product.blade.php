...
@section('header')
    @include('components.porto.demo3.header')
@endsection
...
<nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/porto/demo3.html"><i class="icon-home"></i></a></li>
                    ...
                    <aside class="sidebar-product col-lg-3 mobile-sidebar">
                        <div class="sidebar-wrapper">
                            <div class="widget category-banner pt-0 pb-2 mt-0">
                                <figure>
                                    <img class="slide-bg" src="/porto/assets/images/demoes/demo3/banners/banner-sidebar.jpg"
                                        alt="banner" />
                                </figure>
                                <div class="category-slide-content">
                                    ...
                                    <a href="/porto/demo3-shop.html" class="btn btn-dark btn-xl ml-0" role="button">Shop
                                        Now</a>
                                    ...
                                    <div class="owl-carousel widget-featured-products">
                                        <div class="featured-col">
                                            <div class="product-default left-details product-widget">
                                                <figure>
                                                    <a href="/porto/demo3-product.html">
                                                        <img src="/porto/assets/images/demoes/demo3/products/small/product-4.jpg"
                                                            width="75" height="75" alt="Product" />
                                                        <img src="/porto/assets/images/demoes/demo3/products/small/product-4-2.jpg"
                                                            width="75" height="75" alt="Product" />
                                                    </a>
                                                </figure>
                                            ...
                                            <div class="product-default left-details product-widget">
                                                <figure>
                                                    <a href="/porto/demo3-product.html">
                                                        <img src="/porto/assets/images/demoes/demo3/products/small/product-5.jpg"
                                                            width="75" height="75" alt="Product" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h5 class="product-title">
                                                        <a href="/porto/demo3-product.html">Porto Black Men Watch</a>
                                                    </h5>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                                            <span class="ratings" style="width:100%"></span>
                                            ...
                                            <div class="product-default left-details product-widget">
                                                <figure>
                                                    <a href="/porto/demo3-product.html">
                                                        <img src="/porto/assets/images/demoes/demo3/products/small/product-15.jpg"
                                                            width="75" height="75" alt="Product" />
                                                        <img src="/porto/assets/images/demoes/demo3/products/small/product-15-2.jpg"
                                                            width="75" height="75" alt="Product" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h5 class="product-title">
                                                        <a href="/porto/demo3-product.html">Brown-Black Men Casual Glasses</a>
                                                    </h5>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                                            <span class="ratings" style="width:100%"></span>
                                        ...
                                        <div class="featured-col">
                                            <div class="product-default left-details product-widget">
                                                <figure>
                                                    <a href="/porto/demo3-product.html">
                                                        <img src="/porto/assets/images/demoes/demo3/products/small/product-16.jpg"
                                                            width="75" height="75" alt="Product" />
                                                        <img src="/porto/assets/images/demoes/demo3/products/small/product-16-2.jpg"
                                                            width="75" height="75" alt="Product" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h5 class="product-title">
                                                        <a href="/porto/demo3-product.html">Casual Spring Blue Shoes</a>
                                                    </h5>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                                            <span class="ratings" style="width:100%"></span>
                                            ...
                                            <div class="product-default left-details product-widget">
                                                <figure>
                                                    <a href="/porto/demo3-product.html">
                                                        <img src="/porto/assets/images/demoes/demo3/products/small/product-17.jpg"
                                                            width="75" height="75" alt="Product" />
                                                        <img src="/porto/assets/images/demoes/demo3/products/small/product-17-2.jpg"
                                                            width="75" height="75" alt="Product" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h5 class="product-title">
                                                        <a href="/porto/demo3-product.html">Men Black Gentle Belt</a>
                                                    </h5>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                                            <span class="ratings" style="width:100%"></span>
                                            ...
                                            <div class="product-default left-details product-widget">
                                                <figure>
                                                    <a href="/porto/demo3-product.html">
                                                        <img src="/porto/assets/images/demoes/demo3/products/small/product-18.jpg"
                                                            width="75" height="75" alt="Product" />
                                                        <img src="/porto/assets/images/demoes/demo3/products/small/product-18-2.jpg"
                                                            width="75" height="75" alt="Product" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h5 class="product-title">
                                                        <a href="/porto/demo3-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                    </h5>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                                            <span class="ratings" style="width:100%"></span>

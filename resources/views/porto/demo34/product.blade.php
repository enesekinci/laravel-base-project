...
<div class="container">
                ...
                <div class="product-single-container product-single-default">
                    <div class="cart-message d-none">
                        <strong class="single-cart-notice">“Aerin Rose Oil”</strong>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 product-single-gallery">
                                ...
                                <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="/porto/assets/images/demoes/demo34/products/zoom/product-1.jpg"
                                            data-zoom-image="/porto/assets/images/demoes/demo34/products/zoom/product-1-big.jpg"
                            ...
                            <div class="prod-thumbnail owl-dots">
                                <div class="owl-dot">
                                    <img src="/porto/assets/images/demoes/demo34/products/zoom/product-1.jpg" width="110"
                        ...
                        <div class="col-lg-7 col-md-6 product-single-details">
                            <h1 class="product-title">Aerin Rose Oil</h1>
                            ...
                            <ul class="single-info-list">
                                <li>
                                    CATEGORIES: <strong><a href="#" class="product-category">BODY CARE</a>, <a href="#"
                                            class="product-category">SHAMPOO</a>, <a href="#"
                                            class="product-category">STYLING</a></strong>
                                </li>
                            </ul>
                    ...
                    <div class="tab-content font2">
                        ...
                        <div class="tab-pane fade" id="product-reviews-content" role="tabpanel"
                            ...
                            <div class="product-reviews-content">
                                <h3 class="reviews-title font1 font-italic">1 review for Men Black Sports Shoes</h3>

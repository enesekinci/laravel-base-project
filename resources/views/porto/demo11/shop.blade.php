...
@section('content')
<div class="category-banner" data-parallax="{'offset': -40}"
                ...
                <div class="promo-content d-sm-flex align-items-center justify-content-center">
                    ...
                    <a href="/porto/demo11-shop.html" class="btn btn-light">Shop Now <i
                        ...
                        <div class="row products-group">
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="/porto/demo11-product.html">Black Women Shoes</a>
                                        </h3>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="/porto/demo11-product.html">Black Women Dress</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="/porto/demo11-product.html">Product Gril Jacket</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="/porto/demo11-product.html">Masrinna Ankle
                                                Fashion</a> </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="/porto/demo11-product.html">Product Brown Bag</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo11-product.html">
                                            <img src="/porto/assets/images/demoes/demo11/products/product-20.jpg" width="280"
                                                height="280" alt="product" />
                                            <img src="/porto/assets/images/demoes/demo11/products/product-20-2.jpg" width="280"
                                                height="280" alt="product" />
                                        </a>
                                        <div class="btn-icon-group">
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/demo11-product.html">
                                            <img src="/porto/assets/images/demoes/demo11/products/product-21.jpg" width="280"
                                                height="280" alt="product" />
                                            <img src="/porto/assets/images/demoes/demo11/products/product-21-2.jpg" width="280"
                                                height="280" alt="product" />
                                        </a>
                                        <div class="label-group">
                                            <div class="product-label label-hot">HOT</div>
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/product.html">
                                            <img src="/porto/assets/images/demoes/demo11/products/product-5.jpg" width="280"
                                                height="280" alt="product" />
                                            <img src="/porto/assets/images/demoes/demo11/products/product-5-2.jpg" width="280"
                                                height="280" alt="product" />
                                        </a>
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="/porto/demo11-product.html">Porto Brown Glasses</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    <figure>
                                        <a href="/porto/product.html">
                                            <img src="/porto/assets/images/demoes/demo11/products/product-7.jpg" width="280"
                                                height="280" alt="product" />
                                            <img src="/porto/assets/images/demoes/demo11/products/product-7-2.jpg" width="280"
                                                height="280" alt="product" />
                                        </a>
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="/porto/demo11-product.html">Godlen Glasses</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="/porto/demo11-product.html">Women Fashion-Black</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default inner-quickview inner-icon">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="price-box">
                                            <span class="product-price">$60.00.00</span>
                                        </div><!-- End .price-box -->
                                    </div><!-- End .product-details -->
                                </div>
                            </div><!-- End .col-sm-4 -->
                                    ...
                                    <div class="widget-body">
                                        <form action="#">
                                            ...
                                            <div
                                                ...
                                                <button type="submit" class="btn btn-primary text-dark">Filter</button>

<header class="header mb-2">
                ...
                <div class="container">
                    <div class="header-left pl-0">
                        <nav class="main-nav w-100">
                            <ul class="menu">
                                <li class="active">
                                    <a href="/porto/demo29.html">Home</a>
                                </li>
                                <li>
                                    <a href="/porto/demo29-shop.html">Shop</a>
                                    <div class="megamenu megamenu-fixed-width megamenu-3cols">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <a href="#" class="nolink">VARIATION 1</a>
                                                <ul class="submenu">
                                                    <li><a href="/porto/demo29-shop.html">Fullwidth Banner</a></li>
                                                    ...
                                                    <li><a href="/porto/demo29-shop.html">Left Sidebar</a></li>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <ul class="submenu">
                                                    ...
                                                    <li><a href="/porto/demo29-shop.html">3 Columns Products</a></li>
                                            ...
                                            <div class="col-lg-4 p-0">
                                                <div class="menu-banner">
                                                    ...
                                                    <div class="banner-content">
                                                        ...
                                                        <a href="/porto/demo29-shop.html" class="btn btn-sm btn-dark">SHOP
                                                            NOW</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li>
                                    <a href="/porto/demo29-product.html">Products</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 p-0">
                                                <div class="menu-banner menu-banner-2">
                                                    ...
                                                    <a href="/porto/demo29-shop.html" class="btn btn-sm btn-dark">SHOP NOW</a>
                                                </div>
                                            </div><!-- End .col-lg-4 -->
                                        </div><!-- End .row -->
                                    </div><!-- End .megamenu -->
                    ...
                    <div class="header-center ml-lg-auto ml-0">
                        ...
                        <a href="/porto/demo29.html" class="logo">
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo-product.html" class="product-image">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo-product.html">Brown Women Casual HandBag</a>
                                                </h4>
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo-product.html">Circled Ultimate 3D Speaker</a>
                                                </h4>
            ...
            <div class="container">
                <div class="header-bottom w-100">
                    <h4 class="mb-0 text-center pr-3 pl-3">Get 10% OFF at the Porto Kitchen Selection - <a
                            href="/porto/demo29-shop.html">Shop
                            Now!</a></h4>
                </div>
            </div><!-- End .header-top -->
        </header>
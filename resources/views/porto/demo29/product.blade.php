...
@section('header')
    @include('components.porto.demo29.header')
@endsection

@section('footer')
    @include('components.porto.demo29.footer')
@endsection
                            ...
                            <div class="row">
                                <div class="col-xl-5 col-md-6 product-single-gallery mb-3">
                                        ...
                                        <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                            <div class="product-item">
                                                <img class="product-single-image"
                                                    src="/porto/assets/images/demoes/demo29/products/zoom/product-1-big.jpg"
                                                    data-zoom-image="/porto/assets/images/demoes/demo29/products/zoom/product-1-big.jpg"
                                                    width="468" height="468" alt="product" />
                                            </div>
                                            <div class="product-item">
                                                <img class="product-single-image"
                                                    src="/porto/assets/images/demoes/demo29/products/zoom/product-2-big.jpg"
                                                    data-zoom-image="/porto/assets/images/demoes/demo29/products/zoom/product-2-big.jpg"
                                                    width="468" height="468" alt="product" />
                                            </div>
                                            <div class="product-item">
                                                <img class="product-single-image"
                                                    src="/porto/assets/images/demoes/demo29/products/zoom/product-3-big.jpg"
                                                    data-zoom-image="/porto/assets/images/demoes/demo29/products/zoom/product-3-big.jpg"
                                                    width="468" height="468" alt="product" />
                                            </div>
                                            <div class="product-item">
                                                <img class="product-single-image"
                                                    src="/porto/assets/images/demoes/demo29/products/zoom/product-4-big.jpg"
                                                    data-zoom-image="/porto/assets/images/demoes/demo29/products/zoom/product-4-big.jpg"
                                                    width="468" height="468" alt="product" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="prod-thumbnail owl-dots">
                                        <div class="owl-dot">
                                            <img src="/porto/assets/images/demoes/demo29/products/zoom/product-1.jpg"
                                                width="110" height="110" alt="product-thumbnail" />
                                        </div>
                                        <div class="owl-dot">
                                            <img src="/porto/assets/images/demoes/demo29/products/zoom/product-2.jpg"
                                                width="110" height="110" alt="product-thumbnail" />
                                        </div>
                                        <div class="owl-dot">
                                            <img src="/porto/assets/images/demoes/demo29/products/zoom/product-3.jpg"
                                                width="110" height="110" alt="product-thumbnail" />
                                        </div>
                                        <div class="owl-dot">
                                            <img src="/porto/assets/images/demoes/demo29/products/zoom/product-4.jpg"
                                                width="110" height="110" alt="product-thumbnail" />
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-7 col-md-6 product-single-details">
                                    <h1 class="product-title">Trellis Pillow</h1>
                                                ...
                                                <span class="product-popup">
                                                    <span class="box-content">
                                                        <img alt="product" width="150" height="150"
                                                            src="/porto/assets/images/demoes/demo29/products/small/product-1.jpg"
                                        ...
                                        <div class="product-next">
                                            <a href="#">
                                                ...
                                                <span class="product-popup">
                                                    <span class="box-content">
                                                        <img alt="product" width="150" height="150"
                                                            src="/porto/assets/images/demoes/demo29/products/small/product-2.jpg"
                                                            style="padding-top: 0px;">

                                                        <span>Trellis Pillow</span>
                                                    </span>
                                                </span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="product-desc">
                                        <p class="font1">Pellentesque habitant morbi tristique senectus et netus et
                                            malesuada fames ac
                    ...
                    <aside class="sidebar-product col-lg-3 padding-left-lg mobile-sidebar">
                        <div class="sidebar-wrapper">
                                    ...
                                    <div class="product-intro">
                                        <div class="product-default left-details product-widget">
                                            ...
                                            <div class="product-details">
                                                <h3 class="product-title"> <a href="/porto/demo29-product.html">Product Short
                                                        Name</a> </h3>
                                                <div class="ratings-container">
                                                    <div class="product-ratings">
                            ...
                            <div class="widget widget-block">
                                ...
                                <div class="widget-body">
                                    <h4 class="widget-subtitle font1">This is a custom sub-title.</h4>
                            ...
                            <div class="widget widget-banner">
                                <div class="home-banner pb-0 mb-2 mb-lg-0">
                                    <figure style="background-color: #222529;">
                                        <img src="/porto/assets/images/demoes/demo29/banners/banner-sidebar.jpg" width="313"
                    ...
                    <div class="products-slider owl-carousel owl-theme dots-top dots-small 5col" data-owl-options="{
                        ...
                        <div class="product-default inner-quickview left-details inner-icon">
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title">
                                    <a href="/porto/demo29-product.html">Product Short Name</a>
                                </h3>
                                <div class="ratings-container">
                                    <div class="product-ratings">
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title">
                                    <a href="/porto/demo29-product.html">Wooden Arm Chair</a>
                                </h3>
                                <div class="ratings-container">
                                    <div class="product-ratings">
                                        <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                        ...
                        <div class="product-default inner-quickview inner-icon">
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title">
                                    <a href="/porto/demo29-product.html">Drawer</a>
                                </h3>
                                <div class="ratings-container">
                                    <div class="product-ratings">
                                        <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                ...
                <div class="product-widgets-container row pb-2">
                    <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/demo29-product.html">
                                    <img src="/porto/assets/images/demoes/demo29/products/small/product-1.jpg" width="74"
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/demo29-product.html">
                                    <img src="/porto/assets/images/demoes/demo29/products/small/product-2.jpg" width="74"
                                        height="74" alt="product">
                                </a>
                            </figure>

                            <div class="product-details">
                                <h3 class="product-title"> <a href="/porto/demo29-product.html">Trellis Pillow</a> </h3>
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/demo29-product.html">
                                    <img src="/porto/assets/images/demoes/demo29/products/small/product-3.jpg" width="74"
                                        height="74" alt="product">
                                </a>
                            </figure>

                            <div class="product-details">
                                <h3 class="product-title"> <a href="/porto/demo29-product.html">Blue Pillow</a> </h3>
                    ...
                    <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/demo29-product.html">
                                    <img src="/porto/assets/images/demoes/demo29/products/small/product-4.jpg" width="74"
                                        height="74" alt="product">
                                </a>
                            </figure>

                            <div class="product-details">
                                <h3 class="product-title"> <a href="/porto/demo29-product.html">Product Name</a> </h3>
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/demo29-product.html">
                                    <img src="/porto/assets/images/demoes/demo29/products/small/product-5.jpg" width="74"
                                        height="74" alt="product">
                                </a>
                            </figure>

                    ...
                    <table class="table table-wishlist mb-0">
                        ...
                        <tbody>
                            <tr class="product-row">
                                <td>
                                    <figure class="product-image-container">
                                        <a href="/porto/demo33-product.html" class="product-image">
                                ...
                                <td>
                                    <h5 class="product-title">
                                        <a href="/porto/demo33-product.html">Men Watch</a>
                                    </h5>
                                </td>
                                ...
                                <td class="action">
                                    <a href="/porto/demo33-ajax/product-quick-view.html" class="btn btn-quickview mt-1 mt-md-0"
                            ...
                            <tr class="product-row">
                                ...
                                <td>
                                    <h5 class="product-title">
                                        <a href="/porto/demo33-product.html">Men Cap</a>
                                    </h5>
                                </td>
                                <td class="price-box">$17.90</td>
                                <td>
                                ...
                                <td class="action">
                                    <a href="/porto/demo33-ajax/product-quick-view.html" class="btn btn-quickview mt-1 mt-md-0"
                                        title="Quick View">Quick
                                        View</a>
                                    <a href="/porto/demo33-product.html" class="btn btn-dark btn-add-cart btn-shop">
                                        SELECT OPTION
                                    </a>
                                </td>
                            </tr>
                            ...
                            <tr class="product-row">
                                ...
                                <td>
                                    <h5 class="product-title">
                                        <a href="/porto/demo33-product.html">Men Black Gentle Belt</a>
                                    </h5>
                                </td>
                                <td class="price-box">$17.90</td>
                                <td>

...
<div class="category-banner-container bg-gray">
                    ...
                    <div class="category-banner banner p-0">
                        <div class="row align-items-center no-gutters m-0 text-center text-lg-left">
                            ...
                            <div class="col-md-5 col-lg-4 text-md-center my-5 my-lg-0"
                                style="background-image: url(/porto/assets/images/demoes/demo27/banners/shop-banner-bg.png);">
                                <img class="d-inline-block" src="/porto/assets/images/demoes/demo27/banners/shop-banner.png"
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/porto/demo27.html">Home</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-sm-4 col-xl-3">
                                <div class="product-default">
                                    <figure>
                                        <a href="/porto/demo27-product.html">
                                            <img src="/porto/assets/images//demoes/demo27/products/product-11.jpg" width="280"
                                                height="280" alt="product">
                                        </a>
                                        <div class="label-group">
                                            <div class="product-label label-hot">HOT</div>
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo27-product.html">Bike Accessories</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:80%"></span><!-- End .ratings -->
                            ...
                            <div class="col-6 col-sm-4 col-xl-3">
                                <div class="product-default">
                                    <figure>
                                        <a href="/porto/demo27-product.html">
                                            <img src="/porto/assets/images//demoes/demo27/products/product-12.jpg" width="280"
                                                height="280" alt="product">
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/porto/demo27-product.html">Bike Backpack</a>
                                        </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                                <span class="ratings" style="width:80%"></span><!-- End .ratings -->
                                ...
                                <div class="widget-body">
                                    <div class="featured-col">
                                        <div class="product-default left-details product-widget">
                                            <figure>
                                                <a href="/porto/demo27-product.html">
                                                    <img src="/porto/assets/images/demoes/demo27/products/small/product-1.jpg"
                                        ...
                                        <div class="product-default left-details product-widget">
                                            <figure>
                                                <a href="/porto/demo27-product.html">
                                                    <img src="/porto/assets/images/demoes/demo27/products/small/product-2.jpg"
                                                        width="75" height="75" alt="product" />
                                                </a>
                                            </figure>
                                            <div class="product-details">

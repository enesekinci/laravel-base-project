            ...
            <div class="container">
                <div class="product-single-container product-single-default">
                    <div class="cart-message d-none">
                        <strong class="single-cart-notice">“Green Bike”</strong>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 product-single-gallery">
                                ...
                                <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="/porto/assets/images/demoes/demo27/products/zoom/product-1.jpg"
                                            data-zoom-image="/porto/assets/images/demoes/demo27/products/zoom/product-1-big.jpg"
                            ...
                            <div class="prod-thumbnail owl-dots">
                                <div class="owl-dot">
                                    <img src="/porto/assets/images/demoes/demo27/products/zoom/product-1.jpg" width="110"
                        ...
                        <div class="col-lg-7 col-md-6 product-single-details">
                            <h1 class="product-title">Green Bike</h1>
                                        ...
                                        <span class="product-popup">
                                            <span class="box-content">
                                                <img alt="product" width="150" height="150"
                                                    src="/porto/assets/images/demoes/demo27/products/product-3.jpg"
                                ...
                                <div class="product-next">
                                    <a href="#">
                                        ...
                                        <span class="product-popup">
                                            <span class="box-content">
                                                <img alt="product" width="150" height="150"
                                                    src="/porto/assets/images/demoes/demo27/products/product-4.jpg"
                                                    style="padding-top: 0px;">
                            ...
                            <div class="price-box">
                                <div class="product-price">$129.0 &ndash; $149.0</div>
                            </div><!-- End .price-box -->
                                ...
                                <div class="product-single-filter">
                                    ...
                                    <ul class="config-size-list">
                                        <li><a href="javascript:;"
                                                ...
                                                style="background-image: url(/porto/assets/images/demoes/demo27/products/zoom/product-1-thumb.jpg)"><span
                                                    class="sr-only">Extra
                                                    Large</span></a>
                                        </li>
                                        <li class=""><a href="javascript:;"
                                                class="d-flex align-items-center justify-content-center"
                                                style="background-image: url(/porto/assets/images/demoes/demo27/products/zoom/product-2-thumb.jpg)"><span
                                                    class="sr-only">Large</span></a>
                                        </li>
                                        <li class=""><a href="javascript:;"
                                                class="d-flex align-items-center justify-content-center"
                                                style="background-image: url(/porto/assets/images/demoes/demo27/products/zoom/product-3-thumb.jpg)"><span
                            ...
                            <div class="product-action">
                                <div class="price-box product-filtered-price">
                                    <del class="old-price"><span>$139.00</span></del>
                ...
                <div class="products-section pt-0">
                    <h2 class="section-title m-b-4 border-0">Related Products</h2>

                    <div class="row">
                        <div class="products-slider 5col owl-carousel owl-theme dots-top dots-small mb-0"
                            data-owl-options="{
                        'margin': 0
                    }">

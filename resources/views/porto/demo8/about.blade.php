...
<nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/porto/demo8.html">Home</a></li>
            ...
            <div class="container">
                <div class="page-header bg-transparent">
                    <div class="container text-left">
                        <h1 class="text-uppercase">The New Way to Success</h1>
                    </div><!-- End .container -->
                </div><!-- End .page-header -->
                ...
                <div class="history-section pb-0">
                    <div class="container">
                        ...
                        <div class="row row-bg">
                            <div class="col-xl-5 col-lg-6">
                                <div class="about-slider owl-carousel owl-theme dots-simple">
                                    <div class="about-slider-item">
                                        <img class="owl-lazy" data-src="/porto/assets/images/demoes/demo3/about/img-1.jpg"
                                            src="/porto/assets/images/lazy.png" alt="About image description">
                                    </div>
                                    <div class="about-slider-item">
                                        <img class="owl-lazy" data-src="/porto/assets/images/demoes/demo3/about/img-2.jpg"
                                            src="/porto/assets/images/lazy.png" alt="About image description">
                                    </div>
                                    <div class="about-slider-item">
                                        <img class="owl-lazy" data-src="/porto/assets/images/demoes/demo3/about/img-3.jpg"
                                            src="/porto/assets/images/lazy.png" alt="About image description">
                                    </div>
                            ...
                            <div class="col-xl-7 col-lg-6">
                                ...
                                <p>Nulla felis nibh, bibendum a leo ut, egestas ornare felis. Nam pretium mauris justo,
                                    eget commodo est fringilla vel. Proin condimentum, lacus sit amet finibus gravida,
                                    sapien ligula mattis leo, sit amet mattis leo lacus sit amet lectus. Nulla facilisi.
                                    Etiam porta iaculis velit id pulvinar. Sed dolor odio, eleifend eget aliquam vitae,

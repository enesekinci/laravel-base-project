...
<div class="container pb-2">
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="home-slider slide-animate owl-carousel owl-theme mb-2" data-owl-options="{
                            ...
                            <div
                                ...
                                <img class="slide-bg" src="/porto/assets/images/demoes/demo1-dark/slider/slide-1.png"
                                    width="880" height="428" alt="home-slider" style="background-color: #0188CC;" />
                                <div class="banner-layer appear-animate" data-animation-name="fadeInUpShorter">
                                    <h4 class="text-white mb-0">Find the Boundaries. Push Through!</h4>
                                    <h2 class="mb-0">Summer Sale</h2>
                                    <h3 class="text-uppercase m-b-3">70% Off</h3>
                                    ...
                                    <a href="/porto/demo1-dark-shop.html" class="btn btn-dark btn-md ls-10">Shop Now!</a>
                                </div><!-- End .banner-layer -->
                            </div><!-- End .home-slide -->

                            <div
                                class="home-slide home-slide2 banner banner-md-vw banner-sm-vw d-flex align-items-center">
                                <img class="slide-bg" src="/porto/assets/images/demoes/demo1-dark/slider/slide-2.jpg"
                                    width="880" height="428" alt="home-slider" style="background-color: #dadada;" />
                                <div class="banner-layer text-uppercase appear-animate"
                                    data-animation-name="fadeInUpShorter">
                                    <h4 class="m-b-2">Over 200 products with discounts</h4>
                                    <h2 class="m-b-3 text-dark">Great Deals</h2>
                                    <h5 class="d-inline-block mb-0 align-top mr-5 mb-2 text-dark">Starting At
                                        <b>$<em>299</em>99</b>
                                    </h5>
                                    <a href="/porto/demo1-dark-shop.html" class="btn btn-dark btn-md ls-10">Get Yours!</a>
                                </div><!-- End .banner-layer -->
                            </div><!-- End .home-slide -->

                            <div
                                class="home-slide home-slide3 banner banner-md-vw banner-sm-vw  d-flex align-items-center">
                                <img class="slide-bg" src="/porto/assets/images/demoes/demo1-dark/slider/slide-3.jpg"
                                    width="880" height="428" alt="home-slider" style="background-color: #e5e4e2;" />
                                <div class="banner-layer text-uppercase appear-animate"
                                    data-animation-name="fadeInUpShorter">
                                    <h4 class="m-b-2">Up to 70% off</h4>
                                    <h2 class="m-b-3 text-dark">New Arrivals</h2>
                                    <h5 class="d-inline-block mb-0 align-top mr-5 mb-2 text-dark">Starting At
                                        <b>$<em>299</em>99</b>
                                    </h5>
                                    <a href="/porto/demo1-dark-shop.html" class="btn btn-dark btn-md ls-10">Get Yours!</a>
                        ...
                        <div class="banners-container m-b-2 owl-carousel owl-theme" data-owl-options="{
                            ...
                            <div class="banner banner1 banner-hover-shadow d-flex align-items-center mb-2 w-100 appear-animate"
                                ...
                                <figure class="w-100">
                                    <img src="/porto/assets/images/demoes/demo1-dark/banners/banner-1.jpg" alt="banner"
                                        width="265" height="170" style="background-color: #fefefe;" />
                                </figure>
                                <div class="banner-layer">
                                    <h3 class="m-b-2 text">Porto Watches</h3>
                                    <h4 class="m-b-4 text-primary"><sup
                                            class="text-dark"><del>20%</del></sup>30%<sup>OFF</sup></h4>
                                    <a href="/porto/demo1-dark-shop.html" class="text-dark text-uppercase ls-10">Shop Now</a>
                                </div>
                            </div><!-- End .banner -->
                            <div class="banner banner2 text-uppercase banner-hover-shadow d-flex align-items-center mb-2 w-100 appear-animate"
                                ...
                                <figure class="w-100">
                                    <img src="/porto/assets/images/demoes/demo1-dark/banners/banner-2.jpg" alt="banner"
                                        width="240" height="140" style="background-color: #e6e6e6;" />
                                </figure>
                            ...
                            <div class="banner banner3 banner-hover-shadow d-flex align-items-center mb-2 w-100 appear-animate"
                                ...
                                <figure class="w-100">
                                    <img src="/porto/assets/images/demoes/demo1-dark/banners/banner-3.jpg" alt="banner"
                                        width="265" height="170" style="background-color: #ebebeb;" />
                                </figure>
                        ...
                        <div class="products-slider owl-carousel owl-theme dots-top dots-small m-b-1 pb-1 appear-animate"
                            ...
                            <div class="product-default inner-quickview inner-icon">
                                <figure class="img-effect">
                                    <a href="/porto/demo1-dark-product.html">
                                        <img src="/porto/assets/images/demoes/demo1-dark/products/product-1.jpg" width="205"
                                            height="205" alt="product">
                                        <img src="/porto/assets/images/demoes/demo1-dark/products/product-1-2.jpg" width="205"
                                            height="205" alt="product">
                                    </a>
                                    ...
                                    <div class="btn-icon-group">
                                        <a href="/porto/demo1-dark-product.html" class="btn-icon btn-add-cart"><i
                                ...
                                <div class="product-details">
                                    <div class="category-wrap">
                                        <div class="category-list">
                                            <a href="/porto/demo1-dark-shop.html" class="product-category">category</a>
                                        </div>
                                        <a href="/porto/wishlist.html" title="Add to Wishlist" class="btn-icon-wish"><i
                                                class="icon-heart"></i></a>
                                    </div>
                                    <h3 class="product-title"> <a href="/porto/demo1-dark-product.html">Black Grey Headset</a>
                                    </h3>
                            ...
                            <div class="product-default inner-quickview inner-icon">
                                <figure class="img-effect">
                                    <a href="/porto/demo1-dark-product.html">
                                        <img src="/porto/assets/images/demoes/demo1-dark/products/product-2.jpg" width="205"
                                            height="205" alt="product" />
                                    </a>
                                    <div class="btn-icon-group">
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title"> <a href="/porto/demo1-dark-product.html">Battery Charger</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                            ...
                            <div class="product-default inner-quickview inner-icon">
                                <figure class="img-effect">
                                    <a href="/porto/demo1-dark-product.html">
                                        <img src="/porto/assets/images/demoes/demo1-dark/products/product-3.jpg" width="205"
                                            height="205" alt="product">
                                        <img src="/porto/assets/images/demoes/demo1-dark/products/product-3-2.jpg" width="205"
                                            height="205" alt="product">
                                    </a>
                                    <div class="label-group">
                                        <div class="product-label label-hot">HOT</div>
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title"> <a href="/porto/demo1-dark-product.html">Brown Bag</a> </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                                            <span class="tooltiptext tooltip-top"></span>
                            ...
                            <div class="product-default inner-quickview inner-icon">
                                <figure class="img-effect">
                                    <a href="/porto/demo1-dark-product.html">
                                        <img src="/porto/assets/images/demoes/demo1-dark/products/product-4.jpg" width="205"
                                            height="205" alt="product">
                                        <img src="/porto/assets/images/demoes/demo1-dark/products/product-4-2.jpg" width="205"
                                            height="205" alt="product">
                                    </a>
                                    <div class="label-group">
                                        <div class="product-label label-hot">HOT</div>
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title"> <a href="/porto/demo1-dark-product.html">Casual Note Bag</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                            ...
                            <div class="product-default inner-quickview inner-icon">
                                <figure class="img-effect">
                                    <a href="/porto/demo1-dark-product.html">
                                        <img src="/porto/assets/images/demoes/demo1-dark/products/product-5.jpg" width="205"
                                            height="205" alt="product">
                                        <img src="/porto/assets/images/demoes/demo1-dark/products/product-5-2.jpg" width="205"
                                            height="205" alt="product">
                                    </a>
                                    <div class="label-group">
                                        <div class="product-label label-hot">HOT</div>
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title"> <a href="/porto/demo1-dark-product.html">Porto Extended
                                            Camera</a> </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:100%"></span><!-- End .ratings -->
                        ...
                        <div class="brands-slider owl-carousel owl-theme images-center appear-animate"
                            data-animation-name="fadeIn" data-animation-duration="700" data-owl-options="{
                            'margin': 0,
                            'autoplay': true,
							'responsive': {
								'768': {
                        ...
                        <div class="row products-widgets">
                            <div class="col-sm-6 col-md-4 pb-4 pb-md-0 appear-animate"
                                ...
                                <div class="product-column">
                                    ...
                                    <div class="product-default left-details product-widget">
                                        <figure>
                                            <a href="/porto/demo1-dark-product.html">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-4.jpg"
                                                    width="84" height="84" alt="product">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-4-2.jpg"
                                                    width="84" height="84" alt="product">
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                    ...
                                    <div class="product-default left-details product-widget">
                                        <figure>
                                            <a href="/porto/demo1-dark-product.html">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-5.jpg"
                                                    width="84" height="84" alt="product">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-5-2.jpg"
                                                    width="84" height="84" alt="product">
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                            <h3 class="product-title"> <a href="/porto/demo1-dark-product.html">Blue
                                                    BackPack</a> </h3>
                                            <div class="ratings-container">
                                                <div class="product-ratings">
                                                    <span class="ratings" style="width:100%"></span>
                                    ...
                                    <div class="product-default left-details product-widget ">
                                        <figure>
                                            <a href="/porto/demo1-dark-product.html">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-6.jpg"
                                                    width="84" height="84" alt="product">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-6-2.jpg"
                                                    width="84" height="84" alt="product">
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                            <h3 class="product-title"> <a href="/porto/demo1-dark-product.html">Casual Blue
                                                    Shoes</a> </h3>
                                            <div class="ratings-container">
                                                <div class="product-ratings">
                                                    <span class="ratings" style="width:100%"></span>
                            ...
                            <div class="col-sm-6 col-md-4 pb-4 pb-md-0 appear-animate"
                                ...
                                <div class="product-column">
                                    ...
                                    <div class="product-default left-details product-widget ">
                                        <figure>
                                            <a href="/porto/demo1-dark-product.html">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-2.jpg"
                                                    width="84" height="84" alt="product">
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                            <h3 class="product-title"> <a href="/porto/demo1-dark-product.html">Battery
                                                    Charger</a> </h3>
                                            <div class="ratings-container">
                                                <div class="product-ratings">
                                                    <span class="ratings" style="width:100%"></span>
                                    ...
                                    <div class="product-default left-details product-widget ">
                                        <figure>
                                            <a href="/porto/demo1-dark-product.html">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-7.jpg"
                                                    width="84" height="84" alt="product">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-7-2.jpg"
                                                    width="84" height="84" alt="product">
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                            <h3 class="product-title"> <a href="/porto/demo1-dark-product.html">Computer
                                                    Mouse</a> </h3>
                                            <div class="ratings-container">
                                                <div class="product-ratings">
                                                    <span class="ratings" style="width:100%"></span>
                                    ...
                                    <div class="product-default left-details product-widget ">
                                        <figure>
                                            <a href="/porto/demo1-dark-product.html">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-8.jpg"
                                                    width="84" height="84" alt="product">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-8-2.jpg"
                                                    width="84" height="84" alt="product">
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                            <h3 class="product-title"> <a href="/porto/demo1-dark-product.html">Casual Note
                                                    Bag</a> </h3>
                                            <div class="ratings-container">
                                                <div class="product-ratings">
                                                    <span class="ratings" style="width:100%"></span>
                            ...
                            <div class="col-sm-6 col-md-4 pb-4 pb-md-0 appear-animate"
                                ...
                                <div class="product-column">
                                    ...
                                    <div class="product-default left-details product-widget ">
                                        <figure>
                                            <a href="/porto/demo1-dark-product.html">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-9.jpg"
                                                    width="84" height="84" alt="product">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-9-2.jpg"
                                                    width="84" height="84" alt="product">
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                            <h3 class="product-title"> <a href="/porto/demo1-dark-product.html">Ultimate 3D
                                    ...
                                    <div class="product-default left-details product-widget ">
                                        <figure>
                                            <a href="/porto/demo1-dark-product.html">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-10.jpg"
                                                    width="84" height="84" alt="product">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-10-2.jpg"
                                                    width="84" height="84" alt="product">
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                            <h3 class="product-title"> <a href="/porto/demo1-dark-product.html">Brown-Black Men
                                                    Casual Glasses</a> </h3>
                                            <div class="ratings-container">
                                                <div class="product-ratings">
                                                    <span class="ratings" style="width:100%"></span>
                                    ...
                                    <div class="product-default left-details product-widget ">
                                        <figure>
                                            <a href="/porto/demo1-dark-product.html">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-11.jpg"
                                                    width="84" height="84" alt="product">
                                                <img src="/porto/assets/images/demoes/demo1-dark/products/small/product-11-2.jpg"
                                                    width="84" height="84" alt="product">
                                            </a>
                                        </figure>
                                        <div class="product-details">
                    ...
                    <aside class="sidebar-home col-lg-3 order-lg-first mobile-sidebar bg-dark">
                        <div class="side-menu-wrapper text-uppercase mb-2 d-none d-lg-block">
                            <h2 class="side-menu-title ls-n-25">Browse Categories</h2>

                            <nav class="side-nav border-0">
                                <ul class="menu menu-vertical sf-arrows">
                                    <li class="active"><a href="/porto/demo1-dark.html"><i class="icon-home"></i>Home</a></li>
                                    <li>
                                        <a href="/porto/demo1-dark-shop.html" class="sf-with-ul"><i
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    ...
                                                    <ul class="submenu">
                                                        ...
                                                        <li><a href="/porto/demo1-dark-shop.html">Left Sidebar</a></li>
                                                ...
                                                <div class="col-lg-4 p-0">
                                                    <div class="menu-banner">
                                                        <figure>
                                                            <img src="/porto/assets/images/menu-banner.jpg" width="192"
                                                        ...
                                                        <div class="banner-content">
                                                            ...
                                                            <a href="/porto/demo1-dark-shop.html"
                                                                class="btn btn-sm btn-dark">SHOP
                                                                NOW</a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <li>
                                        <a href="/porto/demo1-dark-product.html" class="sf-with-ul"><i
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 p-0">
                                                    <div class="menu-banner menu-banner-2">
                                                        ...
                                                        <a href="/porto/demo1-dark-shop.html" class="btn btn-sm btn-dark">SHOP
                                                            NOW</a>
                                                    </div>
                                                </div><!-- End .col-lg-4 -->
                                            </div><!-- End .row -->
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="/porto/demo1-dark-about.html">About Us</a></li>
                                            <li><a href="#">Blog</a>
                                                <ul>
                                            ...
                                            <li><a href="/porto/demo1-dark-contact.html">Contact Us</a></li>
                                    ...
                                    <li><a href="/porto/demo1-dark-about.html"><i class="sicon-users"></i>About Us</a></li>
                                    <li><a href="#"><i class="icon-cat-gift"></i>Special Offer!</a></li>
                                    <li><a href="https://1.envato.market/DdLk5" target="_blank" rel="noopener"><i
                        ...
                        <div class="widget widget-banners px-3 pb-3 text-center">
                            <div class="owl-carousel owl-theme dots-small">
                                <div class="banner d-flex flex-column align-items-center">
                                    ...
                                    <a href="/porto/demo1-dark-shop.html" class="btn btn-light btn-md">View Sale</a>
                                </div><!-- End .banner -->

                                <div class="banner banner4">
                                    <figure>
                                        <img src="/porto/assets/images/demoes/demo1-dark/banners/banner-7.jpg" alt="banner"
                                            width="166" height="114" style="background-color: #fff;" />
                                    </figure>
                                    ...
                                    <div class="banner-layer">
                                        <div class="coupon-sale-content">
                                            ...
                                            <h5 class="coupon-sale-text text-gray ls-n-10 p-0 font1"><i>UP
                                                    TO</i><b class="text-white bg-secondary font1">$100</b> OFF</h5>
                                            <p class="ls-0">Top Brands and Models!</p>
                                            <a href="/porto/demo1-dark-shop.html"
                                                class="btn btn-inline-block btn-light ls-0">VIEW
                                                SALE</a>
                                        </div>
                                    </div>
                                </div><!-- End .banner -->
                                ...
                                <div class="banner banner5">
                                    ...
                                    <figure class="m-b-3">
                                        <img src="/porto/assets/images/demoes/demo1-dark/banners/banner-8.jpg" alt="banner"
                                            width="163" height="170" style="background-color: #fff;" />
                                    </figure>
                        ...
                        <div class="widget widget-newsletters text-center">
                        ...
                        <div class="widget widget-testimonials">
                            <div class="owl-carousel owl-theme dots-left dots-small">
                                ...
                                <div class="testimonial">
                                    <div class="testimonial-owner">
                                        <figure>
                                            <img src="/porto/assets/images/clients/client-2.jpg" alt="client" width="120"
                                                height="120" />
                                        </figure>
                                ...
                                <div class="testimonial">
                                    <div class="testimonial-owner">
                                        <figure>
                                            <img src="/porto/assets/images/clients/client-3.jpg" alt="client" width="67"
                                                height="67" />
                                        </figure>
                        ...
                        <div class="widget widget-posts post-date-in-media media-with-zoom mb-0 mb-lg-2 pb-lg-2">
                            <div class="owl-carousel owl-theme dots-left dots-m-0 dots-small" data-owl-options="
                                ...
                                <article class="post">
                                    <div class="post-media">
                                        <a href="/porto/single.html">
                                            <img src="/porto/assets/images/blog/home/post-1.jpg"
                                                data-zoom-image="/porto/assets/images/blog/home/post-1.jpg" width="280"
                                                height="209" alt="Post">
                                        </a>
                                        <div class="post-date">
                                    ...
                                    <div class="post-body">
                                        ...
                                        <div class="post-content">
                                            <p>Leap into electronic typesetting, remaining essentially unchanged. It
                                                was popularised in the 1960s with... </p>
                                ...
                                <article class="post">
                                    <div class="post-media">
                                        <a href="/porto/single.html">
                                            <img src="/porto/assets/images/blog/home/post-2.jpg"
                                                data-zoom-image="/porto/assets/images/blog/home/post-2.jpg" width="280"
                                                height="209" alt="Post">
                                        </a>
                                        <div class="post-date">
                                            <span class="day">29</span>
                                ...
                                <article class="post">
                                    <div class="post-media">
                                        <a href="/porto/single.html">
                                            <img src="/porto/assets/images/blog/home/post-3.jpg"
                                                data-zoom-image="/porto/assets/images/blog/home/post-3.jpg" width="280"
                                                height="209" alt="Post">
                                        </a>
                                        <div class="post-date">
                                            <span class="day">29</span>

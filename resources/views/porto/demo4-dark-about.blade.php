...
<div class="page-header page-header-bg text-left"
				...
				<div class="container">
					<h1><span>ABOUT US</span>
						OUR COMPANY</h1>
					<a href="/porto/demo4-dark-contact.html" class="btn btn-dark">Contact</a>
				</div><!-- End .container -->
			</div><!-- End .page-header -->
			...
			<nav aria-label="breadcrumb" class="breadcrumb-nav">
				<div class="container">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="/porto/demo4-dark.html" title="homing"><i class="icon-home"></i></a></li>
					...
					<div class="testimonials-carousel owl-carousel owl-theme images-left" data-owl-options="{
						...
						<div class="testimonial">
							<div class="testimonial-owner">
								<figure>
									<img src="/porto/assets/images/clients/client1.png" alt="client" width="40" height="40" />
								</figure>
						...
						<div class="testimonial">
							<div class="testimonial-owner">
								<figure>
									<img src="/porto/assets/images/clients/client2.png" alt="client" width="40" height="40" />
								</figure>

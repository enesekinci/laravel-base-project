            ...
            <div class="container">
                <div class="toolbox toolbox-store sticky-header" data-sticky-options="{'mobile': true}">
                    ...
                    <div class="toolbox-item layout-modes">
                        <a href="/porto/demo22-vendors.html" class="layout-btn btn-grid active" title="Grid">
                            <i class="icon-mode-grid"></i>
                        </a>
                        <a href="/porto/demo22-vendors-list.html" class="layout-btn btn-list" title="List">
                    ...
                    <form action="#" class="mb-0">
                        <div class="row">
                            <div class="input-group col-lg-7 col-xl-5">
                                <input type="text" class="form-control" placeholder="Search Vendors" required>
                ...
                <div class="row row-lg mt-2">
                    ...
                    <div class="col-md-4">
                        <div class="store-default no-banner">
                            <div class="store-header">
                                <figure>

...
<div class="page-header page-header-bg text-left"
                style="background-image: url(/porto/assets/images/demoes/demo18/page-header-bg.jpg); background-color: #111">
            ...
            <div class="about-section bg-gray">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <img src="/porto/assets/images/demoes/demo18/about.jpg" alt="About">
                        </div><!-- End .col-lg-6 -->
            ...
            <div class="counters-section"
                style="background-image: url(/porto/assets/images/demoes/demo18/bg-counters.jpg); background-color: #111;">
                <div class="container-fluid">
                    <div class="row">

...
@section('header')
    @include('components.porto.demo12.header')
@endsection

@section('footer')
    @include('components.porto.demo12.footer')
@endsection
...
<div class="container">
                <nav aria-label="breadcrumb" class="breadcrumb-nav">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/porto/demo12.html"><i class="icon-home"></i></a></li>
                ...
                <div class="products-section pt-0">
                    <h2 class="section-title mt-0">Related Products</h2>
                    ...
                    <div class="products-slider 5col owl-carousel owl-theme dots-top dots-small" data-owl-options="{
                        ...
                        <div class="product-default">
                            ...
                            <div class="product-details">
                                <h3 class="product-title">
                                    <a href="/porto/demo12-product.html">Men Black Shoes</a>
                                </h3>
                        ...
                        <div class="product-default">
                            ...
                            <div class="product-details">
                                <h3 class="product-title">
                                    <a href="/porto/demo12-product.html">Porto Black Watch</a>
                                </h3>
                        ...
                        <div class="product-default">
                            ...
                            <div class="product-details">
                                <h3 class="product-title">
                                    <a href="/porto/demo12-product.html">Porto Sports Shoes</a>
                                </h3>
                        ...
                        <div class="product-default">
                            ...
                            <div class="product-details">
                                <h3 class="product-title">
                                    <a href="/porto/demo12-product.html">Speaker</a>
                                </h3>
                        ...
                        <div class="product-default">
                            ...
                            <div class="product-details">
                                <h3 class="product-title">
                                    <a href="/porto/demo12-product.html">Woman Shoes</a>
                                </h3>
                        ...
                        <div class="product-default">
                            ...
                            <div class="product-details">
                                <h3 class="product-title">
                                    <a href="/porto/demo12-product.html">Men Gentle Watch</a>
                                </h3>
                ...
                <div class="product-widgets-container custom-widget-container row pb-2">
                    ...
                    <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                        ...
                        <div class="product-default left-details product-widget">
                            ...
                            <div class="product-details">
                                <h3 class="product-title"> <a href="/porto/demo12-product.html">Product Brown Belt</a> </h3>
                                <div class="ratings-container">
                                    <div class="product-ratings">
                                        <span class="ratings" style="width: 0%"></span>
                                        <!-- End .ratings -->

...
@section('top-notice')
    @include('components.porto.demo12.top-notice')
@endsection
...
@section('content')
<div class="shop-banner banner banner-5" style="background-image: url(/porto/assets/images/demoes/demo12/bg-category.jpg)">
                <div class="container">
                    <div class="row banner-layer-middle align-items-center position-absolute w-100 justify-content-sm-start justify-content-center">
                        <div class="mb-0 col-lg-5 col-sm-4">
                            <h3 class="text-sm-right mb-1 mb-md-0 text-center">TOP FASHION<br>DEALS</h3>
                        </div>

                        <div class="mb-md-0 mb-1 col-lg-3 col-sm-4 text-center">
                            <a href="#" class="btn btn-lg ls-10 text-white btn-dark">VIEW SALE</a>
                        </div>

                        <div class="col-auto col-sm-4">
                            <div class="coupon-sale-content d-inline-flex flex-column">
                                <h4 class="coupon-sale-text d-block ext-transform-none mr-0 ls-0 bg-dark text-white ml-0">
                                    Exclusive COUPON</h4>
                                <h5 class="coupon-sale-text ls-0 p-0 mb-0 ml-0"><i class="ls-0">UP TO</i><b class="bg-secondary text-white">$100</b><sub>OFF</sub></h5>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row products-group">
                            <div class="col-6 col-sm-4 col-md-3">
                                <div class="product-default">
                                    ...
                                    <div class="product-details">
                                        <h3 class="product-title"> <a href="/porto/demo12-product.html">Men Black Shoes</a>
                                        </h3>
                            ...
                            <div class="col-6 col-sm-4 col-md-3">
                                <div class="product-default">
                                    ...
                                    <div class="product-details">
                                        <h3 class="product-title"> <a href="/porto/demo12-product.html">Porto Black Watch</a>
                                        </h3>
                                        ...
                                        <div class="product-action">
                                            <a href="/porto/wishlist.html" title="Wishlist" class="btn-icon-wish"><i
													class="icon-heart"></i></a>
                                            <a href="/porto/demo12-product.html" class="btn-icon btn-add-cart">SELECT
												OPTIONS</a>
                                            <a href="/porto/ajax/product-quick-view.html" class="btn-quickview" title="Quick View"><i class="fas fa-external-link-alt"></i></a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-6 col-sm-4 col-md-3">
                                <div class="product-default">
                                    ...
                                    <div class="product-details">
                                        <h3 class="product-title"> <a href="/porto/demo12-product.html">Product Extended</a>
                                        </h3>
                            ...
                            <div class="col-6 col-sm-4 col-md-3">
                                <div class="product-default">
                                    ...
                                    <div class="product-details">
                                        <h3 class="product-title"> <a href="/porto/demo12-product.html">Centered Vertical
												Zoom</a> </h3>

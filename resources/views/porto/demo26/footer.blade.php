<footer class="footer font2">
            ...
            <div class="container">
                <div class="footer-middle">
                    <div class="row">
                        <div class="col-lg-5">
                            <a href="/porto/demo26.html"><img src="/porto/assets/images/logo-white.png" alt="Logo" width="111"
                            ...
                            <div class="contact-widget mb-2 mb-lg-0">
                                ...
                                <div class="row ls-0">
                                    ...
                                    <div class="col-md-3-5">
                                        <h6 class="text-uppercase text-white mb-0">Payment Methods</h6>
                                        <img src="/porto/assets/images/demoes/demo26/payments.png" alt="payment methods"

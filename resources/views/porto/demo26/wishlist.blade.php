                    ...
                    <table class="table table-wishlist mb-0">
                        ...
                        <tbody>
                            <tr class="product-row">
                                ...
                                <td class="action">
                                    <a href="/porto/demo26-ajax/product-quick-view.html" class="btn btn-quickview mt-1 mt-md-0"
                            ...
                            <tr class="product-row">
                                ...
                                <td>
                                    <h5 class="product-title">
                                        <a href="/porto/demo26-product.html">Men Cap</a>
                                    </h5>
                                </td>
                                <td class="price-box">$17.90</td>
                                <td>
                                ...
                                <td class="action">
                                    <a href="/porto/demo26-ajax/product-quick-view.html" class="btn btn-quickview mt-1 mt-md-0"
                                        title="Quick View">Quick
                                        View</a>
                                    <a href="/porto/demo26-product.html" class="btn btn-dark btn-add-cart btn-shop">
                                        SELECT OPTION
                                    </a>
                                </td>
                            </tr>

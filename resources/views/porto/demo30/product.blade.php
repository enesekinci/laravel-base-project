...
@section('header')
    @include('porto.demo30.header')
@endsection

@section('footer')
    @include('porto.demo30.footer')
@endsection
...
<div class="container">
                <nav aria-label="breadcrumb" class="breadcrumb-nav font2">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/porto/demo30.html">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Products</a></li>
                    </ol>
                </nav>

                <div class="product-single-container product-single-default font2">
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 product-single-gallery">
                                ...
                                <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="/porto/assets/images/demoes/demo30/products/zoom/product-1-big.jpg"
                                            data-zoom-image="/porto/assets/images/demoes/demo30/products/zoom/product-1-big.jpg"
                                            width="468" height="468" alt="product" />
                                    </div>
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="/porto/assets/images/demoes/demo30/products/zoom/product-2-big.jpg"
                                            data-zoom-image="/porto/assets/images/demoes/demo30/products/zoom/product-2-big.jpg"
                                            width="468" height="468" alt="product" />
                                    </div>
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="/porto/assets/images/demoes/demo30/products/zoom/product-3-big.jpg"
                                            data-zoom-image="/porto/assets/images/demoes/demo30/products/zoom/product-3-big.jpg"
                                            width="468" height="468" alt="product" />
                                    </div>
                                    <div class="product-item">
                                        <img class="product-single-image"
                                            src="/porto/assets/images/demoes/demo30/products/zoom/product-4-big.jpg"
                                            data-zoom-image="/porto/assets/images/demoes/demo30/products/zoom/product-4-big.jpg"
                                            width="468" height="468" alt="product" />
                                    </div>
                                </div>
                            ...
                            <div class="prod-thumbnail owl-dots">
                                <div class="owl-dot">
                                    <img src="/porto/assets/images/demoes/demo30/products/zoom/product-1.jpg" width="110"
                                        height="110" alt="product-thumbnail" />
                                </div>
                                <div class="owl-dot">
                                    <img src="/porto/assets/images/demoes/demo30/products/zoom/product-2.jpg" width="110"
                                        height="110" alt="product-thumbnail" />
                                </div>
                                <div class="owl-dot">
                                    <img src="/porto/assets/images/demoes/demo30/products/zoom/product-3.jpg" width="110"
                                        height="110" alt="product-thumbnail" />
                                </div>
                                <div class="owl-dot">
                                    <img src="/porto/assets/images/demoes/demo30/products/zoom/product-4.jpg" width="110"
                                        height="110" alt="product-thumbnail" />
                                </div>
                            </div>
                        ...
                        <div class="col-lg-7 col-md-6 product-single-details">
                            <h1 class="product-title">Teddy Bear Blue</h1>
                                        ...
                                        <span class="product-popup">
                                            <span class="box-content">
                                                <img alt="product" width="150" height="150"
                                                    src="/porto/assets/images/demoes/demo30/products/400x400/product-1.jpg"
                                ...
                                <div class="product-next">
                                    <a href="#">
                                        ...
                                        <span class="product-popup">
                                            <span class="box-content">
                                                <img alt="product" width="150" height="150"
                                                    src="/porto/assets/images/demoes/demo30/products/400x400/product-2.jpg"
                                                    style="padding-top: 0px;">
                                    ...
                                    <ul class="config-size-list">
                                        <li>
                                            <a href="javascript:;"
                                                ...
                                                <img src="/porto/assets/images/demoes/demo30/products/zoom/product-1.jpg"
                                        ...
                                        <li>
                                            <a href="javascript:;"
                                                class="d-flex align-items-center justify-content-center p-0">
                                                <img src="/porto/assets/images/demoes/demo30/products/zoom/product-2.jpg"
                                                    width="30" height="30" alt="filter-img" />
                                            </a>
                                        </li>
                                    </ul>
                ...
                <div class="row">
                    <div class="col-lg-9">
                        ...
                        <div class="products-section pt-0">
                            <h2 class="section-title ls-0">Related Products</h2>
                            ...
                            <div class="widget">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-body-2" role="button" aria-expanded="true"
                                        aria-controls="widget-body-2">Featured Products</a>
                                </h3>
                                        ...
                                        <div class="product-intro">
                                            <div class="product-default left-details product-widget">
                                                <figure>
                                                    <a href="/porto/demo30-product.html">
                                                        <img src="/porto/assets/images/demoes/demo30/products/400x400/product-9.jpg"
                                                            width="154" height="154" alt="Product" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo30-product.html">Clasp
                                                            Knife</a> </h3>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                            ...
                                            <div class="product-default left-details product-widget">
                                                ...
                                                <div class="product-details">
                                                    <h3 class="product-title"> <a href="/porto/demo30-product.html">Fountain
                                                            Pen</a> </h3>
                                                    <div class="ratings-container">
                                                        <div class="product-ratings">
                                                            <span class="ratings" style="width:100%"></span>
                            ...
                            <div class="widget widget-block ">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-body-3" role="button" aria-expanded="true"
                                        aria-controls="widget-body-2">Custom HTML Block</a>
                                </h3>
                                ...
                                <div class="collapse show" id="widget-body-3">
                                    <div class="widget-body">
                                        ...
                                        <p class="font2 ls-0">Lorem ipsum dolor ist amet, consec tetur elitad adipiscing
                                            Cras
                                            non placerat
                                            mi.</p>
                                    </div><!-- End .widget-body -->
                            ...
                            <div class="widget">
                                <div class="home-banner2 text-center">
                                    ...
                                    <div class="banner-content">
                                        ...
                                        <a href="/porto/demo30-shop.html" class="btn text-white">SHOP SALE NOW</a>
                                    </div>
                                </div>
                            </div><!-- End .widget -->
                        </div>
                ...
                <div class="product-widgets-container row pb-2">
                    <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/demo30-product.html">
                                    <img src="/porto/assets/images/demoes/demo30/products/small/product-1.jpg" width="74"
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/demo30-product.html">
                                    <img src="/porto/assets/images/demoes/demo30/products/small/product-2.jpg" width="74"
                                        height="74" alt="product">
                                </a>
                            </figure>
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/demo30-product.html">
                                    <img src="/porto/assets/images/demoes/demo30/products/small/product-3.jpg" width="74"
                                        height="74" alt="product">
                                </a>
                            </figure>

                            <div class="product-details">
                                <h3 class="product-title"> <a href="/porto/demo30-product.html">USB Memory</a> </h3>
                    ...
                    <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/demo30-product.html">
                                    <img src="/porto/assets/images/demoes/demo30/products/small/product-4.jpg" width="74"
                                        height="74" alt="product">
                                </a>
                            </figure>

                            <div class="product-details">
                                <h3 class="product-title"> <a href="/porto/demo30-product.html">Ceramic Panda Mug</a> </h3>
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="/porto/demo30-product.html">
                                    <img src="/porto/assets/images/demoes/demo30/products/small/product-5.jpg" width="74"
                                        height="74" alt="product">
                                </a>
                            </figure>

                            <div class="product-details">
                                <h3 class="product-title"> <a href="/porto/demo30-product.html">Teddy Bear Blue</a> </h3>

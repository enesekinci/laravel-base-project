...
@section('title', isset($id) ? 'Edit Menu' : 'Create Menu')
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('menuForm', () => ({
                ...
                async loadMenu() {
                    ...
                    this.loading = true
                    try {
                        const response = await window.adminApiHelpers.get(`/menus/${this.menuId}`)
                        ...
                        if (window.swalHelpers) {
                            window.swalHelpers.error('Menu yüklenirken bir hata oluştu')
                        }
                    } finally {
                        this.loading = false
                    }
                ...
                async save() {
                    await handleFormSave(
                        ...
                        this.menuId,
                        this.formData,
                        this.menuId ? 'Menu güncellendi' : 'Menu oluşturuldu',
                        '/admin/menus'
                    )
                },
            }))
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" x-text="menuId ? 'Edit' : 'Create'"></li>
            </ol>
        </nav>
    </div>
    <!-- /BREADCRUMB -->

    <div x-data="menuForm" x-init="init()">
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="widget-content widget-content-area br-8 p-4">
                    <!-- Header -->
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="mb-0" x-text="menuId ? 'Edit Menu' : 'Create Menu'"></h4>
                        <div>
                            <a href="{{ route('admin.menus.index') }}" class="btn btn-secondary me-2">Cancel</a>
                    ...
                    <div x-show="!loading">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" x-model="formData.code" class="form-control" :class="{ 'is-invalid': errors.code }" placeholder="header_menu" />
                                <small class="form-text text-muted">Unique code for this menu (e.g., header_menu)</small>

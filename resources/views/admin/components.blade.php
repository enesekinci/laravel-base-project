...
@section('content')
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Bileşen Vitrini</li>
            </ol>
        </nav>
    </div>
    <!-- /BREADCRUMB -->
    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
            <div class="widget-content widget-content-area br-8 p-4">
                <h4 class="mb-4">Ürün Düzenleme Düzeni</h4>
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-12">
                                    ...
                                    <div id="product-description">
                                        Perspiciatis maxime facilis velit tenetur, iste expedita in dignissimos iure aut excepturi sapiente eligendi repellat. Lorem ipsum dolor sit amet consectetur,
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
            <div class="widget-content widget-content-area br-8 p-4">
                <h4 class="mb-4">Form Bileşenleri</h4>
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <h5>TouchSpin - Son Ek</h5>
                        <input id="demo1" type="text" value="55" name="demo1" />
                    </div>
                    <div class="col-md-6">
                        <h5>TouchSpin - Ön Ek</h5>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <div class="form-check form-check-primary form-check-inline">
                            ...
                            <label class="form-check-label" for="form-check-default">Varsayılan</label>
                        </div>
                        <div class="form-check form-check-primary form-check-inline">
                            <input class="form-check-input" type="checkbox" id="form-check-default-checked" checked />
                            <label class="form-check-label" for="form-check-default-checked">Seçili</label>
                        </div>
                        <div class="form-check form-check-primary form-check-inline">
                            <input class="form-check-input" type="checkbox" id="form-check-disabled" disabled />
                            <label class="form-check-label" for="form-check-disabled">Devre Dışı</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <div class="form-check form-switch form-check-inline">
                            ...
                            <label class="form-check-label" for="flexSwitchCheckDefault">Varsayılan</label>
                        </div>
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" checked />
                            <label class="form-check-label" for="flexSwitchCheckChecked">Seçili</label>
                        </div>
                        <div class="form-check form-switch form-check-inline form-switch-primary">
                            ...
                            <label class="form-check-label" for="form-switch-primary">Birincil</label>
                        </div>
                        <div class="form-check form-switch form-check-inline form-switch-success">
                            ...
                            <label class="form-check-label" for="form-switch-success">Başarılı</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <h5>Quill Editör (Zengin Metin Editörü)</h5>
                            ...
                            <div class="col-md-12">
                                <ul class="nav nav-pills" id="animateLine" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button
                                            class="nav-link"
                                            id="animated-underline-preferences-tab"
                                            data-bs-toggle="tab"
                                            href="#animated-underline-preferences"
                                            role="tab"
                                            aria-controls="animated-underline-preferences"
                                            aria-selected="false"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"

                    ...
                    <ul class="list-unstyled menu-categories" id="accordionExample">
                        ...
                        <li class="menu">
                            <a
                                href="#products"
                                data-bs-toggle="collapse"
                                aria-expanded="{{ request()->routeIs('admin.products.*') || request()->routeIs('admin.categories.*') || request()->routeIs('admin.brands.*') || request()->routeIs('admin.attributes.*') || request()->routeIs('admin.options.*') || request()->routeIs('admin.tags.*') ? 'true' : 'false' }}"
                                class="dropdown-toggle {{ request()->routeIs('admin.products.*') || request()->routeIs('admin.categories.*') || request()->routeIs('admin.brands.*') || request()->routeIs('admin.attributes.*') || request()->routeIs('admin.options.*') || request()->routeIs('admin.tags.*') ? 'active' : '' }}"
                            >
                                <div class="">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                            ...
                            <ul
                                class="collapse submenu list-unstyled {{ request()->routeIs('admin.products.*') || request()->routeIs('admin.categories.*') || request()->routeIs('admin.brands.*') || request()->routeIs('admin.attributes.*') || request()->routeIs('admin.options.*') || request()->routeIs('admin.tags.*') ? 'show' : '' }}"
                                id="products"
                            ...
                            >
                                ...
                                <li class="{{ request()->routeIs('admin.brands.*') ? 'active' : '' }}"><a href="{{ route('admin.brands.index') }}">Brands</a></li>
                                <li class="{{ request()->routeIs('admin.attributes.*') ? 'active' : '' }}"><a href="{{ route('admin.attributes.index') }}">Attributes</a></li>
                                <li class="{{ request()->routeIs('admin.options.*') ? 'active' : '' }}"><a href="{{ route('admin.options.index') }}">Options</a></li>
                                <li class="{{ request()->routeIs('admin.tags.*') ? 'active' : '' }}"><a href="{{ route('admin.tags.index') }}">Tags</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu">
                            <a
                                href="#sales"
                                data-bs-toggle="collapse"
                                aria-expanded="{{ request()->routeIs('admin.orders.*') || request()->routeIs('admin.coupons.*') || request()->routeIs('admin.transactions.*') ? 'true' : 'false' }}"
                                class="dropdown-toggle {{ request()->routeIs('admin.orders.*') || request()->routeIs('admin.coupons.*') || request()->routeIs('admin.transactions.*') ? 'active' : '' }}"
                            >
                                <div class="">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                            ...
                            <ul
                                class="collapse submenu list-unstyled {{ request()->routeIs('admin.orders.*') || request()->routeIs('admin.coupons.*') || request()->routeIs('admin.transactions.*') ? 'show' : '' }}"
                                id="sales"
                                data-bs-parent="#accordionExample"
                            >
                        ...
                        <li class="menu">
                            <a href="{{ route('admin.customers.index') }}" class="dropdown-toggle {{ request()->routeIs('admin.customers.*') ? 'active' : '' }}">
                                <div class="">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="24"
                        ...
                        <li class="menu">
                            <a
                                href="#content-menu"
                                data-bs-toggle="collapse"
                                aria-expanded="{{ request()->routeIs('admin.pages.*') || request()->routeIs('admin.posts.*') || request()->routeIs('admin.menus.*') || request()->routeIs('admin.sliders.*') || request()->routeIs('admin.content-blocks.*') || request()->routeIs('admin.media.*') ? 'true' : 'false' }}"
                                class="dropdown-toggle {{ request()->routeIs('admin.pages.*') || request()->routeIs('admin.posts.*') || request()->routeIs('admin.menus.*') || request()->routeIs('admin.sliders.*') || request()->routeIs('admin.content-blocks.*') || request()->routeIs('admin.media.*') ? 'active' : '' }}"
                            >
                                <div class="">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                            ...
                            <ul
                                class="collapse submenu list-unstyled {{ request()->routeIs('admin.pages.*') || request()->routeIs('admin.posts.*') || request()->routeIs('admin.menus.*') || request()->routeIs('admin.sliders.*') || request()->routeIs('admin.content-blocks.*') || request()->routeIs('admin.media.*') ? 'show' : '' }}"
                                id="content-menu"
                                data-bs-parent="#accordionExample"
                            >
                                <li class="{{ request()->routeIs('admin.pages.*') ? 'active' : '' }}"><a href="{{ route('admin.pages.index') }}">Pages</a></li>
                                <li class="{{ request()->routeIs('admin.posts.*') ? 'active' : '' }}"><a href="{{ route('admin.posts.index') }}">Blog Posts</a></li>
                                <li class="{{ request()->routeIs('admin.post-categories.*') ? 'active' : '' }}"><a href="{{ route('admin.post-categories.index') }}">Blog Categories</a></li>
                                <li class="{{ request()->routeIs('admin.post-tags.*') ? 'active' : '' }}"><a href="{{ route('admin.post-tags.index') }}">Blog Tags</a></li>
                                <li class="{{ request()->routeIs('admin.menus.*') ? 'active' : '' }}"><a href="{{ route('admin.menus.index') }}">Menus</a></li>
                                <li class="{{ request()->routeIs('admin.sliders.*') ? 'active' : '' }}"><a href="{{ route('admin.sliders.index') }}">Sliders</a></li>
                                <li class="{{ request()->routeIs('admin.content-blocks.*') ? 'active' : '' }}"><a href="{{ route('admin.content-blocks.index') }}">Content Blocks</a></li>
                                <li class="{{ request()->routeIs('admin.media.*') ? 'active' : '' }}"><a href="{{ route('admin.media.index') }}">Media Library</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu">
                            <a
                                href="#localization"
                                data-bs-toggle="collapse"
                                aria-expanded="{{ request()->routeIs('admin.tax-classes.*') ? 'true' : 'false' }}"
                                class="dropdown-toggle {{ request()->routeIs('admin.tax-classes.*') ? 'active' : '' }}"
                            >
                                <div class="">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                            ...
                            <ul class="collapse submenu list-unstyled {{ request()->routeIs('admin.tax-classes.*') ? 'show' : '' }}" id="localization" data-bs-parent="#accordionExample">
                                <li><a href="{{ route('admin.tax-classes.index') }}" class="{{ request()->routeIs('admin.tax-classes.*') ? 'active' : '' }}">Tax Classes</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu">
                            <a
                                ...
                                data-bs-toggle="collapse"
                                aria-expanded="{{ request()->routeIs('admin.shipping-methods.*') || request()->routeIs('admin.payment-methods.*') ? 'true' : 'false' }}"
                                class="dropdown-toggle {{ request()->routeIs('admin.shipping-methods.*') || request()->routeIs('admin.payment-methods.*') ? 'active' : '' }}"
                            >
                                <div class="">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                            ...
                            <ul
                                class="collapse submenu list-unstyled {{ request()->routeIs('admin.shipping-methods.*') || request()->routeIs('admin.payment-methods.*') ? 'show' : '' }}"
                                id="shipping-payment"
                                data-bs-parent="#accordionExample"
                            >
                                <li><a href="{{ route('admin.shipping-methods.index') }}" class="{{ request()->routeIs('admin.shipping-methods.*') ? 'active' : '' }}">Shipping Methods</a></li>
                                <li><a href="{{ route('admin.payment-methods.index') }}" class="{{ request()->routeIs('admin.payment-methods.*') ? 'active' : '' }}">Payment Methods</a></li>
                            </ul>
                        </li>

                        <li class="menu">
                            <a href="{{ route('admin.settings.index') }}" class="dropdown-toggle {{ request()->routeIs('admin.settings.*') ? 'active' : '' }}">
                                <div class="">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="24"

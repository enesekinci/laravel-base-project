        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('tagForm', () => ({
                ...
                async loadTag() {
                    ...
                    this.loading = true
                    try {
                        const response = await window.adminApiHelpers.get(`/tags/${this.tagId}`)
                        ...
                        if (window.swalHelpers) {
                            window.swalHelpers.error('Etiket yüklenirken bir hata oluştu')
                        }
                    } finally {
                        this.loading = false
                    }
                ...
                async save() {
                    await handleFormSave(this, '/tags', this.tagId, this.formData, this.tagId ? 'Etiket güncellendi' : 'Etiket oluşturuldu', '/admin/tags')
                },
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="widget-content widget-content-area br-8 p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div>
                            <a href="{{ route('admin.tags.index') }}" class="btn btn-secondary me-2">Cancel</a>

...
@push('scripts')
    <script>
        ...
        // Post Category Form Component
        document.addEventListener('alpine:init', () => {
            Alpine.data('postCategoryForm', () => ({
                loading: false,
                saving: false,
                categoryId: {{ $id ?? 'null' }},
                formData: {
                ...
                async loadCategory() {
                    ...
                    this.loading = true
                    try {
                        const response = await window.adminApiHelpers.get(`/post-categories/${this.categoryId}`)
                        ...
                        if (window.swalHelpers) {
                            window.swalHelpers.error('Blog kategorisi yüklenirken bir hata oluştu')
                        }
                    } finally {
                        this.loading = false
                    }
                ...
                async save() {
                    try {
                        await handleFormSave(
                            ...
                            this.categoryId,
                            this.formData,
                            this.categoryId ? 'Blog kategorisi güncellendi' : 'Blog kategorisi oluşturuldu',
...
@section('content')
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.post-categories.index') }}">Blog Categories</a></li>
    ...
    <div x-data="postCategoryForm" x-init="init()">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="widget-content widget-content-area br-8 p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div>
                            <a href="{{ route('admin.post-categories.index') }}" class="btn btn-secondary me-2">Cancel</a>

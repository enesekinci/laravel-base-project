            ...
            <div class="header-middle sticky-header">
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="/porto/demo27.html" class="logo">
                            <img src="/porto/assets/images/logo-black.png" alt="Porto Logo" width="111" height="44">
                        </a>
                        <nav class="main-nav">
                            <ul class="menu">
                                <li class="active">
                                    <a href="/porto/demo27.html">Home</a>
                                </li>
                                <li>
                                    <a href="/porto/demo27-shop.html">Shop</a>
                                            ...
                                            <div class="col-lg-4 p-0">
                                                <div class="menu-banner">
                                                    ...
                                                    <div class="banner-content">
                                                        ...
                                                        <a href="/porto/demo27-shop.html" class="btn btn-sm btn-dark">SHOP
                                                            NOW</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li>
                                    <a href="/porto/demo27-product.html">Products</a>
                                    <div class="megamenu megamenu-fixed-width">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <a href="#" class="nolink">PRODUCT PAGES</a>
                                                <ul class="submenu">
                                                    <li><a href="/porto/demo27-product.html">SIMPLE PRODUCT</a></li>
                                                    <li><a href="/porto/product-variable.html">VARIABLE PRODUCT</a></li>
                                                    <li><a href="/porto/demo27-product.html">SALE PRODUCT</a></li>
                                                    <li><a href="/porto/demo27-product.html">FEATURED & ON SALE</a></li>
                                            ...
                                            <div class="col-lg-4 p-0">
                                                <div class="menu-banner menu-banner-2">
                                                    ...
                                                    <a href="/porto/demo27-shop.html" class="btn btn-sm btn-dark">SHOP NOW</a>
                                                </div>
                                            </div><!-- End .col-lg-4 -->
                                        </div><!-- End .row -->
                                    </div><!-- End .megamenu -->
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo27-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo27-product.html" class="product-image">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo27-product.html">Brown Women Casual HandBag</a>
                                                </h4>
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo27-product.html">Circled Ultimate 3D Speaker</a>
                                                </h4>

            ...
            <div class="header-top">
                <div class="container-fluid">
                    <div class="header-left">
                        <p class="top-message font-italic ls-n-10">Get <b class="font-weight-extra-bold">10% OFF</b> at
                            the Porto Cosmetics Selection -
                            <a href="/porto/demo34-shop.html" class="font-weight-extra-bold text-underline">Shop
                                Now!</a></p>
                    </div>
                    ...
                    <div class="header-right">
                        ...
                        <div class="header-dropdown d-none d-sm-block">
                            <a href="#">USD</a>
                            <div class="header-menu">
                                <ul>
                                    <li><a href="#">EUR</a></li>
            ...
            <div class="header-middle sticky-header font2">
                <div class="container-fluid">
                    <div class="header-left">
                        ...
                        <a href="/porto/demo34.html" class="logo">
                            <img src="/porto/assets/images/logo-black.png" alt="Porto Logo" width="111" height="44">
                        </a>
                        <nav class="main-nav">
                            <ul class="menu">
                                <li class="active">
                                    <a href="/porto/demo34.html">Home</a>
                                </li>
                                <li>
                                    <a href="/porto/demo34-shop.html">Shop</a>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <ul class="submenu">
                                                    ...
                                                    <li><a href="/porto/category-off-canvas.html">Off Canvas Filter<span
                                                                class="tip tip-new">New</span></a></li>
                                                    <li><a href="/porto/category-horizontal-filter1.html">Horizontal
                                                            Filter1<span class="tip tip-new">New</span></a>
                                                    </li>
                                                    <li><a href="/porto/category-horizontal-filter2.html">Horizontal
                                                            Filter2<span class="tip tip-new">New</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col-lg-4">
                                ...
                                <li>
                                    <a href="/porto/demo34-product.html">Products</a>
                                    <div class="megamenu megamenu-fixed-width">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <a href="#" class="nolink">PRODUCT PAGES</a>
                                                <ul class="submenu">
                                                    <li><a href="/porto/demo34-product.html">SIMPLE PRODUCT</a></li>
                                                    <li><a href="/porto/product-variable.html">VARIABLE PRODUCT</a></li>
                                                    <li><a href="/porto/demo34-product.html">SALE PRODUCT</a></li>
                                                    <li><a href="/porto/demo34-product.html">FEATURED & ON SALE</a></li>
                                                    ...
                                                    <li><a href="/porto/product-addcart-sticky.html">ADD CART STICKY<span
                                                                class="tip tip-new">New</span></a></li>
                                                </ul>
                                            </div><!-- End .col-lg-4 -->
                                ...
                                <li><a href="#" target="blank" class="nolink">Buy Porto!</a></li>
                            </ul>
                        </nav>
                    </div>
                    ...
                    <div class="header-right">
                        <div
                            class="header-search header-search-popup header-search-category w-lg-max text-right d-none d-sm-block">
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo34-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo34-product.html" class="product-image">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo34-product.html">Brown Women Casual HandBag</a>
                                                </h4>
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo34-product.html">Circled Ultimate 3D Speaker</a>
                                                </h4>

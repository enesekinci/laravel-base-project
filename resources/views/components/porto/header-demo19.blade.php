            ...
            <div class="header-middle sticky-header" data-sticky-options="{ 'mobile': true }">
                <div class="container-fluid">
                    <div class="header-left">
                        ...
                        <a href="/porto/demo19.html" class="logo">
                    ...
                    <div class="header-right justify-content-end">
                        <nav class="main-nav">
                            <ul class="menu">
                                <li class="active">
                                    <a href="/porto/demo19.html">Home</a>
                                </li>
                                <li>
                                    <a href="/porto/demo19-shop.html">Categories</a>
                                ...
                                <li>
                                    <a href="/porto/demo19-product.html">Products</a>
                                ...
                                <li class="d-none d-xl-block">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/porto/demo19-about.html">About Us</a></li>
                                        <li><a href="#">Blog</a>
                                            <ul>
                                        ...
                                        <li><a href="/porto/demo19-contact.html">Contact Us</a></li>
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo19-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo19-product.html" class="product-image">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo19-product.html">Brown Women Casual HandBag</a>
                                                </h4>
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo19-product.html">Circled Ultimate 3D Speaker</a>
                                                </h4>

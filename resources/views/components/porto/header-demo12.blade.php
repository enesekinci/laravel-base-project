                    ...
                    <div class="header-dropdown dropdown-expanded">
                        <div class="header-menu">
                            <ul>
                                ...
                                <li><a href="/porto/category.html">Daily Deal</a></li>
        ...
        <div class="header-middle sticky-header">
            <div class="container d-flex">
                <div class="header-left">
                    ...
                    <a href="/porto/demo12.html" class="logo">
                    ...
                    <nav class="main-nav font2">
                        <ul class="menu">
                            <li>
                                <a href="/porto/demo12.html">Home</a>
                            </li>

                            <li>
                                <a href="/porto/demo12-shop.html">Categories</a>
                            ...
                            <li>
                                <a href="/porto/demo12-product.html">Products</a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 p-0">
                                            <div class="menu-banner menu-banner-2">
                                                ...
                                                <a href="/porto/demo12-shop.html" class="btn btn-sm btn-dark">SHOP
                                                    NOW</a>
                                            </div>
                                        </div>
                                        <!-- End .col-lg-4 -->
                            ...
                            <div class="dropdownmenu-wrapper custom-scrollbar">
                                ...
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        <div class="product-details">
                                            <h4 class="product-title">
                                                <a href="/porto/demo12-product.html">Ultimate 3D Bluetooth Speaker</a>
                                            </h4>
                                        ...
                                        <figure class="product-image-container">
                                            <a href="/porto/demo12-product.html" class="product-image">
                                    ...
                                    <div class="product">
                                        <div class="product-details">
                                            <h4 class="product-title">
                                                <a href="/porto/demo12-product.html">Brown Women Casual HandBag</a>
                                            </h4>
                                            <span class="cart-product-info">
                                    ...
                                    <div class="product">
                                        <div class="product-details">
                                            <h4 class="product-title">
                                                <a href="/porto/demo12-product.html">Circled Ultimate 3D Speaker</a>
                                            </h4>
                                            <span class="cart-product-info">
                                                <span class="cart-product-qty">1</span> × $35.00
                                            </span>

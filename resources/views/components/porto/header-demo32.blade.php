            ...
            <div class="header-top d-flex align-items-center">
                <div class="container">
                    <div class="header-left mr-lg-0 mr-3 d-sm-flex d-none">
                        <h4 class="mb-0">Get 10% OFF at the Porto GIFTs Selection - <a href="/porto/demo32-shop.html">Shop
                                Now!</a></h4>
                    </div>
            ...
            <div class="header-middle sticky-header">
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="/porto/demo32.html" class="logo">
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo32-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo32-product.html" class="product-image">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo32-product.html">Brown Women Casual HandBag</a>
                                                </h4>
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo32-product.html">Circled Ultimate 3D Speaker</a>
                                                </h4>

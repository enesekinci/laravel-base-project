                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo20-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo20-product.html" class="product-image">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo20-product.html">Brown Women Casual HandBag</a>
                                                </h4>
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo20-product.html">Circled Ultimate 3D Speaker</a>
                                                </h4>
                ...
                <div class="container">
                    <div class="header-left d-none d-lg-flex justify-content-center">
                        <nav class="main-nav">
                            <ul class="menu">
                                <li class="active">
                                    <a href="/porto/demo20.html">Home</a>
                                </li>
                                <li>
                                    <a href="/porto/demo20-shop.html">Categories</a>
                                ...
                                <li>
                                    <a href="/porto/demo20-product.html">Products</a>
                    ...
                    <div class="header-center ml-0">
                        ...
                        <a href="/porto/demo20.html" class="logo">
                            <img src="/porto/assets/images/logo-black.png" alt="Porto Logo" width="101" height="40">
                        </a>
                    </div>

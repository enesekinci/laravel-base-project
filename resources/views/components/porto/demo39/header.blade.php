                    ...
                    <div class="header-right header-dropdowns ml-0 ml-sm-auto w-sm-100">
                        <div class="header-dropdown dropdown-expanded d-none d-lg-block">
                            ...
                            <div class="header-menu">
                                <ul>
                                    <li class="d-xl-blcok d-none"><a href="dashboard.html">Track Order</a></li>
                                    <li><a href="about.html">About</a></li>
                                    <li><a href="wishlist.html">Our Stores</a></li>
                                    <li><a href="blog.html">Blog</a></li>
                                    <li><a href="contact.html">Contact</a></li>
                                    <li><a href="#" class="login-link">Help & FAQs</a></li>
                                </ul>
                            </div>
                            <!-- End .header-menu -->
                        </div>
                ...
                <div class="container-fluid">
                    <div class="header-left pl-0">
                        <nav class="main-nav w-100">
                            <ul class="menu">
                                <li class="active">
                                    <a href="/porto/demo39.html">Home</a>
                                </li>
                                <li>
                                    <a href="/porto/demo39-shop.html">Shop</a>
                                ...
                                <li>
                                    <a href="/porto/demo39-product.html">Products</a>
                    ...
                    <div class="header-center ml-lg-auto ml-0">
                        ...
                        <a href="/porto/demo39.html" class="logo">
                            <img src="/porto/assets/images/logo-black.png" width="111" height="44" alt="Porto Logo">
                        </a>
                    </div>
                    ...
                    <div class="header-right">
                        ...
                        <a href="login.html" class="header-icon header-user-icon" title="Login"><i
                                class="icon-user-2"></i></a>

                        <a href="wishlist.html" class="header-icon position-relative" title="wishlist">
                            <i class="icon-wishlist-2"></i>
                            <span class="wishlist-count badge-circle font2">0</span>
                        </a>

                        <div class="separator"></div>

                        <span class="cart-subtotal text-right d-sm-block d-none">Shopping Cart
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo39-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo39-product.html" class="product-image">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo39-product.html">Brown Women Casual HandBag</a>
                                                </h4>
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo39-product.html">Circled Ultimate 3D Speaker</a>
                                                </h4>

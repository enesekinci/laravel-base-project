<header class="header">
            <div class="header-top">
                <div class="container">
                    <div class="header-left d-none d-sm-flex align-items-center">
                        <p class="top-message">Get 10% OFF at the Porto GAMES Selection</p>
                        <span class="separator d-sm-block d-none"></span>
                        <a href="/porto/demo31-shop.html" class="text-primary">Shop Now!</a>
                    </div><!-- End .header-left -->
            ...
            <div class="header-middle sticky-header">
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="/porto/demo31.html" class="logo">
                    ...
                    <div class="header-center">
                        <nav class="main-nav">
                            <ul class="menu">
                                <li class="active">
                                    <a href="/porto/demo31-shop.html"><i class="icon-joystick font-size-lg"></i>Games</a>
                                ...
                                <li class="">
                                    <a href="/porto/demo31-product.html"><i class="icon-bars mr-3"></i>Products</a>
                                ...
                                <li><a href="https://1.envato.market/DdLk5" target="_blank"><i
                                            class="icon-star-empty mr-3"></i>Buy Porto</a></li>
                                <li class="menu-deal"><a href="#"><i class="icon-tag-percent mr-3"></i>Deals</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="header-right">
                        <a href="login.html" class="header-icon header-icon-user mb-0" title="Login"><i
                                class="icon-user-2"></i></a>

                        <div
                            class="header-icon header-search header-search-popup header-search-category d-none d-sm-block mb-0">
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo31-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo31-product.html" class="product-image">
                                                    <img src="/porto/assets/images/demoes/demo31/products/small/product-1.jpg"
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo31-product.html">Brown Women Casual HandBag</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo31-product.html" class="product-image">
                                                    <img src="/porto/assets/images/demoes/demo31/products/small/product-2.jpg"
                                                        alt="product" width="80" height="80">
                                                </a>
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo31-product.html">Circled Ultimate 3D Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo31-product.html" class="product-image">
                                                    <img src="/porto/assets/images/demoes/demo31/products/small/product-3.jpg"
                                                        alt="product" width="80" height="80">
                                                </a>
                                                <a href="#" class="btn-remove" title="Remove Product"><span>×</span></a>
                                            </figure>

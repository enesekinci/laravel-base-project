                ...
                <div class="header-dropdown dropdown-expanded d-none d-lg-block mr-2">
                    ...
                    <div class="header-menu">
                        <ul>
                            ...
                            <li><a href="/porto/demo2-contact.html">Contact Us</a></li>
    ...
    <div class="header-middle sticky-header" data-sticky-options="{'mobile': true}">
        <div class="container">
            <div class="header-left col-lg-2 w-auto pl-0">
                ...
                <a href="/porto/demo2.html" class="logo">
                    <img src="/porto/assets/images/logo-white.png" alt="Porto Logo">
                </a>
            </div>
            <!-- End .header-left -->
            ...
            <div class="header-right w-lg-max ml-0">
                ...
                <div class="header-contact d-none d-lg-flex pl-4 ml-3 mr-xl-5">
                    <img alt="phone" src="/porto/assets/images/phone-white.png" width="30" height="30" class="pb-1">
                    <h6>Call us now<a href="tel:#" class="font1">+123 5678 890</a></h6>
                </div>

                <a href="/porto/login.html" class="header-icon d-inline-block" title="Login"><i
                        class="icon-user-2"></i></a>

                <a href="/porto/wishlist.html" class="header-icon d-inline-block" title="Wishlist"><i
                        ...
                        <div class="dropdownmenu-wrapper custom-scrollbar">
                            ...
                            <div class="dropdown-cart-products">
                                <div class="product">
                                    <div class="product-details">
                                        <h4 class="product-title">
                                            <a href="/porto/demo2-product.html">Ultimate 3D Bluetooth Speaker</a>
                                        </h4>
                                    ...
                                    <figure class="product-image-container">
                                        <a href="/porto/demo2-product.html" class="product-image">
                                ...
                                <div class="product">
                                    <div class="product-details">
                                        <h4 class="product-title">
                                            <a href="/porto/demo2-product.html">Brown Women Casual HandBag</a>
                                        </h4>
                                ...
                                <div class="product">
                                    <div class="product-details">
                                        <h4 class="product-title">
                                            <a href="/porto/demo2-product.html">Circled Ultimate 3D Speaker</a>
                                        </h4>
                            ...
                            <div class="dropdown-cart-action">
                                <a href="/porto/cart.html" class="btn btn-gray btn-block view-cart">View
                                    Cart</a>
                                <a href="/porto/checkout.html" class="btn btn-dark btn-block">Checkout</a>
                            </div>
                            <!-- End .dropdown-cart-total -->
                        </div>
        ...
        <div class="container">
            ...
            <div class="header-center">
                <nav class="main-nav w-100">
                    <ul class="menu">
                        <li class="active">
                            <a href="/porto/demo2.html">Home</a>
                        </li>
                        <li>
                            <a href="/porto/demo2-shop.html">Categories</a>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li><a href="/porto/category-horizontal-filter1.html">Horizontal Filter1</a></li>
                                            <li><a href="/porto/category-horizontal-filter2.html">Horizontal Filter2</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-4">
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li><a href="/porto/category-infinite-scroll.html">Ajax Infinite Scroll</a></li>
                                    ...
                                    <div class="col-lg-4 p-0">
                                        <div class="menu-banner">
                                            <figure>
                                                <img src="/porto/assets/images/menu-banner.jpg" alt="Menu banner" width="300" height="300">
                                            </figure>
                                            <div class="banner-content">
                                                ...
                                                <a href="/porto/demo2-shop.html" class="btn btn-sm btn-dark">SHOP NOW</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <li>
                            <a href="/porto/demo2-product.html">Products</a>
                            <div class="megamenu megamenu-fixed-width megamenu-3cols">
                                <div class="row">
                                    <div class="col-lg-4">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="/porto/demo2-about.html">About Us</a></li>
                                <li><a href="#">Blog</a>
                                    <ul>
                                        <li><a href="/porto/blog.html">Blog</a></li>
            ...
            <div class="header-right">
                ...
                <a href="/porto/login.html" class="header-icon "><i class="icon-user-2"></i></a>

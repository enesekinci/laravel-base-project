<footer class="footer font2">
            ...
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-5 mb-1 mb-lg-0">
                            <div class="appear-animate" data-animation-name="fadeInUpShorter"
                                ...
                                <a href="/porto/demo25.html"><img src="/porto/assets/images/logo-black.png" alt="Logo" width="111"
                            ...
                            <div class="contact-widget">
                                ...
                                <div class="row ls-0">
                                    <div class="col-md-2-5">
                                        ...
                                        <h3 class="text-primary m-b-4">(123) 456-7890</h3>
                                    </div>
                                    <div class="col-md-3-5">
                                        <h6 class="text-uppercase mb-0">Payment Methods</h6>
                                        <img src="/porto/assets/images/demoes/demo25/payment.jpg" alt="payment methods"
                                            class="footer-payments m-b-4">
                                    </div>
                                </div>
                            </div>
                        </div><!-- End .col-lg-5 -->
                        ...
                        <div class="col-lg-3 col-sm-4">
                            <div class="widget">
                                ...
                                <ul class="links">
                                    <li><a href="/porto/about.html">About Porto</a></li>
                ...
                <div class="footer-bottom d-flex justify-content-between align-items-center flex-wrap">
                    <p class="footer-copyright py-3 pr-4 mb-0">&copy; Porto eCommerce. 2021. All Rights Reserved</p>

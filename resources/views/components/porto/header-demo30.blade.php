            ...
            <div class="header-middle sticky-header" data-sticky-options="{'mobile': true}">
                <div class=" container">
                    ...
                    <div class="header-center ml-lg-auto ml-0">
                        ...
                        <a href="/porto/demo30.html" class="logo">
                            <img src="/porto/assets/images/demoes/demo30/logo.png" alt="Porto Logo">
                        </a>
                    </div>
                    <div class="header-right">
                        ...
                        <div
                            class="header-icon header-search header-search-popup header-search-category d-none d-sm-block d-lg-none">
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo30-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo30-product.html" class="product-image">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo30-product.html">Brown Women Casual HandBag</a>
                                                </h4>
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo30-product.html">Circled Ultimate 3D Speaker</a>
                                                </h4>
                ...
                <div class="container">
                    <div class="header-left">
                        <nav class="main-nav">
                            <ul class="menu">
                                <li class="menu-item">
                                    <a class="d-inline-flex align-items-center sf-with-ul"><i
                                            class="custom-icon-toggle-menu d-inline-table"></i><span>Departments</span></a>
                                    <div class="menu-depart-overlay"></div><!-- End .mobil-menu-overlay -->
                                    <div class="menu-depart">
                                        <a href="/porto/demo30-shop.html"><i class="icon-smiling-girl"></i>For Her</a>
                                        <a href="/porto/demo30-shop.html"><i class="icon-boy-broad-smile"></i>For Him</a>
                                        <a href="/porto/demo30-shop.html"><i class="icon-smiling-baby"></i>For Kids</a>
                                        <a href="/porto/demo30-shop.html"><i class="icon-tshirt"></i>Fashion</a>
                                        <a href="/porto/demo30-shop.html"><i class="icon-chef"></i>Kitchen</a>
                                        <a href="/porto/demo30-shop.html"><i class="icon-edit"></i>Stationary</a>
                                        <a href="/porto/demo30-shop.html"><i class="icon-gift-2"></i>Personalized</a>
                                    </div>
                                </li>
                                <li>
                                    <a href="/porto/demo30-shop.html">Categories</a>
                                ...
                                <li>
                                    <a href="/porto/demo30-product.html">Products</a>
                                ...
                                <li><a href="https://1.envato.market/DdLk5" target="_blank">New Arrivals</a></li>
                            </ul>
                        </nav>
                    </div>
                    ...
                    <div class="header-right pr-0">
                        <form class="mb-0" action="#" method="get">
                            <div class="submit-wrapper">
                                <input type="search" class="form-control font2" name="q" id="qq"
                                    placeholder="I'm searching for..." required>

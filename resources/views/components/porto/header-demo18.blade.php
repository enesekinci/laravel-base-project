            ...
            <div class="header-middle sticky-header">
                <div class="container-fluid">
                    <div class="header-left">
                        ...
                        <a href="/porto/demo18.html" class="logo">
                            <img src="/porto/assets/images/demoes/demo18/logo.png" alt="Porto Logo">
                        </a>
                    </div>
                    <!-- End .header-left -->
                    ...
                    <div class="header-center justify-content-between">
                        <nav class="main-nav w-100">
                            <ul class="menu">
                                <li class="active">
                                    <a href="/porto/demo18.html">Home</a>
                                </li>
                                <li>
                                    <a href="/porto/demo18-shop.html">Categories</a>
                                            ...
                                            <div class="col-lg-4 p-0">
                                                <div class="menu-banner">
                                                    ...
                                                    <div class="banner-content">
                                                        ...
                                                        <a href="/porto/demo18-shop.html" class="btn btn-sm btn-dark">SHOP
                                                            NOW</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li>
                                    <a href="/porto/demo18-product.html">Products</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 p-0">
                                                <div class="menu-banner menu-banner-2">
                                                    ...
                                                    <a href="/porto/demo18-shop.html" class="btn btn-sm btn-dark">SHOP NOW</a>
                                                </div>
                                            </div>
                                            <!-- End .col-lg-4 -->
                                        </div>
                                ...
                                <li class="d-none d-xl-block">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/porto/demo18-about.html">About Us</a></li>
                                        <li><a href="#">Blog</a>
                                            <ul>
                                        ...
                                        <li><a href="/porto/demo18-contact.html">Contact Us</a></li>
                    ...
                    <div class="header-right justify-content-end">
                        <div class="header-dropdowns">
                            ...
                            <div class="header-dropdown">
                                ...
                                <div class="header-menu">
                                    <ul>
                                        <li><a href="/porto/demo18-about.html">ABOUT US</a>
                                        </li>
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo18-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo18-product.html" class="product-image">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo18-product.html">Brown Women Casual HandBag</a>
                                                </h4>
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo18-product.html">Circled Ultimate 3D Speaker</a>
                                                </h4>

                        ...
                        <div class="header-dropdown dropdown-expanded d-none d-lg-block">
                            ...
                            <div class="header-menu">
                                <ul class="mb-0 d-none d-lg-flex">
                                    ...
                                    <li><a href="/porto/demo21-about.html">About Us</a></li>
                                    <li><a href="wishlist.html">My Wishlist</a></li>
                                    <li><a href="/porto/demo21-about.html">Site Map</a></li>
            ...
            <div class="header-middle sticky-header" data-sticky-options="{'mobile': true}">
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="/porto/demo21.html" class="logo">
                            <img src="/porto/assets/images/logo-white.png" alt="Porto Logo" width="111" height="44">
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo21-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo21-product.html" class="product-image">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo21-product.html">Brown Women Casual HandBag</a>
                                                </h4>
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo21-product.html">Circled Ultimate 3D Speaker</a>
                                                </h4>
                ...
                <div class="container">
                    ...
                    <div class="header-center">
                        <nav class="main-nav w-100">
                            <ul class="menu">
                                <li class="active">
                                    <a href="/porto/demo21.html">Home</a>
                                </li>
                                <li>
                                    <a href="/porto/demo21-shop.html">Categories</a>
                                ...
                                <li>
                                    <a href="/porto/demo21-product.html">Products</a>
                                    <div class="megamenu megamenu-fixed-width">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <a href="#" class="nolink">PRODUCT PAGES</a>
                                                <ul class="submenu">
                                                    <li><a href="/porto/demo21-product.html">SIMPLE PRODUCT</a></li>
                                                    <li><a href="/porto/product-variable.html">VARIABLE PRODUCT</a></li>
                                                    <li><a href="/porto/demo21-product.html">SALE PRODUCT</a></li>
                                                    <li><a href="/porto/demo21-product.html">FEATURED & ON SALE</a></li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/porto/demo21-contact.html">Contact Us</a></li>

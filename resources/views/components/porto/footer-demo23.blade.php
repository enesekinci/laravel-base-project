                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6 col-xl-4">
                            <a href="#">
                                <img class="logo mb-3" src="/porto/assets/images/demoes/demo23/logo.png" alt="Porto Logo"
            ...
            <div class="footer-bottom">
                <div class="container-fluid d-sm-flex align-items-center">
                    ...
                    <div class="footer-right ml-auto mt-1 mt-sm-0">
                        <img src="/porto/assets/images/demoes/demo23/payment-icon.png" alt="payment">
                    </div>
                </div>

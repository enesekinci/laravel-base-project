            ...
            <div class="footer">
                ...
                <div class="container">
                    <div class="footer-middle">
                        <div class="row">
                            <div class="col-lg-4">
                                <a href="/porto/demo22.html">
                                    <img class="logo" src="/porto/assets/images/logo-black.png" alt="Porto Logo" width="220" height="80">
                                </a>
                                <div class="row">
                                ...
                                <div class="widget">
                                    ...
                                    <div class="row links link-lg link-parts">
                                        <div class="col-sm-6 link-part">
                                            <ul class="mb-0">
                                                <li>
                                                    <a href="/porto/dashboard.html">My Account</a>
                                                </li>
                            ...
                            <div class="col-lg-3">
                                <div class="widget widget-sm">
                                    ...
                                    <ul class="links">
                                        <li>
                                            <a href="/porto/about.html">About Porto</a>
                                        </li>
                    ...
                    <div class="footer-bottom d-sm-flex align-items-center">
                        ...
                        <div class="footer-right ml-auto mt-1 mt-sm-0">
                            <img src="/porto/assets/images/demoes/demo22/payment-icon.png" alt="payment" width="200" height="27">
                        </div>
                    </div>
                </div>
                <!-- End .footer-bottom -->

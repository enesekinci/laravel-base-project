                        ...
                        <div class="header-dropdown dropdown-expanded mr-md-3 mr-lg-0 pr-0 d-none d-lg-block">
                            <div class="header-menu">
                                <ul>
                                    ...
                                    <li><a href="/porto/demo5-about.html">About Us</a></li>
            ...
            <div class="header-middle sticky-header" data-sticky-options="{'mobile': true}">
                <div class="container">
                    <div class="header-left col-lg-2 w-auto pl-0">
                        ...
                        <a href="/porto/demo5.html" class="logo">
                            <img src="/porto/assets/images/demoes/demo5/logo.png" alt="Porto Logo">
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo5-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo5-product.html" class="product-image">
                                                    <img src="/porto/assets/images/demoes/demo5/products/product-1.jpg"
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo5-product.html">Brown Women Casual HandBag</a>
                                                </h4>
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo5-product.html">Circled Ultimate 3D Speaker</a>
                                                </h4>
                ...
                <div class="container">
                    ...
                    <div class="header-center">
                        <nav class="main-nav w-100 w-lg-max bg-primary">
                            <ul class="menu">
                                <li class="active">
                                    <a href="/porto/demo5.html">Home</a>
                                </li>
                                <li>
                                    <a href="/porto/demo5-shop.html">Categories</a>
                                            ...
                                            <div class="col-lg-4 p-0">
                                                <div class="menu-banner">
                                                    ...
                                                    <div class="banner-content">
                                                        ...
                                                        <a href="/porto/demo5-shop.html" class="btn btn-sm btn-dark">SHOP
                                                            NOW</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li>
                                    <a href="/porto/demo5-product.html">Products</a>
                                    <div class="megamenu megamenu-fixed-width megamenu-3cols">
                                        <div class="row">
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-4 p-0">
                                                <div class="menu-banner menu-banner-2">
                                                    ...
                                                    <a href="/porto/demo5-shop.html" class="btn btn-sm btn-dark">SHOP NOW</a>
                                                </div>
                                            </div><!-- End .col-lg-4 -->
                                        </div><!-- End .row -->
                                    </div><!-- End .megamenu -->
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/porto/demo5-contact.html">Contact Us</a></li>
                                ...
                                <li><a href="/porto/demo5-contact.html">Contact Us</a></li>
                                <li class="float-right"><a href="https://1.envato.market/DdLk5" class="pl-3"

            ...
            <div class="header-middle sticky-header" data-sticky-options="{'mobile': true}">
                <div class="container">
                    <div class="header-left col-lg-2 w-auto pl-0">
                        ...
                        <a href="/porto/demo42.html" class="logo">
                            <img src="/porto/assets/images/demoes/demo42/shop42_logo.png" class="w-100" width="202" height="80"
                                alt="Porto Logo">
                        </a>
                    </div><!-- End .header-left -->
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo42-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="/porto/demo42-product.html" class="product-image">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo42-product.html">Brown Women Casual HandBag</a>
                                                </h4>
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="/porto/demo42-product.html">Circled Ultimate 3D Speaker</a>
                                                </h4>
                ...
                <div class="container">
                    <nav class="main-nav w-100">
                        <ul class="menu w-100">
                            ...
                            <li class="active">
                                <a href="/porto/demo42.html">Home</a>
                            </li>
                            <li>
                                <a href="/porto/demo42-shop.html">Shop</a>
                                <div class="megamenu megamenu-fixed-width megamenu-3cols">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <a href="#" class="nolink">VARIATION 1</a>
                                            <ul class="submenu">
                                                <li><a href="/porto/demo42-shop.html" title="shop">Fullwidth Banner</a></li>
                                                ...
                                                <li><a href="/porto/demo42-shop.html" title="shop">Left Sidebar</a></li>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li><a href="/porto/demo42-shop.html" title="shop">3 Columns Products</a></li>
                                        ...
                                        <div class="col-lg-4 p-0">
                                            <div class="menu-banner">
                                                ...
                                                <div class="banner-content">
                                                    ...
                                                    <a href="/porto/demo42-shop.html" class="btn btn-sm btn-dark">SHOP NOW</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li>
                                <a href="/porto/demo42-product.html">Products</a>

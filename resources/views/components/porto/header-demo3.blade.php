    ...
    <div class="header-middle sticky-header">
        <div class="container">
            <div class="header-left">
                ...
                <a href="/porto/demo3.html" class="logo">
                    <img src="/porto/assets/images/logo-black.png" alt="Porto Logo">
                </a>

                <nav class="main-nav font2">
                    <ul class="menu">
                        <li class="active">
                            <a href="/porto/demo3.html">Home</a>
                        </li>
                        <li>
                            <a href="/porto/demo3-shop.html">Categories</a>
                                    ...
                                    <div class="col-lg-4 p-0">
                                        <div class="menu-banner">
                                            ...
                                            <div class="banner-content">
                                                ...
                                                <a href="/porto/demo3-shop.html" class="btn btn-sm btn-dark">SHOP NOW</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <li>
                            <a href="/porto/demo3-product.html">Products</a>
                            <div class="megamenu megamenu-fixed-width megamenu-3cols">
                                <div class="row">
                                    <div class="col-lg-4">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="/porto/demo3-about.html">About Us</a></li>
                                <li><a href="#">Blog</a>
                                    <ul>
                                ...
                                <li><a href="/porto/demo3-contact.html">Contact Us</a></li>
            ...
            <div class="header-right">
                ...
                <a href="/porto/login.html" class="header-icon header-icon-user" title="Login"><i class="icon-user-2"></i></a>

                <a href="/porto/wishlist.html" class="header-icon header-icon-wishlist" title="Wishlist"><i class="icon-wishlist-2"></i></a>
                    ...
                    <div class="dropdown-menu mobile-cart">
                        ...
                        <div class="dropdownmenu-wrapper custom-scrollbar">
                            ...
                            <div class="dropdown-cart-products">
                                <div class="product">
                                    ...
                                    <figure class="product-image-container">
                                        <a href="/porto/demo3-product.html" class="product-image">
                                ...
                                <div class="product">
                                    <div class="product-details">
                                        <h4 class="product-title">
                                            <a href="/porto/demo3-product.html">Brown Women Casual HandBag</a>
                                        </h4>
                                ...
                                <div class="product">
                                    <div class="product-details">
                                        <h4 class="product-title">
                                            <a href="/porto/demo3-product.html">Circled Ultimate 3D Speaker</a>
                                        </h4>
                            ...
                            <div class="dropdown-cart-action">
                                <a href="/porto/cart.html" class="btn btn-gray btn-block view-cart">View Cart</a>

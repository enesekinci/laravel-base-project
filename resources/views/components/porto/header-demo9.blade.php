                ...
                <div class="container">
                    ...
                    <div class="header-right">
                        <ul class="top-links mega-menu show-arrow d-none d-lg-inline-block mt-0 mb-0">
                            ...
                            <li class="item-menu narrow"><a href="/porto/demo9-about.html">About Us</a></li>
                ...
                <div class="header-middle sticky-header d-flex w-100">
                    <div class="container">
                        <div class="header-left">
                            ...
                            <a href="/porto/demo9.html" class="logo">
                                <img src="/porto/assets/images/logo-white.png" alt="Porto Logo" width="110" height="46" />
                            </a>
                        </div>
                        <!-- End .header-left -->
                                    ...
                                    <div class="dropdownmenu-wrapper custom-scrollbar">
                                        ...
                                        <div class="dropdown-cart-products">
                                            <div class="product">
                                                <div class="product-details">
                                                    <h4 class="product-title">
                                                        <a href="/porto/demo9-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                    </h4>
                                                ...
                                                <figure class="product-image-container">
                                                    <a href="/porto/demo9-product.html" class="product-image">
                                            ...
                                            <div class="product">
                                                <div class="product-details">
                                                    <h4 class="product-title">
                                                        <a href="/porto/demo9-product.html">Brown Women Casual HandBag</a>
                                                    </h4>
                                            ...
                                            <div class="product">
                                                <div class="product-details">
                                                    <h4 class="product-title">
                                                        <a href="/porto/demo9-product.html">Circled Ultimate 3D Speaker</a>
                                                    </h4>
                        ...
                        <div class="side-menu-wrapper text-uppercase d-none d-lg-block">
                            ...
                            <nav class="side-nav">
                                <ul class="menu menu-vertical sf-arrows">
                                    <li class="active"><a href="/porto/demo9.html"><i class="sicon-home"></i>Home</a></li>
                                    <li>
                                        <a href="/porto/demo9-shop.html" class="sf-with-ul"><i
                                        ...
                                        <div class="megamenu megamenu-fixed-width megamenu-3cols">
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    ...
                                                    <ul class="submenu">
                                                        <li><a href="/porto/demo9-shop.html">Fullwidth Banner</a></li>
                                                        ...
                                                        <li><a href="/porto/demo9-shop.html">Left Sidebar</a></li>
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <ul class="submenu">
                                                        ...
                                                        <li><a href="/porto/demo9-shop.html">3 Columns Products</a></li>
                                                ...
                                                <div class="col-lg-4 p-0">
                                                    <div class="menu-banner">
                                                        ...
                                                        <div class="banner-content">
                                                            ...
                                                            <a href="/porto/demo9-shop.html" class="btn btn-sm btn-dark">SHOP
                                                                NOW</a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <li>
                                        <a href="/porto/demo9-product.html" class="sf-with-ul"><i
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="/porto/demo9-about.html">About Us</a></li>
                                            <li><a href="#">Blog</a>
                                                <ul>
                                            ...
                                            <li><a href="/porto/demo9-contact.html">Contact Us</a></li>
                                            <li><a href="login.html">Login</a></li>
                                            <li><a href="forgot-password.html">Forgot Password</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="blog.html"><i class="sicon-book-open"></i>blog</a></li>
                                    <li><a href="/porto/demo9-about.html"><i class="sicon-users"></i>About Us</a></li>

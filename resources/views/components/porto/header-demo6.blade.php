            ...
            <div class="header-middle sticky-header">
                <div class="container-fluid">
                    <div class="header-left flex-1 d-none d-xl-flex">
                        <nav class="main-nav w-100">
                            <ul class="menu ls-n-10">
                                <li class="active">
                                    <a href="/porto/demo6.html" class="pl-4">Home</a>
                                </li>
                                <li>
                                    <a href="/porto/demo6-shop.html">Categories</a>
                                ...
                                <li>
                                    <a href="/porto/demo6-product.html">Products</a>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/porto/demo6-about.html">About Us</a></li>
                                        <li><a href="#">Blog</a>
                                            <ul>
                                        ...
                                        <li><a href="/porto/demo6-contact.html">Contact Us</a></li>
                    ...
                    <div class="header-center ml-0 ml-xl-auto">
                        <a href="/porto/demo6.html" class="logo logo-transition">
                            <img src="/porto/assets/images/logo-black.png" width="113" height="46" alt="Porto" />
                        </a>
                    </div>
                    <!-- End .header-center -->

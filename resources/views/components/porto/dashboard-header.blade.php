		...
		<div class="container">
			...
			<div class="header-right w-lg-max">
				...
				<div class="header-contact d-none d-lg-flex pl-4 pr-4">
					...
					<h6><span>{{ $siteSettings['phone_text'] ?? 'Call us now' }}</span><a href="tel:{{ $siteSettings['phone'] ?? '#' }}" class="text-dark font1">{{ $siteSettings['phone'] ?? '+123 5678 890' }}</a></h6>
				</div>

				<a href="/porto/login.html" class="header-icon" title="login"><i class="icon-user-2"></i></a>

				<a href="/porto/wishlist.html" class="header-icon" title="wishlist"><i class="icon-wishlist-2"></i></a>
							...
							<div class="row">
								<div class="col-lg-4">
									...
									<ul class="submenu">
										...
										<li><a href="/porto/category-banner-boxed-slider.html">Boxed Slider Banner</a>
										</li>
										<li><a href="/porto/category-banner-boxed-image.html">Boxed Image Banner</a>
										</li>
										...
										<li><a href="/porto/category-horizontal-filter1.html">Horizontal Filter1</a>
										</li>
										<li><a href="/porto/category-horizontal-filter2.html">Horizontal Filter2</a>
										</li>
									</ul>
								</div>
								<div class="col-lg-4">
								...
								<div class="col-lg-4 p-0">
									<div class="menu-banner">
										<figure>
											<img src="/porto/assets/images/menu-banner.jpg" width="192" height="313"
												alt="Menu banner">
										</figure>
							...
							<div class="row">
								...
								<div class="col-lg-4 p-0">
									<div class="menu-banner menu-banner-2">
										<figure>
											<img src="/porto/assets/images/menu-banner-1.jpg" width="182" height="317"

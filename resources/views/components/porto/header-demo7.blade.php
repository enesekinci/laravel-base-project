                        ...
                        <div class="header-dropdown dropdown-expanded mr-3">
                            <div class="header-menu">
                                <ul>
                                    ...
                                    <li><a href="/porto/demo7-about.html">About Us</a></li>
            ...
            <div class="header-middle sticky-header">
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="/porto/demo7.html" class="logo w-100">
                        ...
                        <nav class="main-nav w-100">
                            <ul class="menu">
                                <li class="active">
                                    <a href="/porto/demo7.html">Home</a>
                                </li>
                                <li>
                                    <a href="/porto/demo7-shop.html">Categories</a>
                                            ...
                                            <div class="col-lg-4 p-0">
                                                <div class="menu-banner">
                                                    ...
                                                    <div class="banner-content">
                                                        ...
                                                        <a href="/porto/demo7-shop.html" class="btn btn-sm btn-dark">SHOP
                                                            NOW</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li>
                                    <a href="/porto/demo7-product.html">Products</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 p-0">
                                                <div class="menu-banner menu-banner-2">
                                                    ...
                                                    <a href="/porto/demo7-shop.html" class="btn btn-sm btn-dark">SHOP NOW</a>
                                                </div>
                                            </div><!-- End .col-lg-4 -->
                                        </div><!-- End .row -->
                                    </div><!-- End .megamenu -->
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/porto/demo7-contact.html">Contact Us</a></li>

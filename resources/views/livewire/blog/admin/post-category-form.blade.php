<div>
    <x-header :title="$categoryId ? 'Kategori Düzenle' : 'Yeni Kategori'" separator progress-indicator>
        <x-slot:actions>
    ...
    <x-card>
        <form wire:submit="save">
            <div class="grid grid-cols-1 gap-4">
                <x-input label="Kategori Adı" wire:model="name" icon="o-folder" hint="Kategori adı" required />
                ...
                <div class="form-control">
                    ...
                    <div class="flex gap-2 w-full">
                        ...
                        <x-button type="button" icon="o-arrow-path" class="btn-primary" wire:click="generateSlug" tooltip="Kategori adından slug oluştur" />
                    </div>
                </div>
            </div>
